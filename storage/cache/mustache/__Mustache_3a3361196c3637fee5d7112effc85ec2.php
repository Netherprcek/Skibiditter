...
class __Mustache_3a3361196c3637fee5d7112effc85ec2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3e4d431d20311b62d9b9e98347a1a5d1($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function section3e4d431d20311b62d9b9e98347a1a5d1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <li class="flex items-center mb-2">
          ...
          <span class="ml-2"> <a href="/profile/{{username}}" class="text-blue-500">{{username}}</a> has created a new <a href="{{id_post}}/post" class="text-blue-500">post</a></span>
        </li>
      ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/post" class="text-blue-500">post</a></span>
';
                $buffer .= $indent . '        </li>
';
                $context->pop();
