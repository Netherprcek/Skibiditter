...
class __Mustache_66eb564708cba479f0648c824241d5e4 extends Mustache_Template
{
...
';
        $buffer .= $indent . '          This is a test message to check rendering.
';
        $buffer .= $indent . '        </h2>
';
        $buffer .= $indent . '
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <!-- Debugging message -->
';
        $buffer .= $indent . '        <p style="color: red;">If you see this message, the template is rendering correctly.</p>
';
        $buffer .= $indent . '
';
