...
class __Mustache_f62472a6572e0804dcd1d22ddc8d00ba extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCbde09804ae8e0ddde903e4b3efffab0($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function sectionCbde09804ae8e0ddde903e4b3efffab0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <li class="flex items-center mb-2">
          ...
          <span class="ml-2"> <a href="/profile/{{username}}">{{username}}</a> has created a new post</span>
        </li>
      ';
