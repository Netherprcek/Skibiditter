...
class __Mustache_222fc3b07586d78ee5036ca62157ff59 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0ca15df2b1d591dea9980dfb655d2461($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section0ca15df2b1d591dea9980dfb655d2461(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
