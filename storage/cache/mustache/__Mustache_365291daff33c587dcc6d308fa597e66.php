...
class __Mustache_365291daff33c587dcc6d308fa597e66 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-textarea" class="hidden w-full p-2 text-gray-800"></textarea>
';
