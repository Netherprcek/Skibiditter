...
class __Mustache_0aa83615c1248c8709145474b5c98a1a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8e919c474025392df2abc07fb96a3563($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section8e919c474025392df2abc07fb96a3563(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            <h2 class="text-xl font-semibold mb-2  text-white">';
                $value = $this->resolveValue($context->find('title'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</h2>
';
