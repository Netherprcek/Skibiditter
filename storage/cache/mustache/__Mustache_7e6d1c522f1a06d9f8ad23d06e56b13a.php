...
class __Mustache_7e6d1c522f1a06d9f8ad23d06e56b13a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section237b368b50f22cb5112ae55096e05527($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section237b368b50f22cb5112ae55096e05527(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div class="px-6 md:px-12 mb-2">
    <p class="overflow-wrap break-word z-10 mb-4 break-words text-gray-100">
      {{ post_text }}
    </p>
...
';
                $buffer .= $indent . '    <p class="overflow-wrap break-word z-10 mb-4 break-words text-gray-100">
';
                $buffer .= $indent . '      ';
