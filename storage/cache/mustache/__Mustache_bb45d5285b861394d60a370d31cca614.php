...
class __Mustache_bb45d5285b861394d60a370d31cca614 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2f5fb6b50d5f30884ab022bb433000c3($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section2f5fb6b50d5f30884ab022bb433000c3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-8 md:px-12 mb-0">
';
