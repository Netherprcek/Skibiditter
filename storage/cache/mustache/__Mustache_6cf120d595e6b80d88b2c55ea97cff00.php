...
class __Mustache_6cf120d595e6b80d88b2c55ea97cff00 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section03c8c973a6e7410153cb0731d407051e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section03c8c973a6e7410153cb0731d407051e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        ...
        <button
          type="submit"
          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white align"
        >
          Update
        </button>
      </form>
...
';
                $buffer .= $indent . '          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white align"
';
                $buffer .= $indent . '        >
';
