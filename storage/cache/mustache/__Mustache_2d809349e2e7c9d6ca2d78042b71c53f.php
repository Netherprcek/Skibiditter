...
class __Mustache_2d809349e2e7c9d6ca2d78042b71c53f extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-4 xl:pl-20 min-[2000px]:pl-40 min-[2500px]:pl-60 text-left justify-items-end">
';
