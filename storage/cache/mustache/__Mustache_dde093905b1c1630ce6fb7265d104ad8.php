...
class __Mustache_dde093905b1c1630ce6fb7265d104ad8 extends Mustache_Template
{
...
';
        ...
        $buffer .= '\'s avatar"
';
        $buffer .= $indent . '        class="mr-2 mt-4 h-24 w-24 rounded-full border-4 border-blue-800"
';
        $buffer .= $indent . '      />
';
        $buffer .= $indent . '
