...
class __Mustache_3fea4012f24352cf127aa3e3db86795b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionCba458a487df219aba1f21d1a20f9cbf($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionCba458a487df219aba1f21d1a20f9cbf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
