...
class __Mustache_99300e785891742e82d0111512c3a695 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section5da4d0b6676490e280e791d926523c04($context, $indent, $value);
            $buffer .= ' ';
        }
        $buffer .= '
';
...
';
    ...
    private function section5da4d0b6676490e280e791d926523c04(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' <div class="mt-16">{{> partials/followButton}} ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
