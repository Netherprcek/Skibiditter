...
class __Mustache_095084a2fda4c71a3c978f32e873a7d9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section83d9f1ac4057019b36c1b34ff376a28a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section83d9f1ac4057019b36c1b34ff376a28a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
