...
class __Mustache_20d917974d539c3235d4cca8a0603e0e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3fd072b8ce467372994ec613100bee52($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section3fd072b8ce467372994ec613100bee52(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
