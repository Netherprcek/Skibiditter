...
class __Mustache_1fb5519dafeb2c4055f37481671abdb9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="w-full max-w-3xl p-8 border-l border-r border-gray-500">
';
