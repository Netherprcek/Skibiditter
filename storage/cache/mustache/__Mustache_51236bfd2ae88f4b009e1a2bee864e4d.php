...
class __Mustache_51236bfd2ae88f4b009e1a2bee864e4d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBdaf1159a34bfbe066c1a05a4df13796($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionBdaf1159a34bfbe066c1a05a4df13796(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
