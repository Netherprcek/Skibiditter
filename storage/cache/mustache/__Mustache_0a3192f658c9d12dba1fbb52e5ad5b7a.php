...
class __Mustache_0a3192f658c9d12dba1fbb52e5ad5b7a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section751b73b1a0b95df3c85aeb7f6b2de1bc($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section751b73b1a0b95df3c85aeb7f6b2de1bc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    <div class="flex items-center">
      ...
      <span class=" text-sm pt-0 mr-auto text-gray-300">Created at: {{ created_at }}</span>
    </div>
    {{#is_owner}}
    <div class="relative">
      <button class="text-white" onclick="toggleOptions(\'{{id_post}}\', event)">
...
';
                $buffer .= $indent . '      </span>
';
                $buffer .= $indent . '      <span class=" text-sm pt-0 mr-auto text-gray-300">Created at: ';
