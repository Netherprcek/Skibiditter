...
class __Mustache_115c9a0c6df2301c37edaa437b3d0e60 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $value = $context->findDot('profile.is_owner');
            $buffer .= $this->sectionDbee2d61a68e90a2386810be6a0fc241($context, $indent, $value);
        }
        $value = $context->findDot('profile.is_owner');
...
';
    ...
    private function sectionDbee2d61a68e90a2386810be6a0fc241(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
