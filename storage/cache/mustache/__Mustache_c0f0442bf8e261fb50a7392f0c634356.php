...
class __Mustache_c0f0442bf8e261fb50a7392f0c634356 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section303f3d59f2cb01776d284b4556ae6893($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section303f3d59f2cb01776d284b4556ae6893(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class=" max-w-2xl w-full border-b-2 mt-2 border-gray-800">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class=" max-w-2xl w-full border-b-2 mt-2 border-gray-800">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
