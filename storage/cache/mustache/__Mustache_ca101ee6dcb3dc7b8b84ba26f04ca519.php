...
class __Mustache_ca101ee6dcb3dc7b8b84ba26f04ca519 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      ></textarea>
';
        $buffer .= $indent . '      <button type="submit" class="ml-2 my-2 rounded-lg bg-blue-500 p-2 text-white">
';
