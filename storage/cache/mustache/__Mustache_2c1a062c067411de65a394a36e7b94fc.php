...
class __Mustache_2c1a062c067411de65a394a36e7b94fc extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section28ab2b4b283ec83f4accc0682861becc($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section28ab2b4b283ec83f4accc0682861becc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 border-b border-gray-700 rounded-lg bg-gray-700 p-2">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 border-b border-gray-700 rounded-lg bg-gray-700 p-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
