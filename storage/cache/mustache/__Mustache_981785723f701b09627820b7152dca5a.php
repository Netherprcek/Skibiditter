...
class __Mustache_981785723f701b09627820b7152dca5a extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->find('avatar_url'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '" alt="';
...
';
        ...
        $value = $this->resolveValue($context->find('handle'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '</p>
';
        $buffer .= $indent . '      </div>
