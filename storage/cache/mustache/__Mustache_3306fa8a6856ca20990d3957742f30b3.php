...
class __Mustache_3306fa8a6856ca20990d3957742f30b3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <label class="text-white">
';
        $buffer .= $indent . '        <input type="radio" name="image_option" value="url" checked> Image URL
';
        $buffer .= $indent . '      </label>
';
        $buffer .= $indent . '      <label class="text-white ml-4">
';
        $buffer .= $indent . '        <input type="radio" name="image_option" value="file"> Upload Image
';
        $buffer .= $indent . '      </label>
';
        $buffer .= $indent . '    </div>
