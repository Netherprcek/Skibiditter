...
class __Mustache_ba5c0fc0574660dcd420861c512f4436 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE9f9cc20645bd1d349bf722829e25abe($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionE9f9cc20645bd1d349bf722829e25abe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="mb-2 px-14 w-4/5 text-gray-200">{{ post_text }}</p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
    <img
      src="{{ img }}"
...
';
                ...
                $buffer .= '</h2>
';
                $buffer .= $indent . '  <p class="mb-2 px-14 w-4/5 text-gray-200">';
