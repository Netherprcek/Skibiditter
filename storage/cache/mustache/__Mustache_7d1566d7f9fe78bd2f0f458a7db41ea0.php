...
class __Mustache_7d1566d7f9fe78bd2f0f458a7db41ea0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section271d4785f1f41524ea70d116a0a86366($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section271d4785f1f41524ea70d116a0a86366(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-2 border-gray-500 bg-gray-900 text-gray-100 rounded-lg shadow-inner">
    {{ post_text }}
  </p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-2 border-gray-500 bg-gray-900 text-gray-100 rounded-lg shadow-inner">
';
                $buffer .= $indent . '    ';
