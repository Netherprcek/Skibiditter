...
class __Mustache_fb3d9dbfa7151a1a938f44c41e59ce6b extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section8bf9d10eb4e8aaa6c1c9dba64589f368($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section8bf9d10eb4e8aaa6c1c9dba64589f368(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-black"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-black"
';
                $buffer .= $indent . '        >
';
