...
class __Mustache_5116fbf69d4fb7001940b043e36ebe1f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD0c125bfb4ac28f161b8255a87713688($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionD0c125bfb4ac28f161b8255a87713688(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
  ...
  <a href="/{{id_post}}/delete">
    <button class="mt-2 rounded-lg bg-red-500 p-2 text-white">Delete Post</button>
  </a>
  ';
...
';
                ...
                $buffer .= '/delete">
';
                $buffer .= $indent . '    <button class="mt-2 rounded-lg bg-red-500 p-2 text-white">Delete Post</button>
';
                $buffer .= $indent . '  </a>
';
                $context->pop();
