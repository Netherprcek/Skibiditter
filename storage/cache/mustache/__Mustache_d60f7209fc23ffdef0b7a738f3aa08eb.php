...
class __Mustache_d60f7209fc23ffdef0b7a738f3aa08eb extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-16 flex h-[calc(100vh-4rem)] w-1/3 flex-col overflow-y-auto  pl-4"
';
        $buffer .= $indent . '>
';
