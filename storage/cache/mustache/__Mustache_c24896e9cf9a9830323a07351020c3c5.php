...
class __Mustache_c24896e9cf9a9830323a07351020c3c5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCd2b1253303f2fcdfbe0cefe7eb81973($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionCd2b1253303f2fcdfbe0cefe7eb81973(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
