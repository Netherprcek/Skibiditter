...
class __Mustache_0a4171f42aa90dcd31d2d3eaecb19cf2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section385332bd18958819acc5b8248df17724($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section385332bd18958819acc5b8248df17724(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="avatar_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4">
        <input
          type="text"
        ...
        <button
          type="submit"
          class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
        >
          Post
        </button>
      </form>
      <form id="background_form" action="/{{username}}/edit-profile" method="post" class="relative">
        <input
          type="text"
        ...
        <button
          type="submit"
          class="absolute right-1 top-1/2 -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
        >
          Post
        </button>
      </form>
...
';
                $buffer .= $indent . '      </h1>
';
                $buffer .= $indent . '      <form id="avatar_form" action="/';
                $value = $this->resolveValue($context->find('username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/edit-profile" method="post" class="relative mb-4">
';
                $buffer .= $indent . '        <input
';
...
';
                $buffer .= $indent . '          class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
';
                $buffer .= $indent . '        >
';
                $buffer .= $indent . '          Post
...
';
                $buffer .= $indent . '      </form>
';
                $buffer .= $indent . '      <form id="background_form" action="/';
                $value = $this->resolveValue($context->find('username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/edit-profile" method="post" class="relative">
';
                $buffer .= $indent . '        <input
';
                $buffer .= $indent . '          type="text"
