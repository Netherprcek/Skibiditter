...
class __Mustache_6056656ff4d148d8e808fcdec5758a57 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section07305d2d206f7aebe46f645d45fb2551($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section07305d2d206f7aebe46f645d45fb2551(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    <div class="flex items-center w-full">
      ...
      <span class="text-sm pt-0 pr-10 text-gray-300">{{created_at }}</span>
    </div>
    {{#is_owner}}
    <div class="relative">
      <button class="text-white" onclick="toggleOptions(\'{{id_post}}\', event)">
  ...
  <p class="mb-2 px-14 text-gray-200 break-words overflow-wrap break-word">{{ post_text }} - {{session_user.user_id}}</p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
    <img
      src="{{ img }}"
...
';
                $buffer .= $indent . '      </span>
';
                $buffer .= $indent . '      <span class="text-sm pt-0 pr-10 text-gray-300">';
