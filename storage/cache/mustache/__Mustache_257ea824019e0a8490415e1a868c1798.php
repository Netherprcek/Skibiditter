...
class __Mustache_257ea824019e0a8490415e1a868c1798 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section213bd68991d1a28110bcbcd4ad4a995a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section213bd68991d1a28110bcbcd4ad4a995a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
