...
class __Mustache_66c879a79bbaeec48f28ef337086d505 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5cbf3f32536dbafe41be0f14d1c1f3de($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section5cbf3f32536dbafe41be0f14d1c1f3de(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    ...
    <p
      class="overflow-wrap break-word z-10 mb-4 break-words py-3 text-gray-100 border-l-2 border-gray-700"
    >
      {{ post_text }}
    </p>
...
';
                $buffer .= $indent . '    <p
';
                $buffer .= $indent . '      class="overflow-wrap break-word z-10 mb-4 break-words py-3 text-gray-100 border-l-2 border-gray-700"
';
                $buffer .= $indent . '    >
';
                $buffer .= $indent . '      ';
