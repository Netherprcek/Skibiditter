...
class __Mustache_8bf1df956bd420e953fa19d999ce54ac extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFae62e3d8d2bcc61f35c22116c9cbb8c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionFae62e3d8d2bcc61f35c22116c9cbb8c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-2 md:px-20 mb-0 ">
';
