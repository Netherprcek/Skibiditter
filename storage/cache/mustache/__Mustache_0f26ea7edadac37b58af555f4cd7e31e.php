...
class __Mustache_0f26ea7edadac37b58af555f4cd7e31e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4bd61cb6d954707b4b26421b289901aa($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4bd61cb6d954707b4b26421b289901aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
