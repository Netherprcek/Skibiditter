...
class __Mustache_9f56270f3a1211629714904d7f910765 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC65be260e664bafaf1c5efb17b3f7ca6($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionC65be260e664bafaf1c5efb17b3f7ca6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <h2 class="text-gray-300">{{ username }}:</h2>
...
';
                $buffer .= $indent . '            <h2 class="text-gray-300">';
