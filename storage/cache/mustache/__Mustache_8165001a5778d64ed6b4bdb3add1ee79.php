...
class __Mustache_8165001a5778d64ed6b4bdb3add1ee79 extends Mustache_Template
{
...
';
        ...
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '\'s avatar" class="w-24 h-24 rounded-full border-4 border-gray-800 mr-4 mt-12">
';
        $buffer .= $indent . '      
';
