...
class __Mustache_645392357a9ababeafa064cc9e713288 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8e7da72223351570a9ca4b4ad9716851($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section8e7da72223351570a9ca4b4ad9716851(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <article class="bg-white shadow-md rounded-lg p-6 w-64">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <article class="bg-white shadow-md rounded-lg p-6 w-64">
';
