...
class __Mustache_f77923aa9d20a699ae69994e80736c80 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAa00f2f2d2292867dc7c918fe5dc106b($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionAa00f2f2d2292867dc7c918fe5dc106b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
