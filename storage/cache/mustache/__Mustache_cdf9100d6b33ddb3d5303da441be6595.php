...
class __Mustache_cdf9100d6b33ddb3d5303da441be6595 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC4c1bf500f7eb3628e5b5a423af80285($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionC4c1bf500f7eb3628e5b5a423af80285(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    ...
    <p
      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100 border-l-2 border-gray-700"
    >
      {{ post_text }}
    </p>
...
';
                $buffer .= $indent . '    <p
';
                $buffer .= $indent . '      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100 border-l-2 border-gray-700"
';
                $buffer .= $indent . '    >
';
                $buffer .= $indent . '      ';
