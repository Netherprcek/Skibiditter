...
class __Mustache_132744a74b534df20f4d92201ae453d2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEd69d43bfe7cba50e2be00eda80e9a2a($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionEd69d43bfe7cba50e2be00eda80e9a2a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
