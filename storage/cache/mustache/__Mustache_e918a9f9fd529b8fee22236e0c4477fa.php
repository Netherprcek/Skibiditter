...
class __Mustache_e918a9f9fd529b8fee22236e0c4477fa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section06c57b7a8e525404a5b681301a7cd4b8($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section06c57b7a8e525404a5b681301a7cd4b8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
