...
class __Mustache_4886f62ea06271deda2a81a994be916b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section048f427806dad7289a74e56c4f0c1d3f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section048f427806dad7289a74e56c4f0c1d3f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
