...
class __Mustache_db774fa577dfbf473ca727e38aeff56d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section975524fd1a2ae382aef8fa04ef8d5c56($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section975524fd1a2ae382aef8fa04ef8d5c56(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" enctype="multipart/form-data" class="relative mb-4 mx-4">
        <div class="relative mb-4 flex items-center justify-between space-x-8">
          <div class="flex flex-col items-center">
            <label for="avatarFileInput" class="block text-white mb-2">Avatar</label>
            <label class="cursor-pointer flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white hover:text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="flex flex-col items-center">
            <label for="backgroundFileInput" class="block text-white mb-2">Background</label>
            <label class="cursor-pointer flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white hover:text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
';
                $buffer .= $indent . '        <div class="relative mb-4 flex items-center justify-between space-x-8">
';
                $buffer .= $indent . '          <div class="flex flex-col items-center">
';
                $buffer .= $indent . '            <label for="avatarFileInput" class="block text-white mb-2">Avatar</label>
';
                $buffer .= $indent . '            <label class="cursor-pointer flex flex-col items-center">
';
                $buffer .= $indent . '              <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white hover:text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
';
...
';
                $buffer .= $indent . '          <div class="flex flex-col items-center">
';
                $buffer .= $indent . '            <label for="backgroundFileInput" class="block text-white mb-2">Background</label>
';
                $buffer .= $indent . '            <label class="cursor-pointer flex flex-col items-center">
';
                $buffer .= $indent . '              <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white hover:text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
