...
class __Mustache_bbe42c061c3187d155aa8a4ba435eec9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC7947965aa746052601510b6ec836c7e($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionC7947965aa746052601510b6ec836c7e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" enctype="multipart/form-data" class="relative mb-4 mx-4">
        <div class="relative mb-4 flex items-center justify-between">
          ...
          <div class="flex items-center">
            ...
            <label class="cursor-pointer flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-white hover:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
';
                $buffer .= $indent . '        <div class="relative mb-4 flex items-center justify-between">
';
...
';
                $buffer .= $indent . '            <label class="cursor-pointer flex items-center">
';
                $buffer .= $indent . '              <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-white hover:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
';
