...
class __Mustache_8831ca015fc94098d40bc47ee1f9acc2 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    </a>
';
        $buffer .= $indent . '    <form action="/logout" method="POST" class="ml-4flex justify-end">
';
        $buffer .= $indent . '      <button type="submit" class="rounded-md bg-blue-500 px-4 py-2 text-white">
';
