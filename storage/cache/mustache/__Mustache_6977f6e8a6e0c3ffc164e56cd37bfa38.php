...
class __Mustache_6977f6e8a6e0c3ffc164e56cd37bfa38 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0081a1ee1c3b00a5611d8e2b333a486c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section0081a1ee1c3b00a5611d8e2b333a486c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative    py-4 pb-0 border-2 border-t-0 border-gray-800">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative    py-4 pb-0 border-2 border-t-0 border-gray-800">
';
