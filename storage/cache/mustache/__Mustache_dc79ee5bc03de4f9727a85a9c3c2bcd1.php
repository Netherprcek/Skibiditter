...
class __Mustache_dc79ee5bc03de4f9727a85a9c3c2bcd1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section84d378839b5dfbf01eb3b76871574d28($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section84d378839b5dfbf01eb3b76871574d28(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
