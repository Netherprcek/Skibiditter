...
class __Mustache_bfbbe85314e8d69f7eba27e1fb09d367 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8ea8f63741b42286bda106ec823d528b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section8ea8f63741b42286bda106ec823d528b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
