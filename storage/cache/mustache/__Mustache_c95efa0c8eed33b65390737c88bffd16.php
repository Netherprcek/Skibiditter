...
class __Mustache_c95efa0c8eed33b65390737c88bffd16 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD1571b0c924024422357cd412a98dc0d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionD1571b0c924024422357cd412a98dc0d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
