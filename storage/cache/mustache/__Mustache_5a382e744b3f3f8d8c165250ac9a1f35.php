...
class __Mustache_5a382e744b3f3f8d8c165250ac9a1f35 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4818f896b2066afee0b1f18bd790ebc2($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section4818f896b2066afee0b1f18bd790ebc2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative mb-6 rounded-lg bg-gray-800 px-6 py-0 pb-0 shadow-md">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative mb-6 rounded-lg bg-gray-800 px-6 py-0 pb-0 shadow-md">
';
