...
class __Mustache_aae682cdbbd32266f33e631cd8f6a32b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDa049d5c69f0535ea996827ceb35b48b($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionDa049d5c69f0535ea996827ceb35b48b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
