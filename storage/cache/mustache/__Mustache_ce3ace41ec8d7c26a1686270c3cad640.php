...
class __Mustache_ce3ace41ec8d7c26a1686270c3cad640 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD575f280989f5aea46ed1ba755e6aab3($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionD8167b7e58865bd1f0cbde0b59f41921(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionD575f280989f5aea46ed1ba755e6aab3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative py-4 pb-0 border-b-2 border-gray-800">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative py-4 pb-0 border-b-2 border-gray-800">
';
...
';
                ...
                $buffer .= $this->sectionD8167b7e58865bd1f0cbde0b59f41921($context, $indent, $value);
