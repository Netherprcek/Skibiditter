...
class __Mustache_084d5901eb2fbff392dd4817ee0de38a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9cbd08250b59bea69701053bac948210($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section9cbd08250b59bea69701053bac948210(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
