...
class __Mustache_3b243f5e64111af78f3f36f7680e82e5 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section8a397d75f18208d0afb5dffe776653af($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section8a397d75f18208d0afb5dffe776653af(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500"
';
                $buffer .= $indent . '        >
';
