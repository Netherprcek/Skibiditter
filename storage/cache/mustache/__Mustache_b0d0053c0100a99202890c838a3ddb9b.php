...
class __Mustache_b0d0053c0100a99202890c838a3ddb9b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6349c92dbfb153144af85fcf5fd1c4ce($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('is_following');
        if (empty($value)) {
...
';
    ...
    private function section6349c92dbfb153144af85fcf5fd1c4ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
