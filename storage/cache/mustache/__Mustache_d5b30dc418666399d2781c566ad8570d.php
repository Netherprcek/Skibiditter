...
class __Mustache_d5b30dc418666399d2781c566ad8570d extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <button class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-600 align-center">SKIBIDITTER</button>
';
