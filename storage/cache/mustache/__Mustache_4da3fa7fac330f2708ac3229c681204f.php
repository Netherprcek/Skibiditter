...
class __Mustache_4da3fa7fac330f2708ac3229c681204f extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<div class="relative mb-6 overflow-hidden rounded-lg bg-gray-900">
';
