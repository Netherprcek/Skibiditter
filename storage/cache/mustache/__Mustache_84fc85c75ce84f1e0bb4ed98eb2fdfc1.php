...
class __Mustache_84fc85c75ce84f1e0bb4ed98eb2fdfc1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7066952dcc3e79633efbc247514e8ace($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section7066952dcc3e79633efbc247514e8ace(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
