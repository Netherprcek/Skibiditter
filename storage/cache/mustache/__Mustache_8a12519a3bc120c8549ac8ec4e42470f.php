...
class __Mustache_8a12519a3bc120c8549ac8ec4e42470f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3a0cd23887b60f197af9a74b96e016fa($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $indent . '      <div class="rounded-lg bg-gray-800 p-6 shadow-md text-center">
';
            $buffer .= $indent . '        <p class="text-white">Login to comment</p>
';
            $buffer .= $indent . '      </div>
';
        }
...
';
    ...
    private function section3a0cd23887b60f197af9a74b96e016fa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
