...
class __Mustache_07926459ad7bb8e76b2f47d04db2e0b8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4ca0661132d985730873baaae7b98dc8($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4ca0661132d985730873baaae7b98dc8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
