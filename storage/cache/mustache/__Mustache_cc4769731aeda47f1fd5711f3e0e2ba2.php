...
class __Mustache_cc4769731aeda47f1fd5711f3e0e2ba2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section28691f6619c9f8a7b13d2dd6b726b9ae($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9eecf92ec3514a71cf8e452dbc9c3d29(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="relative">
      ...
      >
        ...
        <form action="http://localhost:8000/{{id_post}}/delete" method="POST" class="block">
          <button type="submit" class="w-full px-4 py-2 text-left text-white hover:bg-gray-600">
            Delete
          </button>
        </form>
      </div>
...
';
                $buffer .= $indent . '        </a>
';
                $buffer .= $indent . '        <form action="http://localhost:8000/';
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/delete" method="POST" class="block">
';
                $buffer .= $indent . '          <button type="submit" class="w-full px-4 py-2 text-left text-white hover:bg-gray-600">
';
...
';
    ...
    private function section28691f6619c9f8a7b13d2dd6b726b9ae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section9eecf92ec3514a71cf8e452dbc9c3d29($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
