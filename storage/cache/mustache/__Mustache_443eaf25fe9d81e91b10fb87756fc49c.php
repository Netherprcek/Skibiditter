...
class __Mustache_443eaf25fe9d81e91b10fb87756fc49c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA80314f714e22fad53c05d02d1584f5f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
        $buffer .= $indent . '  function toggleOptions(postId, event) {
';
        $buffer .= $indent . '    event.stopPropagation(); // Prevent the click event from propagating to the document
';
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '      if (!optionsMenu.contains(event.target)) {
';
        $buffer .= $indent . '        optionsMenu.classList.add(\'hidden\');
';
...
';
    ...
    private function sectionA80314f714e22fad53c05d02d1584f5f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
