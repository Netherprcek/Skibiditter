...
class __Mustache_989c5d68143ee7116d467f40fdee0e04 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3753c633928e9bb944cb1ca203c0d015($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section6c0da66a5a100334dde5adf1c7855320(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <a href="site/{{post_id}}/edit">
      <button
...
';
    ...
    private function section3753c633928e9bb944cb1ca203c0d015(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section6c0da66a5a100334dde5adf1c7855320($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
