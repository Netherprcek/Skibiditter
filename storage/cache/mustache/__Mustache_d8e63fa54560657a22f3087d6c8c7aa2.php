...
class __Mustache_d8e63fa54560657a22f3087d6c8c7aa2 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</span>
';
        $buffer .= $indent . '      <div class="relative w-full">
';
        $buffer .= $indent . '        <textarea
';
        $buffer .= $indent . '          name="comment_text"
';
        $buffer .= $indent . '          class="w-full resize-none overflow-hidden rounded-lg bg-gray-700 p-2 text-white focus:outline-none pr-20"
';
