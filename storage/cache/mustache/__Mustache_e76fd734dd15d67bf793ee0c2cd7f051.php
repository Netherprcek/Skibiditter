...
class __Mustache_e76fd734dd15d67bf793ee0c2cd7f051 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCf87838d6813357c2881b743795e6dc8($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionCf87838d6813357c2881b743795e6dc8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
