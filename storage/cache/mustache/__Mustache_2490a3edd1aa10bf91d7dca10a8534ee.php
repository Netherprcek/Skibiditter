...
class __Mustache_2490a3edd1aa10bf91d7dca10a8534ee extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE25202ad6ba2f7b5eb124a1da27a1426($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section8533e083feb3f8ffcf6c4c59d9482666(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <img src="{{img}}" alt="{{title}}" class="w-120 h-120 object-cover rounded">
          ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-120 h-120 object-cover rounded">
';
                $context->pop();
            }
        }
    ...
    private function sectionE25202ad6ba2f7b5eb124a1da27a1426(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section8533e083feb3f8ffcf6c4c59d9482666($context, $indent, $value);
