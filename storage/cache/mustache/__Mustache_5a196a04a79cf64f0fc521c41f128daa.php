...
class __Mustache_5a196a04a79cf64f0fc521c41f128daa extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section522c109e0acea19b4d7df50eaba0c5d5($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section522c109e0acea19b4d7df50eaba0c5d5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <h2 class="text-sm text-gray-300">{{ username }}:</h2>
...
';
                $buffer .= $indent . '            <h2 class="text-sm text-gray-300">';
