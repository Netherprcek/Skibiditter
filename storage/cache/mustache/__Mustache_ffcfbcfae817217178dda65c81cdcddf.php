...
class __Mustache_ffcfbcfae817217178dda65c81cdcddf extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBe92be854d73e2c0337f46250560e19e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionBe92be854d73e2c0337f46250560e19e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-gray-500 text-gray-100 rounded-lg shadow-inner">
    {{ post_text }}
  </p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-gray-500 text-gray-100 rounded-lg shadow-inner">
';
                $buffer .= $indent . '    ';
