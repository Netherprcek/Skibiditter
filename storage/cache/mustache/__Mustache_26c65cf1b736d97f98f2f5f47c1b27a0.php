...
class __Mustache_26c65cf1b736d97f98f2f5f47c1b27a0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5acce7015bd4141fb77812ef2022e105($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section5acce7015bd4141fb77812ef2022e105(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
