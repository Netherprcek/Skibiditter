...
class __Mustache_c3431e9769661ebe28569152855cccdb extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <label for="imageFileInput" class="block text-white mb-2">Upload Image</label>
';
        $buffer .= $indent . '      <div class="flex items-center">
';
        $buffer .= $indent . '        <label class="bg-blue-500 text-white p-2 rounded-lg cursor-pointer hover:bg-blue-600 flex items-center">
';
        $buffer .= $indent . '          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
';
...
';
        $buffer .= $indent . '            onchange="document.getElementById(\'fileName\').textContent = this.files[0].name"
';
        $buffer .= $indent . '          />
';
        $buffer .= $indent . '        </label>
