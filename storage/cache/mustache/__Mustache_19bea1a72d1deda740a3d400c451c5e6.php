...
class __Mustache_19bea1a72d1deda740a3d400c451c5e6 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col pl-0 md:pl-4 lg:pl-20 text-left ">
';
