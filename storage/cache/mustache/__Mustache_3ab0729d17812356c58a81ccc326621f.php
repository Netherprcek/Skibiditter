...
class __Mustache_3ab0729d17812356c58a81ccc326621f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section928fc8729e8b7c42bce82841f5c053ba($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section04b241e5fd3df2948cad78beeb746810(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section928fc8729e8b7c42bce82841f5c053ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section04b241e5fd3df2948cad78beeb746810($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
