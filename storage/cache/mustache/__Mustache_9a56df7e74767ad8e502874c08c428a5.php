...
class __Mustache_9a56df7e74767ad8e502874c08c428a5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section55369d0bce8ebb9be205f6a8d132d67d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section55369d0bce8ebb9be205f6a8d132d67d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
