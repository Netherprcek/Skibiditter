...
class __Mustache_47f3e8af6a70f87bc8f54f643d122d97 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section436cd948b678edab7e7cce4898fd466b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section436cd948b678edab7e7cce4898fd466b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
