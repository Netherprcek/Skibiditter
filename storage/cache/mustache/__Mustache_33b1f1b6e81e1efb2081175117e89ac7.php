...
class __Mustache_33b1f1b6e81e1efb2081175117e89ac7 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<a href="/profile" class="ml-10 h-12 rounded-full bg-blue-500 p-0.5">
';
        $buffer .= $indent . '  <div
';
