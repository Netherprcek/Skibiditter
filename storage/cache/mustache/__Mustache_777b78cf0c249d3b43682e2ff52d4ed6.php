...
class __Mustache_777b78cf0c249d3b43682e2ff52d4ed6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB15081dc74c76a799cb14824562453d7($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionB15081dc74c76a799cb14824562453d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
