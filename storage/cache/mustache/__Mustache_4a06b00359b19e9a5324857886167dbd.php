...
class __Mustache_4a06b00359b19e9a5324857886167dbd extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFd0ab470d31a62f0ded986b7df0b252d($context, $indent, $value);
        $buffer .= $indent . '      
';
        $buffer .= $indent . '      </div>
';
...
';
    ...
    private function sectionFd0ab470d31a62f0ded986b7df0b252d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
      <div class="rounded-lg bg-gray-800 p-6 shadow-md"></div>
        <p>{{comment_text}}</p>
        <p>{{username}}</p>
        <p>{{created_at}}</p>
        </div>
      ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '      <div class="rounded-lg bg-gray-800 p-6 shadow-md"></div>
';
                $buffer .= $indent . '        <p>';
