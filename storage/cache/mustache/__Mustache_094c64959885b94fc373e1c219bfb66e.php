...
class __Mustache_094c64959885b94fc373e1c219bfb66e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5f808be82a11cac248a047aa95bad47e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section5f808be82a11cac248a047aa95bad47e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="avatar_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4">
        ...
        <button
          type="submit"
          class="absolute  top-1/2 -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
        >
          Post
        </button>
      </form>
...
';
                $buffer .= $indent . '          class="absolute  top-1/2 -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
';
                $buffer .= $indent . '        >
';
                $buffer .= $indent . '          Post
