...
class __Mustache_50df6a4844158da923f132e8880dc2e0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    class="fixed right-4 top-4 z-50 hidden rounded border-l-4 border-yellow-500 bg-yellow-100 p-4 text-yellow-700 opacity-0 shadow-md transition-opacity duration-300"
';
