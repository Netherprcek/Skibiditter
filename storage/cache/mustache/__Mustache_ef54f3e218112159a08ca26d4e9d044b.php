...
class __Mustache_ef54f3e218112159a08ca26d4e9d044b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB8e60a98779005f9f52142a7c0cc39a3($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionB8e60a98779005f9f52142a7c0cc39a3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
