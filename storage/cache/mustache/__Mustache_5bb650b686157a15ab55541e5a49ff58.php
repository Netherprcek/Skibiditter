...
class __Mustache_5bb650b686157a15ab55541e5a49ff58 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section207412aed96b069d36b602d88e185600($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section207412aed96b069d36b602d88e185600(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex flex-grow justify-center">
    <div class="border-x-8 border-gray-800 max-w-4xl w-full">
...
';
                $buffer .= $indent . '    <div class="border-x-8 border-gray-800 max-w-4xl w-full">
';
