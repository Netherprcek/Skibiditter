...
class __Mustache_d158989933a869507f0a71d201f375d4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3d969c3f7124ef291453d91671d085bb($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section3d969c3f7124ef291453d91671d085bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
