...
class __Mustache_182af68f8859ba7427e5c37f63b36b24 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF02d3bc3987f288dca403cd70c256362($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionF02d3bc3987f288dca403cd70c256362(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
