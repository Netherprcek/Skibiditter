...
class __Mustache_062eb975d6a3652352277405775aafd0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section14e56f2c4f35f7d0f2015dee7bcd4fa9($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section14e56f2c4f35f7d0f2015dee7bcd4fa9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        ...
        <button
          type="submit"
          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white"
        >
          Update
        </button>
      </form>
...
';
                $buffer .= $indent . '          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white"
';
                $buffer .= $indent . '        >
';
