...
class __Mustache_1315196cbb84b402c6c98e1a201b2363 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3706d4d395940c4a22c99fa7a65a2602($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section3706d4d395940c4a22c99fa7a65a2602(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
