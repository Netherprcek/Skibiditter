...
class __Mustache_3cde64c4f7e1bc65caf5f89e1dd34f85 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0876f2b2ba25154e58997f08d549fafe($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section0876f2b2ba25154e58997f08d549fafe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
