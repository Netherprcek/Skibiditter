...
class __Mustache_9aa9eb1dba97552f4d99a7f8da549335 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section625a49a5c602eb5b89433f7ecdd97dce($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->section60ad4b471a885adbaf9d83d79f6bd399($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section625a49a5c602eb5b89433f7ecdd97dce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
      <div class="mb-6 rounded-lg border border-blue-600 bg-gray-800 p-6 shadow-md">
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '      <div class="mb-6 rounded-lg border border-blue-600 bg-gray-800 p-6 shadow-md">
';
...
';
    ...
    private function section60ad4b471a885adbaf9d83d79f6bd399(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700 p-2">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
          ...
          <span class="pl-14 overflow-hidden text-ellipsis whitespace-nowrap">{{comment_text}}</span>
          <div class="flex justify-center mt-2">
            <form
              id="like-form-{{id_comment}}"
              action="/{{id_comment}}/like"
              method="POST"
              class="items-center flex pb-0 mb-0"
            >
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700 p-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <span class="pl-14 overflow-hidden text-ellipsis whitespace-nowrap">';
...
';
                $buffer .= $indent . '              class="items-center flex pb-0 mb-0"
';
                $buffer .= $indent . '            >
';
