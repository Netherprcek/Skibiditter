...
class __Mustache_b8af7520245491494a6fc3efcd064572 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section13b6812f7e7c335fce30b3cbee65e2a9($context, $indent, $value);
    ...
    private function section13b6812f7e7c335fce30b3cbee65e2a9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="flex w-full">
      ...
      <div id="right_column" class="flex w-1/4 justify-left"></div>
...
';
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '      <div id="right_column" class="flex w-1/4 justify-left"></div>
';
                $buffer .= $indent . '      <h2>';
                $value = $this->resolveValue($context->findDot('session_user.username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
