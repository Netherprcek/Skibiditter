...
class __Mustache_5423f05935189d114201eae61ec06d56 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4396db08663ea1f9676f1a593cbde296($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4396db08663ea1f9676f1a593cbde296(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '      </h1>
';
                $buffer .= $indent . '      <div class="mx-8 flex flex-col">
';
