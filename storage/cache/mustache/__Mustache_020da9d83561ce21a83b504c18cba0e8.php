...
class __Mustache_020da9d83561ce21a83b504c18cba0e8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDdd28865112908493f2024e2177469f8($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionDdd28865112908493f2024e2177469f8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div class="rounded-lg border-2 border-gray-700 bg-gray-800 pb-4">
    <p
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="rounded-lg border-2 border-gray-700 bg-gray-800 pb-4">
';
                $buffer .= $indent . '    <p
';
