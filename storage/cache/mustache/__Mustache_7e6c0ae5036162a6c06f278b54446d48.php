...
class __Mustache_7e6c0ae5036162a6c06f278b54446d48 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA8b83ac4f6045e3a17408d8ccff3ef52($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section8cd7803b1853c29afd65a7023f73ca7f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="max-w-full h-auto object-cover rounded-lg" style="max-height: 24rem;" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="max-w-full h-auto object-cover rounded-lg" style="max-height: 24rem;" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function sectionA8b83ac4f6045e3a17408d8ccff3ef52(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section8cd7803b1853c29afd65a7023f73ca7f($context, $indent, $value);
