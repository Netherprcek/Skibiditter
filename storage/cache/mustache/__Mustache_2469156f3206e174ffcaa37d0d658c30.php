...
class __Mustache_2469156f3206e174ffcaa37d0d658c30 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section11f015c7ef5a372fd1b38033e0e797f1($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section11f015c7ef5a372fd1b38033e0e797f1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
