...
class __Mustache_ba42faadddb623d280738a96be336070 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0912a0ffcb3b92f1c2825d744dcf0d2c($context, $indent, $value);
    ...
    private function section0912a0ffcb3b92f1c2825d744dcf0d2c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="flex w-full">
      ...
      <div id="right_column" class="flex w-1/4 justify-start;"><h2>{{session_user.username}}</h2></div>
...
';
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '      <div id="right_column" class="flex w-1/4 justify-start;"><h2>';
                $value = $this->resolveValue($context->findDot('session_user.username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</h2></div>
';
