...
class __Mustache_18da9b6a6a9832e7b52864ee28e7d72d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section649198a80f714054fffc52604b6a1b3c($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function section649198a80f714054fffc52604b6a1b3c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <li class="flex items-center mb-2">
          ...
          <span class="ml-2"> <a href="/profile/{{username}}" class="text-blue-500">{{username}}</a> has created a new <a href="{{id_post}}/comments" class="text-blue-500">post</a></span>
        </li>
      ';
...
';
                ...
                $value = $this->resolveValue($context->find('username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</a> has created a new <a href="';
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/comments" class="text-blue-500">post</a></span>
';
                $buffer .= $indent . '        </li>
';
                $context->pop();
