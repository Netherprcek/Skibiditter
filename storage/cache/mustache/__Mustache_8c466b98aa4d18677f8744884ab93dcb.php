...
class __Mustache_8c466b98aa4d18677f8744884ab93dcb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9018a675fd9aec5aed33e0e802472f7f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionD441a5ba0919ee186fba797eb10604ac(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9018a675fd9aec5aed33e0e802472f7f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
{{/is_following}} ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionD441a5ba0919ee186fba797eb10604ac($context, $indent, $value);
                $buffer .= $indent . ' ';
                $value = $context->find('is_following');
                if (empty($value)) {
