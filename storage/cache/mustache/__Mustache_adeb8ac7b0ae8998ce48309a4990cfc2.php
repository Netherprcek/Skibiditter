...
class __Mustache_adeb8ac7b0ae8998ce48309a4990cfc2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFc4f72c3dd0c161e63bff3a23bb2560a($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionFc4f72c3dd0c161e63bff3a23bb2560a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        ...
        <button
          type="submit"
          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white text-center"
        >
          Update
        </button>
      </form>
...
';
                $buffer .= $indent . '          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white text-center"
';
                $buffer .= $indent . '        >
';
