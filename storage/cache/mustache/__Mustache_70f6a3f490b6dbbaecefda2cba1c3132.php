...
class __Mustache_70f6a3f490b6dbbaecefda2cba1c3132 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF51d3e97c813a8fcb79f6666200656cc($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function sectionF51d3e97c813a8fcb79f6666200656cc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
