...
class __Mustache_2951bbc0e67096125930b5c0a14d6b4d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7fb05de9054eb1e11adf95e4abf9e2fb($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section0274b667afe4d172fa49d6311f7b5b35(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7fb05de9054eb1e11adf95e4abf9e2fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section0274b667afe4d172fa49d6311f7b5b35($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '      </div>
';
