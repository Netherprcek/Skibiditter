...
class __Mustache_d2f7c13087a88c45054c008df2b17f12 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4882c20e236925fa60c644d3d36d7140($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section4882c20e236925fa60c644d3d36d7140(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
