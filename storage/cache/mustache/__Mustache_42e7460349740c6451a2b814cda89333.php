...
class __Mustache_42e7460349740c6451a2b814cda89333 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE30307ae3d52dac35d3821d1e8b57a09($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionE30307ae3d52dac35d3821d1e8b57a09(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
