...
class __Mustache_0b462552197809bf64c39a334a4b214b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE2a4687b9b9f73eae14881fbaacc5c3b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function sectionE2a4687b9b9f73eae14881fbaacc5c3b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
