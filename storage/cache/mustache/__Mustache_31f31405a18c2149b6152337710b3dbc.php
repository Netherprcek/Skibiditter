...
class __Mustache_31f31405a18c2149b6152337710b3dbc extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="flex w-1/3 content-end border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
...
';
        $buffer .= $indent . '    <a href="/" class="mb-12 text-2xl font-bold text-gray-300">
';
        $buffer .= $indent . '      <i class="fas fa-home"></i> Home
';
        $buffer .= $indent . '    </a>
';
        $buffer .= $indent . '    <a href="/explore" class="mb-12 text-2xl font-bold text-gray-300">
';
        $buffer .= $indent . '      <i class="fas fa-compass"></i> Explore
';
        $buffer .= $indent . '    </a>
';
        $buffer .= $indent . '    <a href="/search" class="mb-12 text-2xl font-bold text-gray-300">
';
