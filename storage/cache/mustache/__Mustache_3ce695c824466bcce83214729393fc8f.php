...
class __Mustache_3ce695c824466bcce83214729393fc8f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section30d05987ac7a9761fd1763be84a9a88a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section30d05987ac7a9761fd1763be84a9a88a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
