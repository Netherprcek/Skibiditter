...
class __Mustache_7f57e93bd6996f5cf66989a1d4e4efae extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section950c134cbbbb124f65f6f2b4cc14501a($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section950c134cbbbb124f65f6f2b4cc14501a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
