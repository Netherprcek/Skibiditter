...
class __Mustache_459a21941e6098292058acc0bea6b2d5 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section8400911672e979f45c06455ccd30fcd3($context, $indent, $value);
            $buffer .= ' ';
        }
        $buffer .= '
';
...
';
    ...
    private function section8400911672e979f45c06455ccd30fcd3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' {{> partials/followButton}} ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
