...
class __Mustache_d92dbe97b2d9846c671eb1bfb9b452eb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7009b07f41bc6b0781006a1da6b9eb12($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section7009b07f41bc6b0781006a1da6b9eb12(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
