...
class __Mustache_2cea9320ecb504570a2dac5521a12ea4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section28bee3fdeac21fd609a9c463f218354f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section28bee3fdeac21fd609a9c463f218354f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
