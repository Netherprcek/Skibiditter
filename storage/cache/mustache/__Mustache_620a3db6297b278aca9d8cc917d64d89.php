...
class __Mustache_620a3db6297b278aca9d8cc917d64d89 extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->find('username'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '/following" method="POST" class="inline">
';
...
';
        ...
        $buffer .= '" />
';
        $buffer .= $indent . '          <button type="submit" class="font-bold text-white hover:underline">
';
        $buffer .= $indent . '            ';
...
';
        ...
        $value = $this->resolveValue($context->find('user_id'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '/followers" method="POST" class="inline">
';
        $buffer .= $indent . '          <input type="hidden" name="username" value="';
        $value = $this->resolveValue($context->find('username'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
