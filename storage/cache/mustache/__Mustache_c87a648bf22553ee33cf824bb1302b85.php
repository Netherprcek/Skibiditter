...
class __Mustache_c87a648bf22553ee33cf824bb1302b85 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionCb25868efddfeec78a1c800adb207c44($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
        $buffer .= $indent . '  function validateFileSize(input, fileNameId) {
';
...
';
        $buffer .= $indent . '      document.getElementById(fileNameId).textContent = \'\';
';
        $buffer .= $indent . '    } else {
';
        $buffer .= $indent . '      document.getElementById(fileNameId).textContent = file.name;
';
        $buffer .= $indent . '    }
';
        $buffer .= $indent . '  }
';
    ...
    private function sectionCb25868efddfeec78a1c800adb207c44(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
