...
class __Mustache_c8d7a206d6cbf441e3ab030a57aa6f4d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9609355b20539d40635181e61d25486f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9609355b20539d40635181e61d25486f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
