...
class __Mustache_9268cfefbf70d6f2035d4020754ec2bd extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-24 text-left justify-items-end">
';
