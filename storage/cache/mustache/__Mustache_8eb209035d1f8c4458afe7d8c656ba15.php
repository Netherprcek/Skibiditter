...
class __Mustache_8eb209035d1f8c4458afe7d8c656ba15 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1356e405f4ba1bf97a36f3697af5351d($context, $indent, $value);
        $value = $context->find('is_following');
        if (empty($value)) {
            ...
            $buffer .= '/follow" method="POST" class="flex items-center">
';
...
';
    ...
    private function section1356e405f4ba1bf97a36f3697af5351d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<form action="/{{user_id}}/unfollow" method="POST" class="flex items-center">
  <button
    type="submit"
...
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('user_id'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/unfollow" method="POST" class="flex items-center">
';
                $buffer .= $indent . '  <button
';
                $buffer .= $indent . '    type="submit"
