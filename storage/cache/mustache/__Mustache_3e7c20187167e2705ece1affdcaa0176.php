...
class __Mustache_3e7c20187167e2705ece1affdcaa0176 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1a906ffee394680b0876f6969a1e56b0($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section1a906ffee394680b0876f6969a1e56b0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
