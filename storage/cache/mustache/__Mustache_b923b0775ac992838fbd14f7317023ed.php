...
class __Mustache_b923b0775ac992838fbd14f7317023ed extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB7e9a6b7e23ae8816e2f48e5dcd7e613($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB7e9a6b7e23ae8816e2f48e5dcd7e613(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
