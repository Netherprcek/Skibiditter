...
class __Mustache_4b34005f6bffb600085a420bd9dfe91a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAddd141a8d2b305d1b8c8c2b29af0146($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionAddd141a8d2b305d1b8c8c2b29af0146(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
