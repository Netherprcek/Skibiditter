...
class __Mustache_2f24d043397bd09a6bdd13a9e922f98c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF2bc2727771d95ad709bda2a7f59e67c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionF2bc2727771d95ad709bda2a7f59e67c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
