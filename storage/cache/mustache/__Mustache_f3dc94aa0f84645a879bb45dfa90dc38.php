...
class __Mustache_f3dc94aa0f84645a879bb45dfa90dc38 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0579c581573d3c6839d0f31bc9da20e0($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section0579c581573d3c6839d0f31bc9da20e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class="overflow-wrap break-word z-10 mb-4 break-words border-t-1 border-gray-600 px-6 py-3 text-gray-100"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class="overflow-wrap break-word z-10 mb-4 break-words border-t-1 border-gray-600 px-6 py-3 text-gray-100"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
