...
class __Mustache_8de4448e9ca447594e0205c5f117d885 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section296f9b1c7fd3e9484988bcc87c331a71($context, $indent, $value);
        $value = $context->find('currentPage');
...
';
    ...
    private function section296f9b1c7fd3e9484988bcc87c331a71(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
