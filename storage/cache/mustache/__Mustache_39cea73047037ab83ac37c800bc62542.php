...
class __Mustache_39cea73047037ab83ac37c800bc62542 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD18b5436f6b92636ede5c12dd0b540b5($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionD18b5436f6b92636ede5c12dd0b540b5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
