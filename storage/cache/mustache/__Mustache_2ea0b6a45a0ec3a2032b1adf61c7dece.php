...
class __Mustache_2ea0b6a45a0ec3a2032b1adf61c7dece extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4e8a8619241e779fdd9bddb1ca1ce078($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4e8a8619241e779fdd9bddb1ca1ce078(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
