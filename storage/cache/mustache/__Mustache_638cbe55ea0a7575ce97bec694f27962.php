...
class __Mustache_638cbe55ea0a7575ce97bec694f27962 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-textarea" class="hidden w-full bg-gray-800 p-2 text-gray-800"></textarea>
';
