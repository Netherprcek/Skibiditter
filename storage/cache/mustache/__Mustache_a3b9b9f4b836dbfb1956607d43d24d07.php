...
class __Mustache_a3b9b9f4b836dbfb1956607d43d24d07 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6e48b5f6c10db6ab219dd1d6327dfc83($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section6e48b5f6c10db6ab219dd1d6327dfc83(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
