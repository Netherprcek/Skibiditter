...
class __Mustache_6fe4842c69786ad5fc68493274891440 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBd615b966a7d15673e2662521fa9040c($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section5abf1acbb11964e6af85522bb1fede89(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-4/5 aspect-[4/3] object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-4/5 aspect-[4/3] object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function sectionBd615b966a7d15673e2662521fa9040c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section5abf1acbb11964e6af85522bb1fede89($context, $indent, $value);
