...
class __Mustache_b20b447ddb4d92ba8296c69a3f09a580 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD0b4ad8cd5785098230d739b96aae918($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionD0b4ad8cd5785098230d739b96aae918(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-2 md:px-2 mb-0 ">
';
