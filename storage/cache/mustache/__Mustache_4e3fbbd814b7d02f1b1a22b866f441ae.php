...
class __Mustache_4e3fbbd814b7d02f1b1a22b866f441ae extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7b40a2e05c5955e25f62951876ae6b9c($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section7b40a2e05c5955e25f62951876ae6b9c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="flex flex-col">
          <p class="text-lg font-semibold text-center text-white">{{post_text}}</p>
          <p class="text-lg font-semibold text-white">{{username}}</p>
          <p class="text-lg font-semibold text-white">{{created_at}}</p>
        </div>
        ';
...
';
                $buffer .= $indent . '          <p class="text-lg font-semibold text-center text-white">';
