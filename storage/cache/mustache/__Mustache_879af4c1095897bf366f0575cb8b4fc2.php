...
class __Mustache_879af4c1095897bf366f0575cb8b4fc2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section13621fb9bf07ec19c8a10b67945fa4a2($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section13621fb9bf07ec19c8a10b67945fa4a2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
