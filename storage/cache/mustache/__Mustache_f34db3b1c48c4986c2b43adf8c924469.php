...
class __Mustache_f34db3b1c48c4986c2b43adf8c924469 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB011cc47784c80e656d5bee8a0eda675($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionB011cc47784c80e656d5bee8a0eda675(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
