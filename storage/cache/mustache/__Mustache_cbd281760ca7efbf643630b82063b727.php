...
class __Mustache_cbd281760ca7efbf643630b82063b727 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC0d1264ebca1462ac46d66cd10603105($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionC0d1264ebca1462ac46d66cd10603105(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
