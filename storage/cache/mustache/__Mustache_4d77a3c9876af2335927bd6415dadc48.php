...
class __Mustache_4d77a3c9876af2335927bd6415dadc48 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        </h1>
';
        $buffer .= $indent . '        <form method="post" class="relative mb-4 mx-4">
';
        $buffer .= $indent . '          <input
';
...
';
        $buffer .= $indent . '          class=" right-1 top-1/2 -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
';
        $buffer .= $indent . '        >
';
        $buffer .= $indent . '          Post
