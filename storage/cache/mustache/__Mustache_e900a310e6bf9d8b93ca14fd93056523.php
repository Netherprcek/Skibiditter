...
class __Mustache_e900a310e6bf9d8b93ca14fd93056523 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0cd8e3d9fe498d11e04d71e3ab87c4ad($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section143a46ba89dfdb8e714652ffd252ed6c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <img src="{{img}}" alt="{{title}}" class="w-48 h-48 object-cover rounded">
          ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-48 h-48 object-cover rounded">
';
                $context->pop();
            }
        }
    ...
    private function section0cd8e3d9fe498d11e04d71e3ab87c4ad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section143a46ba89dfdb8e714652ffd252ed6c($context, $indent, $value);
