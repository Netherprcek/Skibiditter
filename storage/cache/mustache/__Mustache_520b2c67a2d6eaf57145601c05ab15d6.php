...
class __Mustache_520b2c67a2d6eaf57145601c05ab15d6 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section71eb7a81fdae037aee16c0a4f84d94e8($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section93cb8a1a2689171bdba5399496f77984(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section71eb7a81fdae037aee16c0a4f84d94e8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section93cb8a1a2689171bdba5399496f77984($context, $indent, $value);
