...
class __Mustache_855ad2d50d68228c9edfa4bdeb928c07 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF071f989c2151aab31491b47d51ec236($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionF071f989c2151aab31491b47d51ec236(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
