...
class __Mustache_3a0c18c6712c409140b889ab80400144 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section50c688b9edaca8ba0e006fb2d87ba27e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section50c688b9edaca8ba0e006fb2d87ba27e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative mb-6 rounded-lg bg-gray-800 px-6 py-2 pb-0 shadow-md">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative mb-6 rounded-lg bg-gray-800 px-6 py-2 pb-0 shadow-md">
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-6 md:px-12 mb-2">
';
