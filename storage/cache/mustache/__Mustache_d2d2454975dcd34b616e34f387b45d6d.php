...
class __Mustache_d2d2454975dcd34b616e34f387b45d6d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4b19c5a2fc82537b9406c5e2dd0c8e07($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section4b19c5a2fc82537b9406c5e2dd0c8e07(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
