...
class __Mustache_ce4c3440c6e3b88058667f547d292c22 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3b88f034fba90ec44b141e8abe8894a9($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section3b88f034fba90ec44b141e8abe8894a9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-4 border-b border-gray-700 pb-4">
          ...
          <p>{{comment_text}}</p>
          <div class="flex justify-center h-max mt-2">
            <form
...
';
                ...
                $buffer .= '</p>
';
                $buffer .= $indent . '          <div class="flex justify-center h-max mt-2">
';
                $buffer .= $indent . '            <form
';
