...
class __Mustache_30f918603c132d0a688ad08758e5a269 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section37d922d3eccc104dfcf34ed9bf0c1282($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section37d922d3eccc104dfcf34ed9bf0c1282(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '      name="previous_page"
';
                $buffer .= $indent . '      value="<?= htmlspecialchars($_SERVER[\'HTTP_REFERER\'] ?? \'/\') ?>"
';
                $buffer .= $indent . '    />
';
                $buffer .= $indent . '    <input type="hidden" name="post_id" value="';
