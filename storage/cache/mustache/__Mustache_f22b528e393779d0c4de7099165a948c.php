...
class __Mustache_f22b528e393779d0c4de7099165a948c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAe7b000ed99c5ef19aa9da92b8eef627($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionAe7b000ed99c5ef19aa9da92b8eef627(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
