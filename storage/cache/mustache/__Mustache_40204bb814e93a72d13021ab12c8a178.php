...
class __Mustache_40204bb814e93a72d13021ab12c8a178 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section23d66175252d37fbb708fe6977de1e5e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section23d66175252d37fbb708fe6977de1e5e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-700 rounded-lg z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-700 rounded-lg z-10">
';
                $buffer .= $indent . '    ';
