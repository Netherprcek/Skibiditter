...
class __Mustache_cc8208042de61798e69d905b7600e411 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6de87845264125ade0b0a73e1fc76a5e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section6de87845264125ade0b0a73e1fc76a5e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
