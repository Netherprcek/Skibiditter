...
class __Mustache_5a0b8ee52328f4223dcbdd6c68628ea0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9e81085e26503d38a31c7a8109dabe7d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9e81085e26503d38a31c7a8109dabe7d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
