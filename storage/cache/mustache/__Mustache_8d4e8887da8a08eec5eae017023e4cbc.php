...
class __Mustache_8d4e8887da8a08eec5eae017023e4cbc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section74d47cc95476890ca85cafa0ffb2654e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section74d47cc95476890ca85cafa0ffb2654e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div>
    <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100  rounded-lg z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <div>
';
                $buffer .= $indent . '    <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100  rounded-lg z-10">
';
                $buffer .= $indent . '    ';
