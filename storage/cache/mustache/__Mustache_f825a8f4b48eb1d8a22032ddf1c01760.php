...
class __Mustache_f825a8f4b48eb1d8a22032ddf1c01760 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section78ab0fdd1fe538d1d9ad23b93662ae57($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section78ab0fdd1fe538d1d9ad23b93662ae57(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
