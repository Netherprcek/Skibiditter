...
class __Mustache_bb6a911984d1ef710e95a096cfa03193 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section82f17d5ff4d2c12ac839072dd6a42bdc($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section4e54147b655dea92c4516a4110b2de05(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center">
                <img src="{{img}}" alt="{{title}}" class="w-1/5 h-auto object-contain" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-1/5 h-auto object-contain" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section82f17d5ff4d2c12ac839072dd6a42bdc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section4e54147b655dea92c4516a4110b2de05($context, $indent, $value);
