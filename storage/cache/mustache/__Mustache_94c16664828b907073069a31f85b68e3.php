...
class __Mustache_94c16664828b907073069a31f85b68e3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEc9bbf338ab62c44807928fd07fb920d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionEc9bbf338ab62c44807928fd07fb920d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700 p-2">
          ...
          <span class="pl-14 overflow-wrap break-word z-10 break-words">{{comment_text}}</span>
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <span class="pl-14 overflow-wrap break-word z-10 break-words">';
