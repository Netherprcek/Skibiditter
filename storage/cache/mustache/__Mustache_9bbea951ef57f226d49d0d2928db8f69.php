...
class __Mustache_9bbea951ef57f226d49d0d2928db8f69 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <label for="imageFileInput1" class="block text-white mb-2">Upload Image 1</label>
';
        $buffer .= $indent . '      <div class="flex items-center">
';
        $buffer .= $indent . '        <label class="custom-file-upload bg-blue-500 text-white p-2 rounded-lg cursor-pointer hover:bg-blue-600">
';
        $buffer .= $indent . '          Choose File
';
        $buffer .= $indent . '          <input
';
...
';
        $buffer .= $indent . '            onchange="document.getElementById(\'fileName1\').textContent = this.files[0].name"
';
        $buffer .= $indent . '          />
';
        $buffer .= $indent . '        </label>
';
        $buffer .= $indent . '        <span id="fileName1" class="ml-2 text-white"></span>
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
...
';
        $buffer .= $indent . '    <div class="relative mb-4">
';
        $buffer .= $indent . '      <label for="imageFileInput2" class="block text-white mb-2">Upload Image 2</label>
';
        $buffer .= $indent . '      <div class="flex items-center">
';
        $buffer .= $indent . '        <label class="custom-file-upload bg-blue-500 text-white p-2 rounded-lg cursor-pointer hover:bg-blue-600">
...
';
        $buffer .= $indent . '            accept="image/*"
';
        $buffer .= $indent . '            onchange="document.getElementById(\'fileName2\').textContent = this.files[0].name"
';
        $buffer .= $indent . '          />
';
        $buffer .= $indent . '        </label>
';
        $buffer .= $indent . '        <span id="fileName2" class="ml-2 text-white"></span>
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
