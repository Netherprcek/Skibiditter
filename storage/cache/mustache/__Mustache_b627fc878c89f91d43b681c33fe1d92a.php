...
class __Mustache_b627fc878c89f91d43b681c33fe1d92a extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-16 flex h-[calc(100vh-4rem)] w-4/12 content-end overflow-y-auto border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '  <div class="flex w-1/2 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-32 text-left ">
';
