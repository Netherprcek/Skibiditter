...
class __Mustache_1043a748c968bddaca37858ab1652848 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC648d27e7aefd41737f3735c5d568339($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionC648d27e7aefd41737f3735c5d568339(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="border-l-2 border-gray-800 max-w-2xl w-full">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="border-l-2 border-gray-800 max-w-2xl w-full">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
