...
class __Mustache_bd6e2de8c43e5c1d9499582a644fdf98 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBd1a56359ce28d7e2fa2ce196ca1b7ca($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionBd1a56359ce28d7e2fa2ce196ca1b7ca(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
