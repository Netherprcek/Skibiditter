...
class __Mustache_19f1556385aa5ea252280a061927cada extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB5ab881fe10030b9200b500c34f7df5e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB5ab881fe10030b9200b500c34f7df5e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800  py-4 pb-0 shadow-md">
  <div class="mb-2 flex items-center justify-between pl-2 pr-6">
...
';
                $buffer .= $indent . '  <div class="mb-2 flex items-center justify-between pl-2 pr-6">
';
