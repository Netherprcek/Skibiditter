...
class __Mustache_8dedd3ece7efcebcfbcea53d0d9c9334 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0b6beebc6100d865356895f2f1b36dca($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionFa0bc82ebf01cbcf93f838ad2f151f0f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-full max-h-32 object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-full max-h-32 object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section0b6beebc6100d865356895f2f1b36dca(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionFa0bc82ebf01cbcf93f838ad2f151f0f($context, $indent, $value);
