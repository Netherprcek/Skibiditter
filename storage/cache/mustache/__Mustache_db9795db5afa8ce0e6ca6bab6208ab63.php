...
class __Mustache_db9795db5afa8ce0e6ca6bab6208ab63 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCf631f05c025d0e2454ef02685632786($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionCf631f05c025d0e2454ef02685632786(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            <div class="mb-4"></div>
';
                if ($partial = $this->mustache->loadPartial('partials/profileAvatar')) {
                    $buffer .= $partial->renderInternal($context, $indent . '              ');
                }
