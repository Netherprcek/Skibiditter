...
class __Mustache_386cc6ddc0b4592c499ab1ae1868af29 extends Mustache_Template
{
...
';
        ...
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '\'s avatar" class="w-24 h-24 rounded-full border-4 border-gray-800 mr-4 mt-8">
';
        $buffer .= $indent . '      
';
