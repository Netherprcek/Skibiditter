...
class __Mustache_0d5520cb71183bd0ab6ef22211758882 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section19aa00b2a671d47332420264bb0055c4($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section19aa00b2a671d47332420264bb0055c4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div class="relative">
    <div class="absolute left-8 top-0 h-4 w-4 rotate-45 transform bg-gray-700"></div>
    <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 text-gray-100 rounded-lg bg-gray-700 shadow-inner relative z-10">
      {{ post_text }}
    </p>
  </div>
...
';
                $buffer .= $indent . '  <div class="relative">
';
                $buffer .= $indent . '    <div class="absolute left-8 top-0 h-4 w-4 rotate-45 transform bg-gray-700"></div>
';
                $buffer .= $indent . '    <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 text-gray-100 rounded-lg bg-gray-700 shadow-inner relative z-10">
';
                $buffer .= $indent . '      ';
