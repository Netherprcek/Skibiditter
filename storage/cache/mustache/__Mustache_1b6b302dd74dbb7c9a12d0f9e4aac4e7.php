...
class __Mustache_1b6b302dd74dbb7c9a12d0f9e4aac4e7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA7d689cabcfaf9013d97f21728b118ce($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionA7d689cabcfaf9013d97f21728b118ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-1 border-gray-700 rounded-lg z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-1 border-gray-700 rounded-lg z-10">
';
                $buffer .= $indent . '    ';
