...
class __Mustache_87992ad5952fb40867dc84df2b7daae9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6d8fd1c8a9f55e78a8a2d3451ad40bfe($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section6d8fd1c8a9f55e78a8a2d3451ad40bfe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
