...
class __Mustache_76c60bd7c06fd43991e96c2de0b41221 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        class="hidden w-full resize-none overflow-hidden rounded-lg bg-gray-600 p-2 text-white"
';
        $buffer .= $indent . '      ></textarea>
';
...
';
        $buffer .= $indent . '        class="mt-2 hidden rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700"
';
        $buffer .= $indent . '      >
';
