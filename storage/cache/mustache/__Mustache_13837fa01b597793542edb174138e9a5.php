...
class __Mustache_13837fa01b597793542edb174138e9a5 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="flex w-1/4 content-end flex-col border-r-2 border-gray-800 pl-4 text-right pr-6"
';
        $buffer .= $indent . '>
';
