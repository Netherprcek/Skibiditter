...
class __Mustache_9ab1161471c47cfb50b07fbe727de64b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section99c31c2afb1f96cc10b57d6022740a5d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section99c31c2afb1f96cc10b57d6022740a5d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
