...
class __Mustache_3cad118965988e6651351d709a7973ae extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section77ac9c3bf6876efc0196e173dff5e438($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section2452edc45dba5cdb59fe074284f66d6c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center">
                <img src="{{img}}" alt="{{title}}" class="w-64 h-auto object-cover" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-64 h-auto object-cover" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section77ac9c3bf6876efc0196e173dff5e438(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section2452edc45dba5cdb59fe074284f66d6c($context, $indent, $value);
