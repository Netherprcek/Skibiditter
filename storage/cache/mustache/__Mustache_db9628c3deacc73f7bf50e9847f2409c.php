...
class __Mustache_db9628c3deacc73f7bf50e9847f2409c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF8afc9e57e167cacf6447d13e00b29dc($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionF8afc9e57e167cacf6447d13e00b29dc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
