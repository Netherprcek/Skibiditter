...
class __Mustache_3543da61252e0f280c9fb06122b3da66 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0b62884f41537c85b68f8f0b8bd21196($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section90d9a3f11417e098dbf35cec3a8b4f9a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section0b62884f41537c85b68f8f0b8bd21196(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section90d9a3f11417e098dbf35cec3a8b4f9a($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
