...
class __Mustache_f7d8263355cc5e3e69997902ecbcbdb0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1be9e7948579e47b1c9128ed91a06f90($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section1be9e7948579e47b1c9128ed91a06f90(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
