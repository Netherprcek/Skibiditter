...
class __Mustache_77272dc948c2d285d1245d7c9630cd7c extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col pl-0 md:pl-32 lg:pl-20 text-left ">
';
