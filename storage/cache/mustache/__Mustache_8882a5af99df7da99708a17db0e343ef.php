...
class __Mustache_8882a5af99df7da99708a17db0e343ef extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section50e8d64cd4542d881ccefeba557eb1a2($context, $indent, $value);
        $buffer .= ' ';
...
';
    ...
    private function section50e8d64cd4542d881ccefeba557eb1a2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
      <div class="mb-6 rounded-lg border border-blue-600 bg-gray-700 p-6 shadow-md">
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '      <div class="mb-6 rounded-lg border border-blue-600 bg-gray-700 p-6 shadow-md">
';
