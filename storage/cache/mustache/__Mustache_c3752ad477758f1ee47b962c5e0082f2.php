...
class __Mustache_c3752ad477758f1ee47b962c5e0082f2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6e2d798807a138bc5d1e240ca448d9ff($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section6e2d798807a138bc5d1e240ca448d9ff(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
