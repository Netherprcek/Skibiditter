...
class __Mustache_4d8304aad51fb11306725dbec316d839 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6c8912709698763dccac62e0eefa521f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section6c8912709698763dccac62e0eefa521f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-700">
          ...
          <span class="pl-8">{{comment_text}}</span>
