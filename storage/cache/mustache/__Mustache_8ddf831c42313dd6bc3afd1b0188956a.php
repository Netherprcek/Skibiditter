...
class __Mustache_8ddf831c42313dd6bc3afd1b0188956a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1d5480efee575552ca8cb8007ab34d3e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section1d5480efee575552ca8cb8007ab34d3e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
