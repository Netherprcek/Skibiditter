...
class __Mustache_0b737a2c3d846fcd6ee574b605631c17 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section57fab0b2b1bd57409e062dc221238276($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section57fab0b2b1bd57409e062dc221238276(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem border-x">
...
';
                $buffer .= $indent . '    <div style="width: 100%; max-width: 42rem border-x">
';
