...
class __Mustache_32d31a6ddcb0380e42e50a75fbb9b622 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2a5373bdfcb6f65b715011df54df28fb($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section2a5373bdfcb6f65b715011df54df28fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
