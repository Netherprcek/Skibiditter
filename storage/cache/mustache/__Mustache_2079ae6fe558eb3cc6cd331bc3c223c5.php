...
class __Mustache_2079ae6fe558eb3cc6cd331bc3c223c5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBcb2460b28493e3ff737537490cc5eee($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionBcb2460b28493e3ff737537490cc5eee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2">
          <span>{{> partials/postsAvatar }} {{ username }}</span>
          <span class="pt-0 text-lg font-semibold text-white">
            {{ username }}
          </span>
          <p>{{comment_text}}</p>
