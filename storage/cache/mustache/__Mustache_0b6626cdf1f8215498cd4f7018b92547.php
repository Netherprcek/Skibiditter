...
class __Mustache_0b6626cdf1f8215498cd4f7018b92547 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section44727045705b090341aebf04bc0c8110($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section44727045705b090341aebf04bc0c8110(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
