...
class __Mustache_cc0aea44ada49a1c68c47982eda35aa9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEd817f4e0ec70172b75199e5906194c2($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionEd817f4e0ec70172b75199e5906194c2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    <div class="flex items-center w-full">
      ...
      <span class="text-sm pt-0 pr-10 text-gray-300">Created at: {{ formatted_created_at }}</span>
    </div>
    {{#is_owner}}
    <div class="relative">
      <button class="text-white" onclick="toggleOptions(\'{{id_post}}\', event)">
...
';
                ...
                $value = $this->resolveValue($context->find('formatted_created_at'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</span>
';
                $buffer .= $indent . '    </div>
