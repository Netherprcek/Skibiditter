...
class __Mustache_11a67c7bba1deb4d030cd49cbc152c6e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB8477d46f0f8e02f1e4df54d8d7d6d01($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionB8477d46f0f8e02f1e4df54d8d7d6d01(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
