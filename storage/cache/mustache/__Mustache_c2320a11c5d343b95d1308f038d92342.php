...
class __Mustache_c2320a11c5d343b95d1308f038d92342 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionF21af77f5c8a35f07a82d968a3c9195c($context, $indent, $value);
            $buffer .= ' ';
        }
        $buffer .= '
';
...
';
    ...
    private function sectionF21af77f5c8a35f07a82d968a3c9195c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' <div class="mt-16">{{> partials/followButton}}</div> ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
