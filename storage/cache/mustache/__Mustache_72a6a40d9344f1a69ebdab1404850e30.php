...
class __Mustache_72a6a40d9344f1a69ebdab1404850e30 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    ></textarea>
';
        $buffer .= $indent . '    <button type="submit" class="relative right-2  rounded-lg bg-blue-500 p-2 text-white">
';
