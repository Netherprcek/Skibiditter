...
class __Mustache_48e90fb1d323b3d6dda8c6bf6afd329e extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <p id="bio-text">';
        $value = $this->resolveValue($context->findDot('profile.bio'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-textarea" class="hidden w-full rounded-lg resize-none overflow-hidden bg-gray-600 p-2 text-white" placeholder="Update your bio">Update your bio</textarea>
';
        $buffer .= $indent . '      <button id="update-bio-button" class="hidden mt-2 rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">Update</button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
