...
class __Mustache_f04b1d0ee3df8e0144f1ce7b7e911bae extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB02a359715b42bf616d2ee6ef5e18ca7($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function sectionB02a359715b42bf616d2ee6ef5e18ca7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
