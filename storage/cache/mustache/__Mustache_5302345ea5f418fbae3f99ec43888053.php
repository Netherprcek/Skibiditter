...
class __Mustache_5302345ea5f418fbae3f99ec43888053 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBb3b98961f6566462b1ce8fb812cecb9($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionBb3b98961f6566462b1ce8fb812cecb9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
