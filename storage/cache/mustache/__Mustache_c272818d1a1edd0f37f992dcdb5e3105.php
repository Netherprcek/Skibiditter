...
class __Mustache_c272818d1a1edd0f37f992dcdb5e3105 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-16 h-[calc(100vh-4rem)] flex w-1/3 content-end border-r-2 border-gray-800 pl-4 pr-4 mt-4 text-right overflow-y-auto"
';
        $buffer .= $indent . '>
';
