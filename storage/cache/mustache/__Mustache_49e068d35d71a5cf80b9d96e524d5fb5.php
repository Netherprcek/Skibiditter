...
class __Mustache_49e068d35d71a5cf80b9d96e524d5fb5 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<a href="/profile" class="ml-10 h-10 rounded-full bg-blue-500 p-0.5">
';
        $buffer .= $indent . '  <div
';
