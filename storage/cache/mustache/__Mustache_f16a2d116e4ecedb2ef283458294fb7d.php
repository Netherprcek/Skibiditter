...
class __Mustache_f16a2d116e4ecedb2ef283458294fb7d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section862af06b8da4f293ce0d26dae2d9577e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section862af06b8da4f293ce0d26dae2d9577e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
