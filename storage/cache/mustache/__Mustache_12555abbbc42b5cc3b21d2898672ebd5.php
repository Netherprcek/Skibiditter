...
class __Mustache_12555abbbc42b5cc3b21d2898672ebd5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section402c2012afbc927662d2e31d916f331a($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section402c2012afbc927662d2e31d916f331a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700 p-2">
          ...
          <span class="pl-14 break-words">{{comment_text}}</span>
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <span class="pl-14 break-words">';
