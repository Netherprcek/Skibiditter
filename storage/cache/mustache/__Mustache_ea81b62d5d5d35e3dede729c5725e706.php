...
class __Mustache_ea81b62d5d5d35e3dede729c5725e706 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5842fa9005a56074e39c7e06c06a4823($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('is_following');
        if (empty($value)) {
...
';
    ...
    private function section5842fa9005a56074e39c7e06c06a4823(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
