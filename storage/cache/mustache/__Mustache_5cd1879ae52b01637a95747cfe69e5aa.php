...
class __Mustache_5cd1879ae52b01637a95747cfe69e5aa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section64f3268a6c8adc088b15f3862c6b047a($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section8ac99ae57c96e751f3f8148aa0b41d3b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section64f3268a6c8adc088b15f3862c6b047a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('session_user');
                $buffer .= $this->section8ac99ae57c96e751f3f8148aa0b41d3b($context, $indent, $value);
