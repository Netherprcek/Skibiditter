...
class __Mustache_46be72684f500ff75dfa1b63912a0cb3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2eeee671311515332857b05a21e39d73($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section882b24b645f0dc3149277e9500f3b6ee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2eeee671311515332857b05a21e39d73(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('is_owner');
                $buffer .= $this->section882b24b645f0dc3149277e9500f3b6ee($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
