...
class __Mustache_ed08705c1a7aafa816ea0abd6eb2c502 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col  md:pl-16 lg:pl-20 text-left ">
';
