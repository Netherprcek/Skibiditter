...
class __Mustache_db0edef889b500b8798f82983bfd2ebf extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC4a529d77c25d3f50ab9abc1183aabea($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionCb319291388bee3199c63ed77cd3f99d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="relative">
      ...
      >
        ...
        <form action="/{{id_post}}/delete" id="deleteForm" method="POST" class="m-0 block">
...
';
                ...
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/delete" id="deleteForm" method="POST" class="m-0 block">
';
...
';
    ...
    private function sectionC4a529d77c25d3f50ab9abc1183aabea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('is_owner');
                $buffer .= $this->sectionCb319291388bee3199c63ed77cd3f99d($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
