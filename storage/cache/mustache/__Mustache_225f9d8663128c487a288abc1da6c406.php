...
class __Mustache_225f9d8663128c487a288abc1da6c406 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAd00e0c41cc37fe1e18af62bf01e501b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionAd00e0c41cc37fe1e18af62bf01e501b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '<div class="flex w-full mt-24">
';
                $buffer .= $indent . '  ';
