...
class __Mustache_0af42a68b401ad71f1da993f949ef5a6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section942d152e6754e9489d05f31ff3a5cfe4($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section942d152e6754e9489d05f31ff3a5cfe4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" enctype="multipart/form-data" class="relative mb-4 mx-4">
        <div class="relative mb-4 flex items-center justify-between">
          ...
          <div class="flex items-center">
            ...
            <label class="cursor-pointer flex items-center">
              <img src="path/to/banner.svg" class="h-6 w-6 text-white hover:text-gray-300" alt="Background Banner" />
              <input
                type="file"
...
';
                $buffer .= $indent . '            <label class="cursor-pointer flex items-center">
';
                $buffer .= $indent . '              <img src="path/to/banner.svg" class="h-6 w-6 text-white hover:text-gray-300" alt="Background Banner" />
';
                $buffer .= $indent . '              <input
';
                $buffer .= $indent . '                type="file"
