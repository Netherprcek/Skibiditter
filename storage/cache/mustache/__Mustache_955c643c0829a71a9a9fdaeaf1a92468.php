...
class __Mustache_955c643c0829a71a9a9fdaeaf1a92468 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF132d1e9faec87df6c2b9625a2580b91($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionF132d1e9faec87df6c2b9625a2580b91(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
