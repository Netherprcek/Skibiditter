...
class __Mustache_7a09733da14e7901340548b8db39131a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section566cf3c9e683b4a3cf8161e459c34578($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section566cf3c9e683b4a3cf8161e459c34578(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
