...
class __Mustache_112a5a8ca5219f67e9cdb34f5b5d55bd extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-textarea" class="hidden w-full rounded-lg resize-none overflow-hidden bg-gray-600 p-2 text-white" placeholder="Update your bio"></textarea>
';
