...
class __Mustache_3f7e5827a3bef3a26e80039534fb1b02 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section152bde5f7bc8b209fcbe0bbe31a90672($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section152bde5f7bc8b209fcbe0bbe31a90672(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
