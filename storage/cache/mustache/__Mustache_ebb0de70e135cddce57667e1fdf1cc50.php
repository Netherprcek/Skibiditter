...
class __Mustache_ebb0de70e135cddce57667e1fdf1cc50 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB9bc7b3472848477ac658b0bf50c8c3b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionB9bc7b3472848477ac658b0bf50c8c3b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
