...
class __Mustache_c64ffacb2d3bf2b950fab87567982d24 extends Mustache_Template
{
...
';
        $value = $context->findDot('profile.is_owner');
        $buffer .= $this->section8c3b652e14a6f3863980a90402ff26db($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section8c3b652e14a6f3863980a90402ff26db(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
