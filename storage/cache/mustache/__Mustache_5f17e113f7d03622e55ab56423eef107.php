...
class __Mustache_5f17e113f7d03622e55ab56423eef107 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB1cc49cd901f8a256639262955856e9a($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionB1cc49cd901f8a256639262955856e9a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
