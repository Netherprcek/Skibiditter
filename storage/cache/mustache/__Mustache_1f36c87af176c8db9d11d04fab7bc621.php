...
class __Mustache_1f36c87af176c8db9d11d04fab7bc621 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3e73e1d903e1d1b72a9dd5bca77c8294($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section3e73e1d903e1d1b72a9dd5bca77c8294(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex flex-grow justify-center">
    <div class="border-x-2 border-gray-800 max-w-3xl w-full">
