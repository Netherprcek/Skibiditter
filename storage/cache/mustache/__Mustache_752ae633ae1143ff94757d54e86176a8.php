...
class __Mustache_752ae633ae1143ff94757d54e86176a8 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section2b5bcb4a5d6d106668cac25c09b59687($context, $indent, $value);
            $buffer .= ' ';
        }
        $buffer .= '
';
...
';
    ...
    private function section2b5bcb4a5d6d106668cac25c09b59687(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
