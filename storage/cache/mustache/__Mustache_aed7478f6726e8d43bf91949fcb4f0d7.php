...
class __Mustache_aed7478f6726e8d43bf91949fcb4f0d7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7967ffb1c68ee6faeffeef1d73064646($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionA3ea284c866ed86140dd9b0d1408debc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7967ffb1c68ee6faeffeef1d73064646(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionA3ea284c866ed86140dd9b0d1408debc($context, $indent, $value);
                $value = $context->find('session_user');
                if (empty($value)) {
