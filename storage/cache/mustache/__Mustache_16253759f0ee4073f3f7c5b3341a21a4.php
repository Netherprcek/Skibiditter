...
class __Mustache_16253759f0ee4073f3f7c5b3341a21a4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1d45515fd8925467e4b9d75c2debbbec($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section1d45515fd8925467e4b9d75c2debbbec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <div class="mx-4"></div>{{> partials/postForm}}</div>
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <div class="mx-4"></div>';
