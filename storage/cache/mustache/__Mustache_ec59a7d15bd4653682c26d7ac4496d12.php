...
class __Mustache_ec59a7d15bd4653682c26d7ac4496d12 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFc187a9206f7f94b0ca90f9a8cc2793d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionFc187a9206f7f94b0ca90f9a8cc2793d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative mb-6 rounded-lg bg-gray-800 px-6 py-4 pb-0 shadow-md">
  <div class="mb-2flex items-center justify-between">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative mb-6 rounded-lg bg-gray-800 px-6 py-4 pb-0 shadow-md">
';
                $buffer .= $indent . '  <div class="mb-2flex items-center justify-between">
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-6 md:px-12 mb-0">
';
