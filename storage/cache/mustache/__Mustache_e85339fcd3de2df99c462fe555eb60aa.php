...
class __Mustache_e85339fcd3de2df99c462fe555eb60aa extends Mustache_Template
{
...
';
        $buffer .= $indent . '    class="fixed right-4 top-4 rounded border-l-4 border-yellow-500 bg-yellow-100 p-4 text-yellow-700 opacity-0 shadow-md transition-opacity duration-300"
';
        $buffer .= $indent . '    role="alert"
';
        $buffer .= $indent . '  >
';
        $buffer .= $indent . '    <p id="notification-message">*lorem</p>
';
        $buffer .= $indent . '  </div>
';
        $buffer .= $indent . '
