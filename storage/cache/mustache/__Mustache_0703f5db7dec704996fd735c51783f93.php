...
class __Mustache_0703f5db7dec704996fd735c51783f93 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    class="fixed left-1/2 top-16 z-50 hidden -translate-x-1/2 transform rounded border-l-4 border-yellow-500 bg-yellow-100 p-4 text-yellow-700 opacity-0 shadow-md transition-opacity duration-300"
';
