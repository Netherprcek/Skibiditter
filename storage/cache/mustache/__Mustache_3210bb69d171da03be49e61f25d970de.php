...
class __Mustache_3210bb69d171da03be49e61f25d970de extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5fb4d93207504ead0f0a9501d3b59524($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section5fb4d93207504ead0f0a9501d3b59524(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
