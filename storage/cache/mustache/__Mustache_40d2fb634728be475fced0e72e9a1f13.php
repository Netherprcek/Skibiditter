...
class __Mustache_40d2fb634728be475fced0e72e9a1f13 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDaf7332c6d616e31be04b179eef15e75($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionDaf7332c6d616e31be04b179eef15e75(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
