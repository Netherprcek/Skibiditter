...
class __Mustache_b9edb09e0f2af94bde246df1c0805131 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB64c084cba2af2f07f99005e98d1585d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function sectionB64c084cba2af2f07f99005e98d1585d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
