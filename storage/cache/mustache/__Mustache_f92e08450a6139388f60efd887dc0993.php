...
class __Mustache_f92e08450a6139388f60efd887dc0993 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section977f214f0e2d561908f32f97d5f88d79($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section977f214f0e2d561908f32f97d5f88d79(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
