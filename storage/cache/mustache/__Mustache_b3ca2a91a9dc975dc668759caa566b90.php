...
class __Mustache_b3ca2a91a9dc975dc668759caa566b90 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section53d5138663b3604af387834a59bc18de($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section53d5138663b3604af387834a59bc18de(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-700">
          ...
          <span class="pl-4">{{comment_text}}</span>
