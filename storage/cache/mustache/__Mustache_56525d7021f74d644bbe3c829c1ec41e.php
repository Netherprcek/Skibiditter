...
class __Mustache_56525d7021f74d644bbe3c829c1ec41e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF365133f7d06483acb5fc0f45c127a05($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionF365133f7d06483acb5fc0f45c127a05(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
