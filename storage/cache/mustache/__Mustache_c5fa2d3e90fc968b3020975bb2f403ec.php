...
class __Mustache_c5fa2d3e90fc968b3020975bb2f403ec extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDf0682f7d6ba14b1fa575b672f4b7a8a($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionDf0682f7d6ba14b1fa575b672f4b7a8a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
  ...
  <form action="/{{id_post}}/edit" method="post">
    ...
    <a href="/{{id_post}}/delete">
      <button class="mt-2 rounded-lg bg-red-500 p-2 text-white">Delete</button>
    </a>
  </form>
...
';
                ...
                $buffer .= '/delete">
';
                $buffer .= $indent . '      <button class="mt-2 rounded-lg bg-red-500 p-2 text-white">Delete</button>
';
                $buffer .= $indent . '    </a>
';
                $buffer .= $indent . '  </form>
