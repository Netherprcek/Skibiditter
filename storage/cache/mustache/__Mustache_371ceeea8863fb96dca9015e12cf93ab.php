...
class __Mustache_371ceeea8863fb96dca9015e12cf93ab extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEdd4cc3510363fa9427613b6cb1fc960($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->section6b5b2117132b6d50b2a91793d453b9e3($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionEdd4cc3510363fa9427613b6cb1fc960(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
        ...
        <div class="flex flex-col">
          <p class="mb-2 px-14 text-gray-200 break-words overflow-wrap break-word">{{ post_text }}</p>
...
';
                $buffer .= $indent . '          <p class="mb-2 px-14 text-gray-200 break-words overflow-wrap break-word">';
...
';
    ...
    private function section6b5b2117132b6d50b2a91793d453b9e3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
