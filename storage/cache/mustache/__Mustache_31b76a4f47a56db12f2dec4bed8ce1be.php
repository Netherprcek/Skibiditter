...
class __Mustache_31b76a4f47a56db12f2dec4bed8ce1be extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6bfef898ab41b39ac42e45b41434b7c5($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section6bfef898ab41b39ac42e45b41434b7c5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" enctype="multipart/form-data" class="relative mb-4 mx-4">
        <div class="relative mb-4 flex items-center justify-center space-x-8">
...
';
                $buffer .= $indent . '        <div class="relative mb-4 flex items-center justify-center space-x-8">
';
