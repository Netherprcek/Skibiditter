...
class __Mustache_f9d5bbf73454ff86cc20fd693646b54d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC17ab110118094e678a664706a0a450f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionC17ab110118094e678a664706a0a450f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
