...
class __Mustache_01df03aa80e85eeb6a402d7f002b1ea6 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section77f70f24a75f72358914670abf8af125($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section77f70f24a75f72358914670abf8af125(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-4 border-b border-gray-700 pb-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
