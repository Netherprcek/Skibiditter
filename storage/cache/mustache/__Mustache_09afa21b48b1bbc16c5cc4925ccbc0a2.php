...
class __Mustache_09afa21b48b1bbc16c5cc4925ccbc0a2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section26812137d3528ec1a49d7800ec651493($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section26812137d3528ec1a49d7800ec651493(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800  py-4 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between pl-2 pr-5">
...
';
                $buffer .= $indent . '  <div class="mb-4 flex items-center justify-between pl-2 pr-5">
';
