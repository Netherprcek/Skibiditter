...
class __Mustache_1d7865b8aa4025206d86fb1163d8a8dd extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <div class="flex w-2/2 flex-col xl:pl-12 justify-self-end text-left">
';
