...
class __Mustache_798be4ae49a35ce5e95b2be35fe67ee1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section53c2364194beae6aeaad99e49542feff($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section4be22115c9a0d471e88733c42b85db38(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section53c2364194beae6aeaad99e49542feff(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section4be22115c9a0d471e88733c42b85db38($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
