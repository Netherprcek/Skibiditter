...
class __Mustache_47c9a1b274a7e9bcadf58fe04eb81c0d extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '      <div class="rounded-lg p-6 ">
';
        $value = $context->find('comments');
        $buffer .= $this->section864d10891715890b493eb430a432d87a($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section864d10891715890b493eb430a432d87a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 rounded-lg border-b border-gray-600 bg-gray-800 p-2">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 rounded-lg border-b border-gray-600 bg-gray-800 p-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
