...
class __Mustache_a9a7e254206478ccece965d1a672126e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1e71dd93994843bd77ea9017d47c4f13($context, $indent, $value);
        $buffer .= '
';
...
';
    ...
    private function section1e71dd93994843bd77ea9017d47c4f13(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' <div class="mx-4"></div>{{> partials/postForm}}</div> ';
