...
class __Mustache_43d3ea6b32bc1bafa2d08c4c612f6d3e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0a3ab3c1bf52bc5af2667e21f1152685($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section0a3ab3c1bf52bc5af2667e21f1152685(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <div class="mx-4">{{> partials/postForm}}</div>
