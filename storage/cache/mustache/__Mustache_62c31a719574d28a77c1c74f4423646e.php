...
class __Mustache_62c31a719574d28a77c1c74f4423646e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section347d4718441781c73d47e384df39122f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section347d4718441781c73d47e384df39122f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pt-2 pb-0 shadow-md">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pt-2 pb-0 shadow-md">
';
