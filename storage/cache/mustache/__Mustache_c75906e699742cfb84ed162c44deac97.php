...
class __Mustache_c75906e699742cfb84ed162c44deac97 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col pl-0 md:pl-4 lg:pl-8 text-left ">
';
