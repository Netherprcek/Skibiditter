...
class __Mustache_2d77df57e4edd0de58bac370bbca9ce8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA5886be3d3c611f8cb4080eb8f1593a1($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionA5886be3d3c611f8cb4080eb8f1593a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
