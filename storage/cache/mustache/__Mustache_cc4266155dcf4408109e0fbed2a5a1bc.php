...
class __Mustache_cc4266155dcf4408109e0fbed2a5a1bc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3ca168eb4e1ee0fe25bbbca9d7bc5816($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section3ca168eb4e1ee0fe25bbbca9d7bc5816(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
