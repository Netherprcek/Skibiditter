...
class __Mustache_479f6f399e7b26d5e0b9aaa65316ef1f extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '      <div class="rounded-lg bg-gray-800  shadow-md">
';
        $value = $context->find('comments');
        $buffer .= $this->sectionA10e10f26148fc3f21994e148f59d420($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionA10e10f26148fc3f21994e148f59d420(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
