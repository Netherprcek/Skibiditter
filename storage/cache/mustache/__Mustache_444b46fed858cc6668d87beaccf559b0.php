...
class __Mustache_444b46fed858cc6668d87beaccf559b0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE23dc00e3b9eeb287298b33ca2048250($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionE23dc00e3b9eeb287298b33ca2048250(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
