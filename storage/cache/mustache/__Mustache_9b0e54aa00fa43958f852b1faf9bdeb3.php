...
class __Mustache_9b0e54aa00fa43958f852b1faf9bdeb3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col xl:pl-40 text-left justify-items-end">
';
