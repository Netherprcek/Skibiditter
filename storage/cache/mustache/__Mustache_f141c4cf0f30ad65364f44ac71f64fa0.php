...
class __Mustache_f141c4cf0f30ad65364f44ac71f64fa0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-16 flex h-[calc(100vh-4rem)] w-1/3 content-end overflow-y-auto border-r-2 border-gray-800 pl-4 pr-4 pt-8 text-right"
';
        $buffer .= $indent . '>
';
