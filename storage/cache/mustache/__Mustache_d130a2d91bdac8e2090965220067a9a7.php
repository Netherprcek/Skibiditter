...
class __Mustache_d130a2d91bdac8e2090965220067a9a7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section27a4d0344fa4166e64318af2a54fcf1e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section27a4d0344fa4166e64318af2a54fcf1e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="mb-2 px-14 mr-10 text-gray-200">{{ post_text }}</p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
    <img
      src="{{ img }}"
...
';
                ...
                $buffer .= '</h2>
';
                $buffer .= $indent . '  <p class="mb-2 px-14 mr-10 text-gray-200">';
