...
class __Mustache_22b7b78638015c3b99d17a72b2a22624 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3f7ddf141a16576808bd04becc605f5c($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section3f7ddf141a16576808bd04becc605f5c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
