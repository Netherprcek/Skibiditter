...
class __Mustache_f8a3a80411d03b9f2f54b23ead1566b6 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionF57eb9c0a894f3a1216aa37ebb1c9381($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function sectionF57eb9c0a894f3a1216aa37ebb1c9381(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-6000 mt-16 rounded-lg border-2 border-blue-600 px-4 py-2 text-white hover:bg-red-700"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-6000 mt-16 rounded-lg border-2 border-blue-600 px-4 py-2 text-white hover:bg-red-700"
';
                $buffer .= $indent . '        >
';
