...
class __Mustache_792984ca253d20564f4f74ea5f3c3aef extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2a3e490af53d88b11549ab34c58f891c($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section2a3e490af53d88b11549ab34c58f891c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
