...
class __Mustache_c5e99ee1f520da51219031cc8fed08f8 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        class="absolute top-4 right-2 mb-2 text-gray-400 hover:text-gray-300"
';
        $buffer .= $indent . '      >
';
        $buffer .= $indent . '        <svg
