...
class __Mustache_4d91bba0e9e2e13f89532e707ce3c706 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section2c5af7a39d07547cf3c60aaf2e096d69($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section2c5af7a39d07547cf3c60aaf2e096d69(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-6000 mt-16 rounded-lg border-2 border-blue-600 px-4 py-2 text-white hover:bg-blue-700"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-6000 mt-16 rounded-lg border-2 border-blue-600 px-4 py-2 text-white hover:bg-blue-700"
';
                $buffer .= $indent . '        >
';
