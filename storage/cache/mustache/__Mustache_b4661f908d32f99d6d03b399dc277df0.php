...
class __Mustache_b4661f908d32f99d6d03b399dc277df0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA3411377f1b47c94a3fa16bdae6b4fdf($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionA3411377f1b47c94a3fa16bdae6b4fdf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
