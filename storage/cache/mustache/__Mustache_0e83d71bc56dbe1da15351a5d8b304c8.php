...
class __Mustache_0e83d71bc56dbe1da15351a5d8b304c8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section10ab73a0ab129eea72f3a3a118cf5355($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section10ab73a0ab129eea72f3a3a118cf5355(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
