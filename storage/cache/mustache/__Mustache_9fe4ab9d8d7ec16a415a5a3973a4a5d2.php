...
class __Mustache_9fe4ab9d8d7ec16a415a5a3973a4a5d2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section316743265ea910f19492c850886dfb48($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section087184feac57de95b1b9b2c945b0a391(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '      class="items-center flex h-2"
';
                $buffer .= $indent . '    >
';
...
';
    ...
    private function section316743265ea910f19492c850886dfb48(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section087184feac57de95b1b9b2c945b0a391($context, $indent, $value);
                $value = $context->find('session_user');
                if (empty($value)) {
