...
class __Mustache_39da8b2a1b7d85d67a0729d8607a88a0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section225453e578f4ab92701c0a22ae07ddc9($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        $buffer .= $this->section2cf1e8b9b36b3e31ca86ca86364698ed($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section225453e578f4ab92701c0a22ae07ddc9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <div class="mb-2">{{> partials/profileAvatar}}</div>
            <form>
              <input
                type="text"
                placeholder="Title"
...
';
    ...
    private function section2cf1e8b9b36b3e31ca86ca86364698ed(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
