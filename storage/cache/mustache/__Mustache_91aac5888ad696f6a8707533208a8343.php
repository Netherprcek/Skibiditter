...
class __Mustache_91aac5888ad696f6a8707533208a8343 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0ae1557cb0bd242d9958301ffb498bf6($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionCa128f61df147abbd0cccb8641534872(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-full max-h-96 object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-full max-h-96 object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section0ae1557cb0bd242d9958301ffb498bf6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionCa128f61df147abbd0cccb8641534872($context, $indent, $value);
