...
class __Mustache_de8abdb27626fd6e0f86a75f0b0ff15d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0744ccbff81791d00a8b112d77528645($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section0744ccbff81791d00a8b112d77528645(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class="overflow-wrap break-word z-10 mb-4 break-words  border-gray-600 px-12 py-3 text-gray-100"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class="overflow-wrap break-word z-10 mb-4 break-words  border-gray-600 px-12 py-3 text-gray-100"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
