...
class __Mustache_f8012147e2f2cdc5728ab9e238eedc64 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6586b3d62f13bbb5878fb6fc6699889c($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->section372e7e4b3a3db721483636b13f40500b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section278f226e2ad2219213c08fe71bab4dae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6586b3d62f13bbb5878fb6fc6699889c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '      <div class="mb-6 border border-blue-600 p-6 shadow-md">
';
...
';
                ...
                $buffer .= $this->section278f226e2ad2219213c08fe71bab4dae($context, $indent, $value);
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '      ';
                $context->pop();
    ...
    private function section372e7e4b3a3db721483636b13f40500b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 rounded-lg border-x border-gray-600 p-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
