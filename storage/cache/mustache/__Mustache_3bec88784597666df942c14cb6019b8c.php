...
class __Mustache_3bec88784597666df942c14cb6019b8c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6b7246e13bef5c626e79a0708e6a4397($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section6b7246e13bef5c626e79a0708e6a4397(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800  py-4 pb-0 shadow-md">
  <div class="mb-2 flex items-center justify-between pl-2 pr-5">
...
';
                $buffer .= $indent . '  <div class="mb-2 flex items-center justify-between pl-2 pr-5">
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-2 md:px-16 mb-0 ">
';
