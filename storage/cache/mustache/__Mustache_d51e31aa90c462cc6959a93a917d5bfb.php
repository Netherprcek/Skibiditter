...
class __Mustache_d51e31aa90c462cc6959a93a917d5bfb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2fad073af40ca5f02409db51d1478224($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section2fad073af40ca5f02409db51d1478224(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
