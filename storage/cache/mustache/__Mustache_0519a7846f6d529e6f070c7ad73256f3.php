...
class __Mustache_0519a7846f6d529e6f070c7ad73256f3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div
';
        $buffer .= $indent . '      class="ml-10 flex h-10 w-10 items-center justify-center rounded-full bg-gray-300 font-bold text-gray-600"
';
        $buffer .= $indent . '    >
';
        $buffer .= $indent . '      ';
