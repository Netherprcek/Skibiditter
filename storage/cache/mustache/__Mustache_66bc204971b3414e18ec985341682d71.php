...
class __Mustache_66bc204971b3414e18ec985341682d71 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCa1657364e33149decc79c604d76830f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionCa1657364e33149decc79c604d76830f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="">{{> partials/postForm}}</div>
        {{> partials/postList}} ';
