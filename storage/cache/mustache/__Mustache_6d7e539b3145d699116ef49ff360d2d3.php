...
class __Mustache_6d7e539b3145d699116ef49ff360d2d3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDbc740164a746e4e8c1171b49af9a568($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionDbc740164a746e4e8c1171b49af9a568(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article
  class="mb-6 cursor-pointer rounded-lg bg-gray-800 p-6 shadow-md"
  data-id="{{id_post}}"
>
...
';
                $buffer .= $indent . '  class="mb-6 cursor-pointer rounded-lg bg-gray-800 p-6 shadow-md"
';
