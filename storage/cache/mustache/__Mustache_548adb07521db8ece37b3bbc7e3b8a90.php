...
class __Mustache_548adb07521db8ece37b3bbc7e3b8a90 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section63f0a469dba325a5a08b9272b0f3dd3f($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section63f0a469dba325a5a08b9272b0f3dd3f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="text-shadow-default hover:text-shadow-lg mt-16 rounded-lg border-2 border-red-600 bg-red-600 px-4 py-2 text-white transition duration-300 ease-in-out hover:bg-red-700"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="text-shadow-default hover:text-shadow-lg mt-16 rounded-lg border-2 border-red-600 bg-red-600 px-4 py-2 text-white transition duration-300 ease-in-out hover:bg-red-700"
';
                $buffer .= $indent . '        >
';
