...
class __Mustache_9227f193c6ba8d3425b6ce6591224b82 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div
';
        $buffer .= $indent . '      class="ml-10 flex h-10 w-10 items-center justify-center rounded-full border-2 border-blue-500 bg-gray-300 font-bold text-gray-600"
';
        $buffer .= $indent . '    >
';
        $buffer .= $indent . '      ';
