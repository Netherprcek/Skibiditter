...
class __Mustache_8c3f598b99ec1613ba3d74e658affaf8 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3e21856757d0188649ddd31ab9168415($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section3e21856757d0188649ddd31ab9168415(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-4 border-b border-gray-700 pb-4">
          ...
          <p>{{comment_text}}</p>
          <div class="flex justify-center py-0 mt-2">
            <form
...
';
                ...
                $buffer .= '</p>
';
                $buffer .= $indent . '          <div class="flex justify-center py-0 mt-2">
';
                $buffer .= $indent . '            <form
';
