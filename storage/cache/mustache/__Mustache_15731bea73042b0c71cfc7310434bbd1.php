...
class __Mustache_15731bea73042b0c71cfc7310434bbd1 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9376231829a16b6adc330efe3def513d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section9376231829a16b6adc330efe3def513d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="border-x-2 border-gray-800">{{> partials/postForm}}</div>
        {{> partials/postList}} ';
