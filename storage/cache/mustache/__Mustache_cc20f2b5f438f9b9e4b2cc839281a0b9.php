...
class __Mustache_cc20f2b5f438f9b9e4b2cc839281a0b9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section827d20f71719ffb87b5ee1aac5f87277($context, $indent, $value);
    ...
    private function section827d20f71719ffb87b5ee1aac5f87277(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="flex w-full">
      ...
      <div id="right_column" class="flex w-1/4 justify-left"><h2>{{session_user.username}}</h2></div>
...
';
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '      <div id="right_column" class="flex w-1/4 justify-left"><h2>';
                $value = $this->resolveValue($context->findDot('session_user.username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</h2></div>
';
