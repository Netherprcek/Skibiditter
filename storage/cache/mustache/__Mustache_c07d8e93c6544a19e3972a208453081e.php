...
class __Mustache_c07d8e93c6544a19e3972a208453081e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA410fbc1a909034620bc3330fd57a69c($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionA410fbc1a909034620bc3330fd57a69c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
