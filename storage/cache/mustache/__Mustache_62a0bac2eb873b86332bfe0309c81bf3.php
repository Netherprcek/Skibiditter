...
class __Mustache_62a0bac2eb873b86332bfe0309c81bf3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col pl-0 md:pl-16 lg:pl-20 text-left ">
';
