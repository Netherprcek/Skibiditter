...
class __Mustache_f3f9049374e1327aca80f343d9de5db6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD76895720e9f01bf0ef9fb5996c67dcd($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionD76895720e9f01bf0ef9fb5996c67dcd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
  ...
  <h2 class="mb-2 text-center text-xl font-semibold text-white">{{ id_post }}</h2>
