...
class __Mustache_503cd8217e5468436efa556f44beabd0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA994c4d1dcbb9d243676e029b4f737cc($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionA994c4d1dcbb9d243676e029b4f737cc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '</p>
';
                $buffer .= $indent . '          <div class="flex justify-between mt-2">
';
                $buffer .= $indent . '            <form
';
