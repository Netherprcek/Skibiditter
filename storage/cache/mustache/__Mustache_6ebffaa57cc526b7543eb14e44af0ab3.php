...
class __Mustache_6ebffaa57cc526b7543eb14e44af0ab3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section47157604d8795ec80eba0f6a8912bed7($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
    ...
    private function section47157604d8795ec80eba0f6a8912bed7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<div class="mb-6 bg-gray-800 p-6 shadow-md">
  ...
  ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="mb-6 bg-gray-800 p-6 shadow-md">
';
