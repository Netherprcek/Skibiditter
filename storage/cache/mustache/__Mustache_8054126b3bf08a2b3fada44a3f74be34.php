...
class __Mustache_8054126b3bf08a2b3fada44a3f74be34 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8393b94bcff0e821205d0481bea69193($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section8393b94bcff0e821205d0481bea69193(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        ...
        <button
          type="submit"
          class=" -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
        >
          Update
        </button>
      </form>
...
';
                $buffer .= $indent . '          class=" -translate-y-1/2 rounded-lg bg-blue-500 px-4 py-1 text-white"
';
                $buffer .= $indent . '        >
';
