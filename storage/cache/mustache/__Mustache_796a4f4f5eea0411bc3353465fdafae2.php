...
class __Mustache_796a4f4f5eea0411bc3353465fdafae2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5435398588b1579e620754028461d9ea($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section5435398588b1579e620754028461d9ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex w-1/3 justify-end" id="dashboard_loggedin">
    <form action="/logout" method="POST" class="ml-4 flex h-min justify-end">
      <button
        type="submit"
...
';
                $buffer .= $indent . '    <form action="/logout" method="POST" class="ml-4 flex h-min justify-end">
';
                $buffer .= $indent . '      <button
';
