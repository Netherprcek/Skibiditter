...
class __Mustache_a9277a5e98bf4a2563ae47ebfdf28dcc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section755233b5b67bb668f2cec4a0706e8d28($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section97e02b74db06c6c2fc80c75c4633e8c1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' {{> partials/userCard}}
        <div>{{created_at}} aa</div>
        ';
...
';
    ...
    private function section755233b5b67bb668f2cec4a0706e8d28(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section97e02b74db06c6c2fc80c75c4633e8c1($context, $indent, $value);
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '    </div>
';
