...
class __Mustache_d5de923432782b8815e36f1e21c19c84 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        />
';
        $buffer .= $indent . '        <button class="align-self-center w-auto rounded-md bg-blue-500 p-2">
';
        $buffer .= $indent . '          Login
';
