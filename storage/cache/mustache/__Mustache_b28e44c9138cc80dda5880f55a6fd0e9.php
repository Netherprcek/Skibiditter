...
class __Mustache_b28e44c9138cc80dda5880f55a6fd0e9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section546ff44f3208f2c9809ca730a3d2d8f3($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section546ff44f3208f2c9809ca730a3d2d8f3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
