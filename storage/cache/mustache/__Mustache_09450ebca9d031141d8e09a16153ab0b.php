...
class __Mustache_09450ebca9d031141d8e09a16153ab0b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB8fa072069e4da5756d402b97b43f4fb($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionB8fa072069e4da5756d402b97b43f4fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class=" max-w-2xl w-full border-2 border-gray-800">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class=" max-w-2xl w-full border-2 border-gray-800">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
