...
class __Mustache_84fc3c4e23e57fa428037f6e896a790b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section05e356895f84474ae496ea7c734a0193($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section69093cb0c510d6170e73d1e7ccdef824(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section05e356895f84474ae496ea7c734a0193(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section69093cb0c510d6170e73d1e7ccdef824($context, $indent, $value);
