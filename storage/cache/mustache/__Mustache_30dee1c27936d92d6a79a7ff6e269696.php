...
class __Mustache_30dee1c27936d92d6a79a7ff6e269696 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5a59833a8c92e5c1335116aa410c5761($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section5a59833a8c92e5c1335116aa410c5761(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
