...
class __Mustache_a05f123629f9c70dd0c44a5d49dbe40e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section654cfafdf527dde9d6e65409cf402896($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section654cfafdf527dde9d6e65409cf402896(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 90%; max-width: 42rem">
...
';
                $buffer .= $indent . '    <div style="width: 90%; max-width: 42rem">
';
