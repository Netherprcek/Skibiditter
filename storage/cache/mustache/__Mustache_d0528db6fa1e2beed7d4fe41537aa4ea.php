...
class __Mustache_d0528db6fa1e2beed7d4fe41537aa4ea extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section63e5ee7d599639874a800966b5733a51($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section63e5ee7d599639874a800966b5733a51(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            <p class="text-sm text-gray-300">';
