...
class __Mustache_04bde39312282090a35854659442a4db extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA094e00f4a3512231744f35519265271($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionA44099e8f2afccac98bb1ccabe007967(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="object-cover rounded-lg" style="max-height: 24rem; width: 100%;" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="object-cover rounded-lg" style="max-height: 24rem; width: 100%;" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function sectionA094e00f4a3512231744f35519265271(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionA44099e8f2afccac98bb1ccabe007967($context, $indent, $value);
