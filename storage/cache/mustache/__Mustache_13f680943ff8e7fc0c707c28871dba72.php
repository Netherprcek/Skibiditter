...
class __Mustache_13f680943ff8e7fc0c707c28871dba72 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC056262bbc0227a7c1f77170636b0671($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionC056262bbc0227a7c1f77170636b0671(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700 p-2">
          ...
          <span class="pl-14 overflow-wrap  z-10 break-words">{{comment_text}}</span>
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <span class="pl-14 overflow-wrap  z-10 break-words">';
