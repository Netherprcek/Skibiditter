...
class __Mustache_3e671c9d60185b26c48b3f13357553b5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9202e775e9a9be20cb6204c6f59ef1c0($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section9202e775e9a9be20cb6204c6f59ef1c0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" enctype="multipart/form-data" class="relative mb-4 mx-4">
        <div class="relative mb-4 flex items-center justify-between space-x-4">
...
';
                $buffer .= $indent . '        <div class="relative mb-4 flex items-center justify-between space-x-4">
';
