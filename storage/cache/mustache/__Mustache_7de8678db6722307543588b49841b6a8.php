...
class __Mustache_7de8678db6722307543588b49841b6a8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9ec5867238bdf5d9a64baa50f370a19e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section9ec5867238bdf5d9a64baa50f370a19e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
