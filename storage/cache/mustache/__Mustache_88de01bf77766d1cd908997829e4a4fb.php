...
class __Mustache_88de01bf77766d1cd908997829e4a4fb extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section8dd1a41a4601ee71b4ca40ea6bd89da9($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
        ...
        $value = $this->resolveValue($context->findDot('profile.posts'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
...
';
    ...
    private function section8dd1a41a4601ee71b4ca40ea6bd89da9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
      <a
        href="/{{profile.user_id}}/unfollow"
        class="bg-blue-6000 mt-16 rounded-lg px-4 py-2 text-white hover:bg-blue-700"
      >
        Unfollow
      </a>
...
';
                ...
                $buffer .= '/unfollow"
';
                $buffer .= $indent . '        class="bg-blue-6000 mt-16 rounded-lg px-4 py-2 text-white hover:bg-blue-700"
';
                $buffer .= $indent . '      >
';
