...
class __Mustache_f026971bee76d4187f315b4c24ac3d99 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFae92dac1afa83d3a976f20ac1ade72c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionFae92dac1afa83d3a976f20ac1ade72c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
