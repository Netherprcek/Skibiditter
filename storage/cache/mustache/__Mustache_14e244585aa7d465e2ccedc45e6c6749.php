...
class __Mustache_14e244585aa7d465e2ccedc45e6c6749 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3ca976c9357233e33eabeb85e8f0d513($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function section3ca976c9357233e33eabeb85e8f0d513(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
