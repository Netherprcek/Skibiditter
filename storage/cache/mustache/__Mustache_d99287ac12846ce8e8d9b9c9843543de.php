...
class __Mustache_d99287ac12846ce8e8d9b9c9843543de extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section957874b664a6866698486a3ea4d72098($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
                $buffer .= $indent . '        <button type="submit" class="mt-16 rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">
';
...
';
    ...
    private function section957874b664a6866698486a3ea4d72098(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button type="submit" class="bg-blue-6000 mt-16 rounded-lg px-4 py-2 text-white hover:bg-blue-700">
          Unfollow
        </button>
      </form>
      >
...
';
                $buffer .= $indent . '        <button type="submit" class="bg-blue-6000 mt-16 rounded-lg px-4 py-2 text-white hover:bg-blue-700">
';
