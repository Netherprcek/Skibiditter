...
class __Mustache_5fad60a91c8330f21cc9ba83c22ee0e6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFf923b61b5eeb5471b6c1c7b27500f17($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionFf923b61b5eeb5471b6c1c7b27500f17(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '      </h1>
';
                $buffer .= $indent . '      <div class="px-4"></div>
';
