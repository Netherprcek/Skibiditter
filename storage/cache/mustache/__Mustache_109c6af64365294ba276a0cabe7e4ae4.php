...
class __Mustache_109c6af64365294ba276a0cabe7e4ae4 extends Mustache_Template
{
...
';
        $value = $context->findDot('profile.is_owner');
        $buffer .= $this->sectionF1d3eca2871f0d57fb366effc0c497a1($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionF1d3eca2871f0d57fb366effc0c497a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
      {{^profile.bio}}
      <p id="bio-text" class="cursor-pointer">No bio yet</p>
      {{/profile.bio}}
      <form
        id="bio-form"
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $buffer .= $indent . '      <p id="bio-text" class="cursor-pointer">No bio yet</p>
';
                }
                $buffer .= $indent . '      <form
';
