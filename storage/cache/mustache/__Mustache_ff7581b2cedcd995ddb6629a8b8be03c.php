...
class __Mustache_ff7581b2cedcd995ddb6629a8b8be03c extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <li id="password_length">Password must be longer than 6 characters</li>
';
        $buffer .= $indent . '            <li id="password_uppercase">Password must contain at least one uppercase letter</li>
';
        $buffer .= $indent . '          </ul>
';
        $buffer .= $indent . '        </div>
