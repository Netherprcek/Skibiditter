...
class __Mustache_af5949f0732ca475721cb50dd7890168 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB9b107616276f0a847d38830f4ae2127($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB9b107616276f0a847d38830f4ae2127(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    <div class="flex items-center">
      ...
      <span class=" text-sm pt-0 align-self-end text-gray-300">Created at: {{ created_at }}</span>
    </div>
    {{#is_owner}}
    <div class="relative">
      <button class="text-white" onclick="toggleOptions(\'{{id_post}}\', event)">
...
';
                $buffer .= $indent . '      </span>
';
                $buffer .= $indent . '      <span class=" text-sm pt-0 align-self-end text-gray-300">Created at: ';
