...
class __Mustache_7d39288189002c39ba422e35c0c71083 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF34cebc6512a6dd6467cbe7567d0fb5f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionF34cebc6512a6dd6467cbe7567d0fb5f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <h2 class="text-lg font-bold text-gray-300">{{ username }}:</h2>
...
';
                $buffer .= $indent . '            <h2 class="text-lg font-bold text-gray-300">';
