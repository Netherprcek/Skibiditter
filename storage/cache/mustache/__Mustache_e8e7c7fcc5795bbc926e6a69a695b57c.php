...
class __Mustache_e8e7c7fcc5795bbc926e6a69a695b57c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA04064e13fa858f2a8a4c9c482204daa($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionA04064e13fa858f2a8a4c9c482204daa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-2 break-words px-14 bg-gray-900 text-gray-200">
    {{ post_text }}
  </p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-2 break-words px-14 bg-gray-900 text-gray-200">
';
                $buffer .= $indent . '    ';
