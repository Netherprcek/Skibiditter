...
class __Mustache_a869520981771df6ae0ac393ea2bd5e1 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<a href="/profile" class="h-max-11 ml-10 rounded-full bg-blue-500 p-0.5">
';
        $buffer .= $indent . '  <div
';
