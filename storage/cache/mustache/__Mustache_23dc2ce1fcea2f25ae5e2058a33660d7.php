...
class __Mustache_23dc2ce1fcea2f25ae5e2058a33660d7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB3f47d6eaf6053f3c227be37c12e64ee($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionB3f47d6eaf6053f3c227be37c12e64ee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
