...
class __Mustache_a6199c32098dad66d4efab41ad181153 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB97f17d985ef44f3c30c35529423304a($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionB97f17d985ef44f3c30c35529423304a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
