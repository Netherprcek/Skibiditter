...
class __Mustache_b367efad25805884fcfe131831ccc003 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8c84cbd613e438806da202be0ec3b360($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
    ...
    private function section8c84cbd613e438806da202be0ec3b360(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mb-6 border-2 border-blue-800 p-6 shadow-md">
  ...
  ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="mb-6 border-2 border-blue-800 p-6 shadow-md">
';
