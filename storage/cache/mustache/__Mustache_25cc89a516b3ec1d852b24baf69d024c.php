...
class __Mustache_25cc89a516b3ec1d852b24baf69d024c extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<div class="relative mb-6 overflow-hidden rounded-lg bg-gray-900 shadow-md">
';
