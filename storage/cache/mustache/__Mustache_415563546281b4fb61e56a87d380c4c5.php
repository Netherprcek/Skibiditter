...
class __Mustache_415563546281b4fb61e56a87d380c4c5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7f7de667441523d5dca320eb7c4d5d91($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function section7f7de667441523d5dca320eb7c4d5d91(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
