...
class __Mustache_2b8fb7efbbd87923ac8481f91e48be3b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section359592aaefc4ddb35de3118389b5b02e($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionCd876b038d858aed645a101c17e01ec7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="max-w-4/5 h-32 object-cover rounded-lg" style="max-height: 24rem;" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="max-w-4/5 h-32 object-cover rounded-lg" style="max-height: 24rem;" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section359592aaefc4ddb35de3118389b5b02e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionCd876b038d858aed645a101c17e01ec7($context, $indent, $value);
