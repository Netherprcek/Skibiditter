...
class __Mustache_e5d803f77c892bf2780d27bf8951b50b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBc74cd6e665e335c75fef16f4edfb70a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionBc74cd6e665e335c75fef16f4edfb70a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
