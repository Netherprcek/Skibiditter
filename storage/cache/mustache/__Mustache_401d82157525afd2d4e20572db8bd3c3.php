...
class __Mustache_401d82157525afd2d4e20572db8bd3c3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section194a3ba090404850710cd2f8295a1e2a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section194a3ba090404850710cd2f8295a1e2a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative py-4  border-b-2 border-gray-800">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative py-4  border-b-2 border-gray-800">
';
