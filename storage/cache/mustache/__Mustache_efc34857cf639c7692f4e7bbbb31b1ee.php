...
class __Mustache_efc34857cf639c7692f4e7bbbb31b1ee extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1eba43edb3802dfaa0ab0b7b777bdfe7($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section1eba43edb3802dfaa0ab0b7b777bdfe7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
