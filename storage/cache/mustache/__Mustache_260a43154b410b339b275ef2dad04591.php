...
class __Mustache_260a43154b410b339b275ef2dad04591 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5a2886e1ce59e17667d7ac87bb2bac8f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section5a2886e1ce59e17667d7ac87bb2bac8f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex w-1/3 justify-end" id="dashboard_loggedin">
    <form action="/logout" method="POST" class="ml-4 flex h-8 justify-end">
      <button
        type="submit"
...
';
                $buffer .= $indent . '    <form action="/logout" method="POST" class="ml-4 flex h-8 justify-end">
';
                $buffer .= $indent . '      <button
';
