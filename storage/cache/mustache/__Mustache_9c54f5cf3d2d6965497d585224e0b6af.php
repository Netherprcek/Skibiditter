...
class __Mustache_9c54f5cf3d2d6965497d585224e0b6af extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section34236bd247629466fc480de09fe25885($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section34236bd247629466fc480de09fe25885(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
