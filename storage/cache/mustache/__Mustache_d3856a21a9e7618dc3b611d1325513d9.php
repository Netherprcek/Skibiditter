...
class __Mustache_d3856a21a9e7618dc3b611d1325513d9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section788996d53a2615cb3ef7947c692b3c2d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section788996d53a2615cb3ef7947c692b3c2d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class="overflow-wrap break-word z-10 mb-4 break-words border-b-2 border-gray-700 px-6 py-3 text-gray-100"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class="overflow-wrap break-word z-10 mb-4 break-words border-b-2 border-gray-700 px-6 py-3 text-gray-100"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
