...
class __Mustache_0805af98e59d53a00ca24074af2426a3 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionCb418708e9c71c4dd6d2be38ef4514ef($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function sectionCb418708e9c71c4dd6d2be38ef4514ef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-600 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-shadow-lg"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-600 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-shadow-lg"
';
                $buffer .= $indent . '        >
';
