...
class __Mustache_0745ae8ea675e9145c6bea76f7cc74ca extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section129eee9282707b86b37a1ec88b2b8f42($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section129eee9282707b86b37a1ec88b2b8f42(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class="overflow-wrap break-word mb-4  rounded-lg px-8 py-3 text-gray-100 shadow-inner"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class="overflow-wrap break-word mb-4  rounded-lg px-8 py-3 text-gray-100 shadow-inner"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
