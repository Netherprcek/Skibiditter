...
class __Mustache_ab418a568143b3706d09c51d3d9f5105 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA6e171e298a809108e3673e9753f852f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section7f56807471f41c13ec7a857cf1c20d9a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="relative">
      <button
        class="text-white"
        onclick="document.getElementById(\'options-{{id_post}}\').classList.toggle(\'hidden\')"
      >
        <i class="fas fa-ellipsis-v"></i>
      </button>
      <div
        id="options-{{id_post}}"
        class="absolute right-0 mt-2 w-48 bg-gray-700 rounded-lg shadow-lg hidden"
      >
        <a
        ...
        <a
          href="http://localhost:8000/{{id_post}}/delete"
          class="block px-4 py-2 text-white hover:bg-gray-600"
        >
          Delete
        </a>
...
';
                $buffer .= $indent . '        class="text-white"
';
                $buffer .= $indent . '        onclick="document.getElementById(\'options-';
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '\').classList.toggle(\'hidden\')"
';
                $buffer .= $indent . '      >
';
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="absolute right-0 mt-2 w-48 bg-gray-700 rounded-lg shadow-lg hidden"
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <a
...
';
    ...
    private function sectionA6e171e298a809108e3673e9753f852f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md relative">
  ...
  <div class="flex justify-center">
    <button
      class="mr-2 rounded-lg px-4 py-2 text-white hover:bg-blue-600 hover:text-white"
    >
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md relative">
';
...
';
                ...
                $buffer .= $this->section7f56807471f41c13ec7a857cf1c20d9a($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
...
';
                $buffer .= $indent . '    <button
';
                $buffer .= $indent . '      class="mr-2 rounded-lg px-4 py-2 text-white hover:bg-blue-600 hover:text-white"
';
                $buffer .= $indent . '    >
';
