...
class __Mustache_ba18fa5a14da1d268b604f87301a8827 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-16 flex h-[calc(100vh-4rem)] w-1/3 content-end overflow-y-auto  pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
