...
class __Mustache_11f5acc863c07c8e74f40b5bd3f06155 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF90c7c33bf5ee247f64f07b004aa8ebc($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionF90c7c33bf5ee247f64f07b004aa8ebc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
