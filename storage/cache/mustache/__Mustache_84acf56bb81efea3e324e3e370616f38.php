...
class __Mustache_84acf56bb81efea3e324e3e370616f38 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4bc0084fa5310a5fa8f863b0f5052765($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4bc0084fa5310a5fa8f863b0f5052765(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '          class="  rounded-lg bg-blue-500 px-4 py-1 text-white"
';
                $buffer .= $indent . '        >
';
