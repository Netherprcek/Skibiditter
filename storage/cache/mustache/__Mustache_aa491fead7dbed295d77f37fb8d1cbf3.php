...
class __Mustache_aa491fead7dbed295d77f37fb8d1cbf3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBeded1e1cf0b53013dc5cc1b5a36c062($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionBeded1e1cf0b53013dc5cc1b5a36c062(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div class=" max-w-2xl w-full">
      ...
      <div class="">{{> partials/postList}}</div>
    </div>
    ';
