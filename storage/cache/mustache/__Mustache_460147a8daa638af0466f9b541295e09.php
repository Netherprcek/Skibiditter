...
class __Mustache_460147a8daa638af0466f9b541295e09 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE47f4b1953cfcd5b323554a62283dd00($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionFa4329cbff0ba58782a44ec8d2479f19(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="flex justify-center">
                <img src="{{img}}" alt="{{title}}" class="max-w-full h-64 object-cover" alt="Description">
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="max-w-full h-64 object-cover" alt="Description">
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function sectionE47f4b1953cfcd5b323554a62283dd00(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionFa4329cbff0ba58782a44ec8d2479f19($context, $indent, $value);
