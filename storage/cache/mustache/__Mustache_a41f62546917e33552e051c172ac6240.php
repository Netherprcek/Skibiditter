...
class __Mustache_a41f62546917e33552e051c172ac6240 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4b055b1b44403ffb32c0f3cf2b0422cb($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4b055b1b44403ffb32c0f3cf2b0422cb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="border-x-8 border-gray-800">
          {{> partials/postForm}}
          {{> partials/postList}}
        </div>
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="border-x-8 border-gray-800">
';
