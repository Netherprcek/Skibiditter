...
class __Mustache_1088be65bb4524c683c87ccf81f58379 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section57bf528d75370d6dbdc56d341b51ab33($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section43c472f88089d5252b3cfae5f34b0657(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="relative">
      ...
      <div
        id="options-{{id_post}}"
        class="absolute right-0 mb-0 mt-2 hidden h-max w-48 rounded-lg bg-gray-700 shadow-lg"
      >
        <a
        ...
        <form action="/{{id_post}}/delete" method="POST" class="block">
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="absolute right-0 mb-0 mt-2 hidden h-max w-48 rounded-lg bg-gray-700 shadow-lg"
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <a
...
';
    ...
    private function section57bf528d75370d6dbdc56d341b51ab33(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section43c472f88089d5252b3cfae5f34b0657($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
