...
class __Mustache_a31428877a6111fd4a94b9ac17e1efde extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF11ac873ebf44b24864056afab5c5c9d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionF11ac873ebf44b24864056afab5c5c9d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="avatar_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        <input
          type="text"
