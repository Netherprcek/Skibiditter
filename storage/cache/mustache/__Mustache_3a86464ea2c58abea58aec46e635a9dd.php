...
class __Mustache_3a86464ea2c58abea58aec46e635a9dd extends Mustache_Template
{
...
';
        $buffer .= $indent . '          class="align-self-center flex w-auto rounded-md bg-blue-500 p-2"
';
        $buffer .= $indent . '        >
';
        $buffer .= $indent . '          Login
