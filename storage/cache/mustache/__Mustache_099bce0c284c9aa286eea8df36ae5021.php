...
class __Mustache_099bce0c284c9aa286eea8df36ae5021 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class=" top-16 left-0 h-[calc(100vh-4rem)] flex w-1/3 content-end border-r-2 border-gray-800 pl-4 pr-4 text-right overflow-y-auto z-10"
';
        $buffer .= $indent . '>
';
