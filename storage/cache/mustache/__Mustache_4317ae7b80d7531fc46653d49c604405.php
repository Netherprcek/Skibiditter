...
class __Mustache_4317ae7b80d7531fc46653d49c604405 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2c140eac95d8cdd7280379484c91f909($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section2c140eac95d8cdd7280379484c91f909(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex w-1/3 justify-end" id="dashboard_loggedin">
    ...
    {{!-- User Profile --}} {{> partials/profileAvatar}}
  </div>
  ';
