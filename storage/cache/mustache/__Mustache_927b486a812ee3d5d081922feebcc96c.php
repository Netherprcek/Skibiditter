...
class __Mustache_927b486a812ee3d5d081922feebcc96c extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= ' ';
            $value = $context->findDot('profile.is_owner');
            $buffer .= $this->sectionFa68a5adcd3d7e0cf7a1e278aca4ece1($context, $indent, $value);
            $buffer .= ' ';
        }
        $buffer .= ' ';
        $value = $context->findDot('profile.is_owner');
...
';
    ...
    private function sectionFa68a5adcd3d7e0cf7a1e278aca4ece1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
