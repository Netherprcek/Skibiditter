...
class __Mustache_d889373e0ce1e21328c39b6909269579 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section40119f3fba781657daa42830408bf76b($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section40119f3fba781657daa42830408bf76b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div>
    <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-2 border-gray-700 rounded-lg z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <div>
';
                $buffer .= $indent . '    <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-2 border-gray-700 rounded-lg z-10">
';
                $buffer .= $indent . '    ';
