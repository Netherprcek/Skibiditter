...
class __Mustache_1e0ee68149063f5b11d0f79479e98b98 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<div class="relative mb-6 overflow-hidden rounded-lg bg-gray-800 shadow-md">
';
