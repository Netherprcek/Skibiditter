...
class __Mustache_d2d4de2c01d13ef6f1340a65359cb9c1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div><div class="flex w-1/2 flex-col"></div>
';
        $buffer .= $indent . '    <div class="flex flex-col text-left w-1/2 justify-self-end">
';
