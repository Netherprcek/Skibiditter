...
class __Mustache_c73536543e1f153d2058c49bc24074e1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div
';
        $buffer .= $indent . '  class="fixed left-0 right-0 top-0 z-20 flex items-center justify-between bg-gray-800 p-4 border-b-2 border-gray-700"
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '  <div class="w-1/3"></div>
';
        $buffer .= $indent . '  <a href="/" class="text-4xl font-bold tracking-widest"
';
        $buffer .= $indent . '    ><span class="text-blue-500">S</span><span class="text-red-500">K</span><span class="text-yellow-500">I</span><span class="text-green-500">B</span><span class="text-blue-500">I</span><span class="text-red-500">D</span><span class="text-yellow-500">I</span><span class="text-green-500">T</span><span class="text-blue-500">T</span><span class="text-red-500">E</span><span class="text-yellow-500">R</span></a
';
        $buffer .= $indent . '  >
';
        $buffer .= $indent . '  ';
        ...
        $buffer .= $this->section22b5157c76bcba53af4a9a9e313cc9d0($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section22b5157c76bcba53af4a9a9e313cc9d0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
