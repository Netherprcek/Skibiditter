...
class __Mustache_428d7db386c104030fbe49d36c6c584f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4d4e8bc8f1983adf339034661c90c87d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section4d4e8bc8f1983adf339034661c90c87d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '</p>
';
                $buffer .= $indent . '          <div class="flex justify-center mb-0 mt-2">
';
                $buffer .= $indent . '            <form
';
