...
class __Mustache_33b09a206a04a6cc154bdce479d07f5e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8bc5d64915863e27979db7e42abeb3fd($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section8bc5d64915863e27979db7e42abeb3fd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
