...
class __Mustache_6515daad097b222ec691e15e7caa06af extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5e2162ba94dab8a052a31faadcce8225($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section5e2162ba94dab8a052a31faadcce8225(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" enctype="multipart/form-data" class="relative mb-4 mx-4">
        <div class="relative mb-4 flex items-center justify-between">
          ...
          <div class="flex items-center">
            ...
            <label class="cursor-pointer flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-6 text-white hover:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
';
                $buffer .= $indent . '            <label class="cursor-pointer flex items-center">
';
                $buffer .= $indent . '              <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-6 text-white hover:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
';
