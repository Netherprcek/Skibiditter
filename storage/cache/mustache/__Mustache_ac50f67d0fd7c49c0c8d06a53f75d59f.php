...
class __Mustache_ac50f67d0fd7c49c0c8d06a53f75d59f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section230a232d0b1ae0bd22e1bc5ef3fc4780($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section230a232d0b1ae0bd22e1bc5ef3fc4780(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
