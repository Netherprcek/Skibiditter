...
class __Mustache_924cfb1612a7f8a095a64339ce5e75c7 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB16a3b6eb9cec20d8386538a07364a16($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionB16a3b6eb9cec20d8386538a07364a16(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '</span>
';
                $buffer .= $indent . '              <span class="text-xl font-semibold text-white"
';
                $buffer .= $indent . '                >';
