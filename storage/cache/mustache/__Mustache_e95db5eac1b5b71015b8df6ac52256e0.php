...
class __Mustache_e95db5eac1b5b71015b8df6ac52256e0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '        <button class="flex w-auto justify-center rounded-md bg-blue-500 p-2">
';
        $buffer .= $indent . '          Login
';
