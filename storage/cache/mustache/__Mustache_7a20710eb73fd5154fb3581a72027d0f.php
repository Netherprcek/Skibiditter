...
class __Mustache_7a20710eb73fd5154fb3581a72027d0f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF4ba2c7e38601ff19c3bc83bf7174235($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
    ...
    private function sectionF4ba2c7e38601ff19c3bc83bf7174235(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<div class="mb-6 rounded-lg bg-gray-800 p-6 mt-8 shadow-md">
  ...
  ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="mb-6 rounded-lg bg-gray-800 p-6 mt-8 shadow-md">
';
