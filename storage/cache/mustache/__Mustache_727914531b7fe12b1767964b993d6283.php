...
class __Mustache_727914531b7fe12b1767964b993d6283 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section023140d4d89d0bd55c9db9e742d8b2e1($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section023140d4d89d0bd55c9db9e742d8b2e1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
