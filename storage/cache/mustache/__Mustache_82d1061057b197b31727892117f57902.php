...
class __Mustache_82d1061057b197b31727892117f57902 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2d1705776003ba1234cb65a2621f431f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section2d1705776003ba1234cb65a2621f431f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-2 border-gray-500 text-gray-100 rounded-lg shadow-inner">
    {{ post_text }}
  </p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-2 border-gray-500 text-gray-100 rounded-lg shadow-inner">
';
                $buffer .= $indent . '    ';
