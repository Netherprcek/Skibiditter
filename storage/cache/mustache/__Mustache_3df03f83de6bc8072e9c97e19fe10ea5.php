...
class __Mustache_3df03f83de6bc8072e9c97e19fe10ea5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA1d212f6fa76149a3c6300f7eea30a90($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionA1d212f6fa76149a3c6300f7eea30a90(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
