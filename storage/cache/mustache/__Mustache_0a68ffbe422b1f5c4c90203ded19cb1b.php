...
class __Mustache_0a68ffbe422b1f5c4c90203ded19cb1b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1a59efad502145000ebc6fe03b2b1e4e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section1a59efad502145000ebc6fe03b2b1e4e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
