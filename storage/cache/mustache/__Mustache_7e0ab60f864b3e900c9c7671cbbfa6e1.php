...
class __Mustache_7e0ab60f864b3e900c9c7671cbbfa6e1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB084a629fac2f40f7c192e18cac79299($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionE26ca2b0ef019481f0701ee978181cbb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '          <input type="hidden" name="previous_page" value="';
                $value = $this->resolveValue($context->find('previous_page'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" />
';
...
';
    ...
    private function sectionB084a629fac2f40f7c192e18cac79299(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionE26ca2b0ef019481f0701ee978181cbb($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
