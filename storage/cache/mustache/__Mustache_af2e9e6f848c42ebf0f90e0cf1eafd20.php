...
class __Mustache_af2e9e6f848c42ebf0f90e0cf1eafd20 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
';
        $value = $context->find('posts');
        $buffer .= $this->section0be61ad4870fc51fa445a6d2ad586dd0($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section0be61ad4870fc51fa445a6d2ad586dd0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <article class="bg-white shadow-md rounded-lg p-6 w-full max-w-sm">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <article class="bg-white shadow-md rounded-lg p-6 w-full max-w-sm">
';
