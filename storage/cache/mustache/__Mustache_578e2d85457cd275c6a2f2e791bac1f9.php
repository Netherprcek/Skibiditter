...
class __Mustache_578e2d85457cd275c6a2f2e791bac1f9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section65d853661a16bc67324825d3ffa5e348($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section65d853661a16bc67324825d3ffa5e348(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem; border-x-8 border-gray-800">
...
';
                $buffer .= $indent . '    <div style="width: 100%; max-width: 42rem; border-x-8 border-gray-800">
';
