...
class __Mustache_8297dab7d7bd62a1954e166a4f6c11da extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section57bfaa7b75cdcf2ba0d034329c61dad1($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section57bfaa7b75cdcf2ba0d034329c61dad1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
