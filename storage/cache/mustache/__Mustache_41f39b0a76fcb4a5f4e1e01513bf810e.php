...
class __Mustache_41f39b0a76fcb4a5f4e1e01513bf810e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF81b4c8210827c8b87bc7104de6c1c72($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9e943351f5a0b8240d172a208b17d486(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionF81b4c8210827c8b87bc7104de6c1c72(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex justify-center">
    ...
    >
      ...
      <button
        ...
        class="mr-2 rounded-lg px-4 py-2 text-white hover:text-blue-600 {{#liked}}bg-red-500{{/liked}}"
        type="button"
...
';
                ...
                $buffer .= $this->section9e943351f5a0b8240d172a208b17d486($context, $indent, $value);
                $buffer .= '"
';
