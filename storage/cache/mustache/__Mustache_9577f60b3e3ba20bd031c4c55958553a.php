...
class __Mustache_9577f60b3e3ba20bd031c4c55958553a extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="fixed flex w-1/3 content-end border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
