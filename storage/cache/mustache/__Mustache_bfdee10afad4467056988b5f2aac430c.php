...
class __Mustache_bfdee10afad4467056988b5f2aac430c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section630d914462d1acc00de429776e1750ef($context, $indent, $value);
        $buffer .= ' ';
...
';
    ...
    private function section630d914462d1acc00de429776e1750ef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
        <div class="mb-4 flex items-center">
          <a href="javascript:history.back()" class="mr-2 text-gray-400 hover:text-gray-300">
            <svg
...
';
                $buffer .= $indent . '          <a href="javascript:history.back()" class="mr-2 text-gray-400 hover:text-gray-300">
';
                $buffer .= $indent . '            <svg
';
