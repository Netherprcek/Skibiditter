...
class __Mustache_922c76ff89354af08f2bd3e1c9a3ee8c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3619a4d7e9e85a8678950aa1fc7118df($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section3619a4d7e9e85a8678950aa1fc7118df(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <article class="bg-gray-600 shadow-md rounded-lg p-6 mb-6">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <article class="bg-gray-600 shadow-md rounded-lg p-6 mb-6">
';
