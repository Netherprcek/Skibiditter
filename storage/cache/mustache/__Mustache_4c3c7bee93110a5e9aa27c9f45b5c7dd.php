...
class __Mustache_4c3c7bee93110a5e9aa27c9f45b5c7dd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD3147d3fc445571b9656a4ecb77f3f10($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionD3147d3fc445571b9656a4ecb77f3f10(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
