...
class __Mustache_74cba7cacc8679d198ca1d7989ffab3d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section596468a6ad358be0d7a53d5f50a98796($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section596468a6ad358be0d7a53d5f50a98796(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
