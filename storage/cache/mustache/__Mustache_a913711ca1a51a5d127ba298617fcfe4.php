...
class __Mustache_a913711ca1a51a5d127ba298617fcfe4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB13b482264b1bb0362587d540b50c086($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function sectionB13b482264b1bb0362587d540b50c086(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
