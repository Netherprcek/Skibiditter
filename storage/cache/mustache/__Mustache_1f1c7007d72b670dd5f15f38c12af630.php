...
class __Mustache_1f1c7007d72b670dd5f15f38c12af630 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section28c8d1ae8da6637978a8ec192ceb3598($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section28c8d1ae8da6637978a8ec192ceb3598(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="edit_form" action="/{{username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        ...
        <button
          type="submit"
          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white align-self-middle"
        >
          Update
        </button>
      </form>
...
';
                $buffer .= $indent . '          class="mt-2 rounded-lg bg-blue-500 px-4 py-1 text-white align-self-middle"
';
                $buffer .= $indent . '        >
';
