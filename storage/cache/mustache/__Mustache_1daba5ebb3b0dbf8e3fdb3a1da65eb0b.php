...
class __Mustache_1daba5ebb3b0dbf8e3fdb3a1da65eb0b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE7b1671476174d53b9d4436b8168d7f1($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('is_following');
        if (empty($value)) {
...
';
    ...
    private function sectionE7b1671476174d53b9d4436b8168d7f1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
