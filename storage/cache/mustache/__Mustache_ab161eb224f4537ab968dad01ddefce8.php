...
class __Mustache_ab161eb224f4537ab968dad01ddefce8 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    document.querySelectorAll(\'article[data-id]\').forEach(function(article) {
';
        $buffer .= $indent . '      article.addEventListener(\'click\', function() {
';
        $buffer .= $indent . '        window.location.href = \'http://localhost:8000/\' + article.getAttribute(\'data-id\');
';
        $buffer .= $indent . '      });
';
        $buffer .= $indent . '    });
