...
class __Mustache_a43ea17ff2be773fa3c93d52c2ad2c24 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section6fe016d6dcf914c013604f20650671cd($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section6fe016d6dcf914c013604f20650671cd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="text-shadow-default hover:text-shadow-lg mt-16 rounded-lg border-2 border-red-700 bg-red-600 px-4 py-2 text-lg text-white transition duration-300 ease-in-out hover:bg-red-700"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="text-shadow-default hover:text-shadow-lg mt-16 rounded-lg border-2 border-red-700 bg-red-600 px-4 py-2 text-lg text-white transition duration-300 ease-in-out hover:bg-red-700"
';
                $buffer .= $indent . '        >
';
