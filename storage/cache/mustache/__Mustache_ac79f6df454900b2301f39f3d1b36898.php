...
class __Mustache_ac79f6df454900b2301f39f3d1b36898 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8b4b2928a2c8108689f8944ce8511ddb($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section8b4b2928a2c8108689f8944ce8511ddb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
