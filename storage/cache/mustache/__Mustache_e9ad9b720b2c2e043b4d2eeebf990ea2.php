...
class __Mustache_e9ad9b720b2c2e043b4d2eeebf990ea2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE5e0649c1d5b1e4192448bf8dc549910($context, $indent, $value);
        $buffer .= ' ';
        $buffer .= ' ';
        $value = $context->find('posts');
        $buffer .= $this->sectionAa30117dc232cc6396a6e55cfcea7381($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionE5e0649c1d5b1e4192448bf8dc549910(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <div class="mb-4">{{> partials/profileAvatar}}</div>
            <form>
              <input
                type="text"
                placeholder="Title"
...
';
    ...
    private function sectionAa30117dc232cc6396a6e55cfcea7381(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <span class="mb-4">{{> partials/profileAvatar}}</span>
            <span class="mb-2 text-center text-xl font-semibold text-white">
              {{ username }}
            </span>
...
';
                $buffer .= $indent . '            <span class="mb-4">';
                if ($partial = $this->mustache->loadPartial('partials/profileAvatar')) {
                    $buffer .= $partial->renderInternal($context);
                }
                $buffer .= '</span>
';
                $buffer .= $indent . '            <span class="mb-2 text-center text-xl font-semibold text-white">
';
                $buffer .= $indent . '              ';
