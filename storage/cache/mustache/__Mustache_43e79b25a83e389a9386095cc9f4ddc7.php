...
class __Mustache_43e79b25a83e389a9386095cc9f4ddc7 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9af531d0af07878f699670c471374751($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section9af531d0af07878f699670c471374751(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
