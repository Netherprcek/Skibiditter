...
class __Mustache_2544090cda70701793024e6ca8b30b59 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCf93a6237d2761728c7199e5c5af2444($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionCf93a6237d2761728c7199e5c5af2444(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
