...
class __Mustache_daa3a2da33f82e02ffa56bedfeea57e7 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-0 flex h-screen w-1/3 content-end overflow-y-auto border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
