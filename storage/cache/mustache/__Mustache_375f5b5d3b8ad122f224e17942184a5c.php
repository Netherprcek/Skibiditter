...
class __Mustache_375f5b5d3b8ad122f224e17942184a5c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEf4defffd6686c8350da32a7991309c4($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function sectionEf4defffd6686c8350da32a7991309c4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
