...
class __Mustache_cae18605ed11143e32dbd55675bad4b9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-12 text-left justify-items-end">
';
