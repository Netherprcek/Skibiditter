...
class __Mustache_2eff165d3409cd2a3ef32fb61e1b382a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCab086f2bd8eff91d7932b0508755d0d($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionCab086f2bd8eff91d7932b0508755d0d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <div class="flex justify-center">
              <button class="bg-blue-500 text-white px-4 py-2 rounded-lg">Like</button>
              <button class="bg-blue-500 text-white px-4 py-2 rounded-lg">Comment</button>
...
';
                $buffer .= $indent . '              <button class="bg-blue-500 text-white px-4 py-2 rounded-lg">Like</button>
';
                $buffer .= $indent . '              <button class="bg-blue-500 text-white px-4 py-2 rounded-lg">Comment</button>
';
