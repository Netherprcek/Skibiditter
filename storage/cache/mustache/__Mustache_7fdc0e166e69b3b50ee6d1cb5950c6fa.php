...
class __Mustache_7fdc0e166e69b3b50ee6d1cb5950c6fa extends Mustache_Template
{
...
';
        $buffer .= $indent . '    ></textarea>
';
        $buffer .= $indent . '    <button type="submit" class="absolute right-2 top-2 rounded-lg bg-blue-500 p-2 text-white">
';
