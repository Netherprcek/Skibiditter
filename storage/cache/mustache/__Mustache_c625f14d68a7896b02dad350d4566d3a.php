...
class __Mustache_c625f14d68a7896b02dad350d4566d3a extends Mustache_Template
{
...
';
        ...
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '\'s avatar" class="w-24 h-24 rounded-full border-4 border-gray-800 mr-4 mt-6">
';
        $buffer .= $indent . '      
';
