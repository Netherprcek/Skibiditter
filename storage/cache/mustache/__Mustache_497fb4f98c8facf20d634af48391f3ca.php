...
class __Mustache_497fb4f98c8facf20d634af48391f3ca extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA710d9d6c55d3bbdc0d07c6aecf2333e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionA710d9d6c55d3bbdc0d07c6aecf2333e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="avatar_form" action="/{{session_user.username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        <input
          type="text"
      ...
      <form id="background_form" action="/{{username}}/edit-profile" method="post" class="relative mx-4">
        <input
          type="text"
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/edit-profile" method="post" class="relative mx-4">
';
                $buffer .= $indent . '        <input
';
                $buffer .= $indent . '          type="text"
