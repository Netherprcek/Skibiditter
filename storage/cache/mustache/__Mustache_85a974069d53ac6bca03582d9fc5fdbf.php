...
class __Mustache_85a974069d53ac6bca03582d9fc5fdbf extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <p>';
        $value = $this->resolveValue($context->findDot('post.post_text'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '</p>
';
        $buffer .= $indent . '        <p>';
...
';
        $buffer .= $indent . '        <p>';
        $value = $this->resolveValue($context->findDot('post.created_at'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '</p>
';
        $buffer .= $indent . '      </div>
