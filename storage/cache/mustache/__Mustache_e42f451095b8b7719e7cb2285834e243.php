...
class __Mustache_e42f451095b8b7719e7cb2285834e243 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCa27d00556097085d62045e7c8795f92($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->section0db447136aa99ee5532032d0cfdb3598($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function sectionCa27d00556097085d62045e7c8795f92(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section0db447136aa99ee5532032d0cfdb3598(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
