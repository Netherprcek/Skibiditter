...
class __Mustache_65a15b229b861efd92bd0847531abd07 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <button class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-600 align-self-center">SKIBIDITTER</button>
';
