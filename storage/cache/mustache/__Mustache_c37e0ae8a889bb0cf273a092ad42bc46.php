...
class __Mustache_c37e0ae8a889bb0cf273a092ad42bc46 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="fixed top-0 flex h-screen w-1/3 content-end overflow-y-auto border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
