...
class __Mustache_200e120d31bb88a53edcfb5ad412b971 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1b26080e2c2ea2460cd0a6cfc7a28912($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section1b26080e2c2ea2460cd0a6cfc7a28912(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <div class="mb-4">
              ...
              <span>{{> partials/profileAvatar}}</span>
              </span>
            </div>
