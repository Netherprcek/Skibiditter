...
class __Mustache_9cf99accb51063e09e107e0880a140f9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0a482d2d9c81336926adb51d880c8192($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section0a482d2d9c81336926adb51d880c8192(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
