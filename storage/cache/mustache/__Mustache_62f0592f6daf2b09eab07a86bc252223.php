...
class __Mustache_62f0592f6daf2b09eab07a86bc252223 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section31d793cd35cbed3163cc38efa5c53922($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section31d793cd35cbed3163cc38efa5c53922(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
