...
class __Mustache_e48da0f3968d8af39e6943f84b09d9fc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE17306f6ae08df02deac21af4f709f8c($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionE17306f6ae08df02deac21af4f709f8c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <div class="mx-8 grid grid-cols-2 gap-4">
        ...
        {{> partials/userCard}}
        {{/followers}}
        <span>{{follows.created_at}} aa</span>
      </div>
    </div>
    ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                ...
                $buffer .= $indent . '        <span>';
                $value = $this->resolveValue($context->findDot('follows.created_at'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= ' aa</span>
';
                $buffer .= $indent . '      </div>
