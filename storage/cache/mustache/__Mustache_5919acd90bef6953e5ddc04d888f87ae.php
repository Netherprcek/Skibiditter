...
class __Mustache_5919acd90bef6953e5ddc04d888f87ae extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFa49660e1ed11bf0fb85912634f750cc($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionFa49660e1ed11bf0fb85912634f750cc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div class="w-max; border-x-8 border-gray-800">
...
';
                $buffer .= $indent . '    <div class="w-max; border-x-8 border-gray-800">
';
