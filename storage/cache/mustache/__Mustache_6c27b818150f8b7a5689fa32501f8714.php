...
class __Mustache_6c27b818150f8b7a5689fa32501f8714 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section375c160d57507ac1c4badd8012158317($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section375c160d57507ac1c4badd8012158317(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
