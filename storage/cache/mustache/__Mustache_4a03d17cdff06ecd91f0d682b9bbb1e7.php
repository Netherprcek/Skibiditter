...
class __Mustache_4a03d17cdff06ecd91f0d682b9bbb1e7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0a11ec4afa638c8dc50c6564063e8dc4($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section0a11ec4afa638c8dc50c6564063e8dc4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800  py-4 pb-0 shadow-md">
  <div class="mb-2 flex items-center justify-between pl-2 pr-4">
...
';
                $buffer .= $indent . '  <div class="mb-2 flex items-center justify-between pl-2 pr-4">
';
