...
class __Mustache_f1aba521045fdf9ba0bc457a88db2c45 extends Mustache_Template
{
...
';
            $buffer .= $indent . '          <h2 class="mb-6 mt-16 rounded-lg bg-gray-800 p-4 text-center text-xl font-bold text-white">
';
            $buffer .= $indent . '            In the meantime, feel free to visit the explore page to see what\'s happening ☺️
';
            $buffer .= $indent . '          </h2>
';
        }
