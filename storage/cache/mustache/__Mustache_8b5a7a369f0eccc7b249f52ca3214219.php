...
class __Mustache_8b5a7a369f0eccc7b249f52ca3214219 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB2ee6f5c4efebb8f79806d71deb80d3d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB2ee6f5c4efebb8f79806d71deb80d3d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
