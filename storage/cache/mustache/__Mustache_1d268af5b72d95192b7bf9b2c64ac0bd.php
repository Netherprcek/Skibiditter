...
class __Mustache_1d268af5b72d95192b7bf9b2c64ac0bd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB89adb65a5b899c0ddd6d600bed145ec($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionB89adb65a5b899c0ddd6d600bed145ec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
