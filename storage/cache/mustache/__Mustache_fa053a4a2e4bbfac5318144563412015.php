...
class __Mustache_fa053a4a2e4bbfac5318144563412015 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDc83ae6b591e8770eae932d1a69292da($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionDc83ae6b591e8770eae932d1a69292da(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
