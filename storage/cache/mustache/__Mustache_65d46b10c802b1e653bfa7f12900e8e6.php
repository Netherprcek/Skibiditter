...
class __Mustache_65d46b10c802b1e653bfa7f12900e8e6 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF9c31e0bfe0386d52c486d96b3d65784($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionF9c31e0bfe0386d52c486d96b3d65784(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <article class="bg-gray-750 shadow-md rounded-lg p-6 mb-6">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <article class="bg-gray-750 shadow-md rounded-lg p-6 mb-6">
';
