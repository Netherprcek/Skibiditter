...
class __Mustache_bb62d04a31a3cf0638d23e8e53b77538 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section91c2103934688b5624e8b95c73f9b582($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section91c2103934688b5624e8b95c73f9b582(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
