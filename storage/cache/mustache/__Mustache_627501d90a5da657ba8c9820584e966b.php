...
class __Mustache_627501d90a5da657ba8c9820584e966b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA86d43b0748f1fe642dd62179351a82d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionA86d43b0748f1fe642dd62179351a82d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
