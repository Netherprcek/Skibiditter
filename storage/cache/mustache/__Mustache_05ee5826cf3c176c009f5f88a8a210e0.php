...
class __Mustache_05ee5826cf3c176c009f5f88a8a210e0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC7bff921d87a02cd5e80194a231c9220($context, $indent, $value);
        $buffer .= '
';
...
';
    ...
    private function sectionC7bff921d87a02cd5e80194a231c9220(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' <div class="mx-4">{{> partials/postForm}}</div></div> ';
