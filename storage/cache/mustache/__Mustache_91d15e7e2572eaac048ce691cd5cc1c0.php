...
class __Mustache_91d15e7e2572eaac048ce691cd5cc1c0 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $indent . '          <div class="text-center text-lg">To see recommended users, you need to be signed in</div>
';
        }
        $buffer .= $indent . '      </div>
';
