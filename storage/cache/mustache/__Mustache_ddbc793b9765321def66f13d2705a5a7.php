...
class __Mustache_ddbc793b9765321def66f13d2705a5a7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1068c5a49236142da86ac2e5ff7f5059($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section1068c5a49236142da86ac2e5ff7f5059(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
