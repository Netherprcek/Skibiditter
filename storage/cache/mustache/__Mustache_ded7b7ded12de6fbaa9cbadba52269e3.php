...
class __Mustache_ded7b7ded12de6fbaa9cbadba52269e3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB85fa4b468db7cbbbf4b88e5ec55e98c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB85fa4b468db7cbbbf4b88e5ec55e98c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
