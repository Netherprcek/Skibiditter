...
class __Mustache_40ec438a410179738b5b94a21b6cda0e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5bc95197155a90d8560a79d560884753($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section5bc95197155a90d8560a79d560884753(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
