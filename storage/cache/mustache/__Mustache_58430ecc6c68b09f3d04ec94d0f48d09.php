...
class __Mustache_58430ecc6c68b09f3d04ec94d0f48d09 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCa403dd44a15c9a34d3fa2346c51c89b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionCa403dd44a15c9a34d3fa2346c51c89b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 border-b border-gray-700">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
