...
class __Mustache_bc75036d22ed544e229eed5060f00da5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF86089de8fc89fe068b8d6d556852c7f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionF86089de8fc89fe068b8d6d556852c7f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
