...
class __Mustache_e832a6c568d04d204505e81b5e2c87db extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2a176f899126c6fd4df39e61fb5d9e3f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section2a176f899126c6fd4df39e61fb5d9e3f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
  ...
  <div class="flex justify-center">
    <button
      class="mr-2 rounded-lg border border-blue-700 px-4 py-2 text-blue-700 hover:bg-blue-600 hover:text-white"
    >
...
';
                $buffer .= $indent . '    <button
';
                $buffer .= $indent . '      class="mr-2 rounded-lg border border-blue-700 px-4 py-2 text-blue-700 hover:bg-blue-600 hover:text-white"
';
                $buffer .= $indent . '    >
';
