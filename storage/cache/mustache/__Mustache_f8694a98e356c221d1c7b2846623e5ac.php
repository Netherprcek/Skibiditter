...
class __Mustache_f8694a98e356c221d1c7b2846623e5ac extends Mustache_Template
{
...
';
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '        <span class="text-gray-300 ">Following</span>
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '      <div class="mr-6">
...
';
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '        <span class="text-gray-300 ">Followers</span>
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
