...
class __Mustache_c7c089f68e6390135b7bab780dfdf688 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section49ed6d46db5dfc9ad8fec611aca0681c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section6e3b100a8f1fe8464b4077bf3a947da8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section49ed6d46db5dfc9ad8fec611aca0681c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
>
  ...
  <button
    ...
    class="mr-2 rounded-lg px-4 py-2  hover:text-red-500 {{#liked}}text-white{{/liked}}"
    type="button"
...
';
                ...
                $buffer .= $this->section6e3b100a8f1fe8464b4077bf3a947da8($context, $indent, $value);
                $buffer .= '"
';
