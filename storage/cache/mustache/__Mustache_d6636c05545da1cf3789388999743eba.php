...
class __Mustache_d6636c05545da1cf3789388999743eba extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF4a630ac9347898bc372548937a51763($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionF4a630ac9347898bc372548937a51763(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
