...
class __Mustache_58250919d52c8d49d9839bfea8a2c58b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0a511b74def2f81bb8d8692389101641($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section0a511b74def2f81bb8d8692389101641(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
