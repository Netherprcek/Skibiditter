...
class __Mustache_cf0c6f558a7c7120a52d34a079080f8b extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-0 text-left justify-end">
';
