...
class __Mustache_f6ca8f401a6926469c2c833f7a9c6f81 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section730caf46cfdefd31f4936748f21c23a1($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section730caf46cfdefd31f4936748f21c23a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
