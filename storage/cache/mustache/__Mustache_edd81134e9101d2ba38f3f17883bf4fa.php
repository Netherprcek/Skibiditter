...
class __Mustache_edd81134e9101d2ba38f3f17883bf4fa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB614f71e2c47c8a52c0f46ee0f6ed890($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB614f71e2c47c8a52c0f46ee0f6ed890(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    ...
    <p
      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-2 border-gray-700 rounded-lg  "
    >
      {{ post_text }}
    </p>
...
';
                $buffer .= $indent . '    <p
';
                $buffer .= $indent . '      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-2 border-gray-700 rounded-lg  "
';
                $buffer .= $indent . '    >
';
                $buffer .= $indent . '      ';
