...
class __Mustache_f5eebc3479518388402652b9b8abc246 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9793b8eadb145101e1c8666636994ea2($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9793b8eadb145101e1c8666636994ea2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
