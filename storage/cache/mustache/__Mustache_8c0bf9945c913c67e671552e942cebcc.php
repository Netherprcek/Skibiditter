...
class __Mustache_8c0bf9945c913c67e671552e942cebcc extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-textarea" class="hidden w-full bg-gray-600 p-2 text-white"></textarea>
';
