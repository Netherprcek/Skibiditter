...
class __Mustache_fd2e5d9f43e03a68f655eabdd1ffd745 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA436223f489570dc25227e64fcff9dee($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionA436223f489570dc25227e64fcff9dee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
