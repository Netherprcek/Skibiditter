...
class __Mustache_61c97e6b1270614e534cfa47ed638572 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section31808960890043867120c6a48e501188($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section31808960890043867120c6a48e501188(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
