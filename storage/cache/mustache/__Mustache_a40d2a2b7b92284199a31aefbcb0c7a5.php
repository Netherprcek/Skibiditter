...
class __Mustache_a40d2a2b7b92284199a31aefbcb0c7a5 extends Mustache_Template
{
...
';
        ...
        $buffer .= ' ';
        $value = $context->findDot('profile.is_owner');
        $buffer .= $this->sectionC3a1b5e1dcfb4202badfc6dcc748e7f8($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionC3a1b5e1dcfb4202badfc6dcc748e7f8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
