...
class __Mustache_5ae10ab21e1660f1741286ba0e1ad9dc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEcc22d0092f1b38b1d608068e6eff6bb($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionEcc22d0092f1b38b1d608068e6eff6bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div class="relative">
  <div class="absolute left-4 -top-4 h-8 w-8 rotate-45 transform bg-gray-700"></div>
  <p class="overflow-wrap break-word mb-4 break-words px-8 py-4 text-gray-100 rounded-lg bg-gray-700 shadow-inner relative z-10">
    {{ post_text }}
  </p>
</div>
...
';
                $buffer .= $indent . '  <div class="relative">
';
                $buffer .= $indent . '  <div class="absolute left-4 -top-4 h-8 w-8 rotate-45 transform bg-gray-700"></div>
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-8 py-4 text-gray-100 rounded-lg bg-gray-700 shadow-inner relative z-10">
';
                $buffer .= $indent . '    ';
