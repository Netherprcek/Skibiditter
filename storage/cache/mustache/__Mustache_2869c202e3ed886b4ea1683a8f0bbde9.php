...
class __Mustache_2869c202e3ed886b4ea1683a8f0bbde9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE9f049a33e0758923965a0ab1450c7c3($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionE9f049a33e0758923965a0ab1450c7c3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div class="width: 100%; max-width: 42rem; border-x-8 border-gray-800">
...
';
                $buffer .= $indent . '    <div class="width: 100%; max-width: 42rem; border-x-8 border-gray-800">
';
