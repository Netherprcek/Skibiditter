...
class __Mustache_b89f9255c35de443c003d85f5fa04727 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEb8add0f8279516b28f2c689ee52c5b1($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section5b3677c4c766cb79ed223a990284874c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="relative">
      ...
      >
        ...
        <form action="/{{id_post}}/delete" id="deleteForm" method="POST" class="m-0 block" data-post-id="{{id_post}}">
...
';
                ...
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/delete" id="deleteForm" method="POST" class="m-0 block" data-post-id="';
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '">
';
...
';
    ...
    private function sectionCedd0855e0ddcde3694a7281c11d8781(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section55ea5b983d3225916afa102633084441(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '      class="items-cente flex h-2"
';
                $buffer .= $indent . '    >
';
...
';
    ...
    private function sectionEb8add0f8279516b28f2c689ee52c5b1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative mb-6 rounded-lg bg-gray-800 py-4 pb-0 shadow-md">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative mb-6 rounded-lg bg-gray-800 py-4 pb-0 shadow-md">
';
...
';
                $value = $context->find('is_owner');
                $buffer .= $this->section5b3677c4c766cb79ed223a990284874c($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
...
';
                ...
                $buffer .= $this->sectionCedd0855e0ddcde3694a7281c11d8781($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
...
';
                ...
                $buffer .= $this->section55ea5b983d3225916afa102633084441($context, $indent, $value);
