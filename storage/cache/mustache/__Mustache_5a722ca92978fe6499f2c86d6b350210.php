...
class __Mustache_5a722ca92978fe6499f2c86d6b350210 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4aa3ea117fb23934906366d0eb2687dd($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4aa3ea117fb23934906366d0eb2687dd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
