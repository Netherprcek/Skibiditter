...
class __Mustache_b0884492c83ba0b92f71362908655218 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4a74c4c1b9206e5ef4760f70f523a6af($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section4a74c4c1b9206e5ef4760f70f523a6af(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 rounded-lg z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 rounded-lg z-10">
';
                $buffer .= $indent . '    ';
