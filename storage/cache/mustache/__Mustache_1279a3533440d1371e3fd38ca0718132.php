...
class __Mustache_1279a3533440d1371e3fd38ca0718132 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <form action="/register" method="post" class="w-96 rounded-lg bg-gray-800 p-4">
';
...
';
        $buffer .= $indent . '      </form>
';
        $buffer .= $indent . '      <div class="flex justify-left">
';
        $buffer .= $indent . '        <ul>
';
