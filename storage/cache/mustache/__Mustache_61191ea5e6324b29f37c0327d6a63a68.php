...
class __Mustache_61191ea5e6324b29f37c0327d6a63a68 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC5a25466102c9685d9c0d8998709ce7e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionC5a25466102c9685d9c0d8998709ce7e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
