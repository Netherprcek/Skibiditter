...
class __Mustache_1925fd5d81a951b59e9335fcd22eacaa extends Mustache_Template
{
...
';
        ...
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= ' <span class="text-gray-300 ">Following</span>
';
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '        
...
';
        ...
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= ' <span class="text-gray-300 ">Followers</span>
';
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '        
