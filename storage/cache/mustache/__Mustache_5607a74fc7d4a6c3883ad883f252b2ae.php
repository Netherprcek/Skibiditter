...
class __Mustache_5607a74fc7d4a6c3883ad883f252b2ae extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEc47a7c63336eb04f8823357627d0168($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionEc47a7c63336eb04f8823357627d0168(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-1 border-gray-800 rounded-lg z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-1 border-gray-800 rounded-lg z-10">
';
                $buffer .= $indent . '    ';
