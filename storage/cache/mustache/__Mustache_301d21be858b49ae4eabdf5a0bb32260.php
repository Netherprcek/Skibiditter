...
class __Mustache_301d21be858b49ae4eabdf5a0bb32260 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE2ffa209c5b5b42f1330a4d5445a3101($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionE2ffa209c5b5b42f1330a4d5445a3101(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
