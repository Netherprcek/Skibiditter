...
class __Mustache_be92a6054fa006cb09abd812595d980c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4e486d5d697686bafbb2a5e9f4e3da97($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section4e486d5d697686bafbb2a5e9f4e3da97(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
