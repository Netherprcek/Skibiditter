...
class __Mustache_eecb00287deca1aacdb014cfc8bf5d72 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEecbaf98fc01404f64507254ce00bdd6($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionE8510eddd7dc40ada46007d21d0d61ae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEecbaf98fc01404f64507254ce00bdd6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionE8510eddd7dc40ada46007d21d0d61ae($context, $indent, $value);
                $value = $context->find('session_user');
                if (empty($value)) {
