...
class __Mustache_0a70c67c10bdcba4b5586fad7c34ced9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA03e346e0c795eb07ed8467bb4a7c972($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionA03e346e0c795eb07ed8467bb4a7c972(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <article class="bg-white shadow-md rounded-lg p-6 mb-6 flex flex-col items-center">
            <div class="w-full">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <article class="bg-white shadow-md rounded-lg p-6 mb-6 flex flex-col items-center">
';
