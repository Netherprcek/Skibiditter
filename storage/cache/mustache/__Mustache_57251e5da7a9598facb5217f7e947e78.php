...
class __Mustache_57251e5da7a9598facb5217f7e947e78 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDb9f5628bb0e7220cf54595cd3ecc78d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionDb9f5628bb0e7220cf54595cd3ecc78d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="mb-2 px-4 text-gray-200">{{ post_text }}</p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
    <img
      src="{{ img }}"
...
';
                ...
                $buffer .= '</h2>
';
                $buffer .= $indent . '  <p class="mb-2 px-4 text-gray-200">';
