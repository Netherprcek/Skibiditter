...
class __Mustache_e9d2820854cbf079959a451abf7989e4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD4bbbda2bdc8048b30f193a38656cb0d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionD4bbbda2bdc8048b30f193a38656cb0d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
