...
class __Mustache_451b58f470e2a9fe34506739b247451f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2a4037e34e4a7f0e93d8b722385a43d8($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section2a4037e34e4a7f0e93d8b722385a43d8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex justify-center">
    <form action="/{{id_post}}/like" method="POST" class="flex items-center">
      <button
        ...
        data-user-id="{{session_user.user_id}}"
      >
        <i class="fas fa-toilet"
          ><span id="like-count-{{id_post}}">{{likes}}</span></i
        >
      </button>
...
';
                $buffer .= $indent . '      <button
';
                $buffer .= $indent . '        class="like-button"
';
...
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <i class="fas fa-toilet"
';
