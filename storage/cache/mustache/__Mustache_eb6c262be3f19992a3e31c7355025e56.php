...
class __Mustache_eb6c262be3f19992a3e31c7355025e56 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8d31c59b8ee710ad22d951acbe424711($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section8d31c59b8ee710ad22d951acbe424711(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
