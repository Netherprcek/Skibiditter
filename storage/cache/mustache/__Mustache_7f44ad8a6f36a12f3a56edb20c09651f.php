...
class __Mustache_7f44ad8a6f36a12f3a56edb20c09651f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3d6a804231a189ddd675338d4df5a882($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section3d6a804231a189ddd675338d4df5a882(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        <i class="fas fa-toilet">asd</i>
';
                $buffer .= $indent . '      </button>
';
                $buffer .= $indent . '    </form>
