...
class __Mustache_194228258b5dad3b070723faecb4365a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAb455dbcefbbc0683fde472e8c89a3ce($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionAb455dbcefbbc0683fde472e8c89a3ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class=" max-w-2xl w-full border-x mt-2 border-gray-800">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class=" max-w-2xl w-full border-x mt-2 border-gray-800">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
