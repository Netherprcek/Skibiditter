...
class __Mustache_820468115a1deadafd81f72c663b34c1 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section65bd0cc1c09bb41dbb5bcbd226b79a71($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section65bd0cc1c09bb41dbb5bcbd226b79a71(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
