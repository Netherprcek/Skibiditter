...
class __Mustache_e44bb61c53cd9f431bca40c0cbb367a8 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2d39de029cea5b19458287a14c3d4950($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionBd18472b630249f17bf22e3d1c362eaf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-full h-12 object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-full h-12 object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section2d39de029cea5b19458287a14c3d4950(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionBd18472b630249f17bf22e3d1c362eaf($context, $indent, $value);
