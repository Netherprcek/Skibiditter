...
class __Mustache_32543b3c59f73817d497d76ab71afbd3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section50e9a0059c07524499f646fc350e4164($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionDf5e54dc4d47cbf20b3e68d945e69b00(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="relative">
      ...
      <div
        id="options-{{id_post}}"
        class="absolute right-0 mt-2 mb-0 hidden w-48 rounded-lg bg-gray-700 shadow-lg"
      >
        <a
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="absolute right-0 mt-2 mb-0 hidden w-48 rounded-lg bg-gray-700 shadow-lg"
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <a
...
';
    ...
    private function section50e9a0059c07524499f646fc350e4164(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionDf5e54dc4d47cbf20b3e68d945e69b00($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
