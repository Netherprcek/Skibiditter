...
class __Mustache_d8c0df36446b1c937ffb4e4e5ffa86b9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5e6024b02327476f5684412e82cff30c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section5e6024b02327476f5684412e82cff30c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 rounded-lg  shadow-inner relative z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 rounded-lg  shadow-inner relative z-10">
';
                $buffer .= $indent . '    ';
