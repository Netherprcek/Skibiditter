...
class __Mustache_37ef731305d77e3e247e48c85074411d extends Mustache_Template
{
...
';
        $buffer .= $indent . '        class="hidden w-full resize-none overflow-hidden bg-gray-600 p-2 text-white"
';
        $buffer .= $indent . '      ></textarea>
';
