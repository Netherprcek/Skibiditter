...
class __Mustache_c0be1a2d9facacce96ad1fc45b2f9e50 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<div class="relative mb-6 mt-6 overflow-hidden rounded-lg bg-gray-800 shadow-md">
';
