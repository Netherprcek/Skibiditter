...
class __Mustache_a5fa7b888f8415b1125b819af56ae970 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        class="w-half rounded-lg bg-slate-700 p-2"
';
        $buffer .= $indent . '      />
';
...
';
        $buffer .= $indent . '        class="rounded-lg"
';
