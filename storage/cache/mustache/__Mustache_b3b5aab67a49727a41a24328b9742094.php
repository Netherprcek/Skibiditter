...
class __Mustache_b3b5aab67a49727a41a24328b9742094 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col pl-0 md:pl-8 lg:pl-20 text-left ">
';
