...
class __Mustache_d5a1d6ddbeca50982933ea53d3bdb2ea extends Mustache_Template
{
...
';
        ...
        $buffer .= '\'s avatar"
';
        $buffer .= $indent . '        class="mr-2 mt-4 h-32 w-32 rounded-full border-4 border-blue-700"
';
        $buffer .= $indent . '      />
';
        $buffer .= $indent . '
