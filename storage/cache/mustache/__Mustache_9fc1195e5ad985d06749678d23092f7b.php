...
class __Mustache_9fc1195e5ad985d06749678d23092f7b extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-textarea" class="hidden w-full rounded-lg resize-none overflow-hidden bg-gray-600 p-2 text-white"></textarea>
';
