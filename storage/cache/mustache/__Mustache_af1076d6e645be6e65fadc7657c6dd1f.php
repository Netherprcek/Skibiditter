...
class __Mustache_af1076d6e645be6e65fadc7657c6dd1f extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section59d407df726c75a85d8044a52ba4f874($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section59d407df726c75a85d8044a52ba4f874(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
