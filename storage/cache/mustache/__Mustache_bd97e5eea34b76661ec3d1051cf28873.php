...
class __Mustache_bd97e5eea34b76661ec3d1051cf28873 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col xl:pl-20 text-left justify-items-end">
';
