...
class __Mustache_1bf8b7a596f832dbcaf900f3841648f0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF52865e01eacfd3efeb06f998d1429e0($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function sectionF52865e01eacfd3efeb06f998d1429e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
