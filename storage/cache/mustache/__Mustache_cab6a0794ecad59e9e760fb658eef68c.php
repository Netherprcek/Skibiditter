...
class __Mustache_cab6a0794ecad59e9e760fb658eef68c extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col xl:pl-12 2xl:pl-32 text-left ">
';
