...
class __Mustache_63def86b14fd109c9290e8ceabd77552 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section91b0bf98a2d449ca2d3dcb0cd2ff21a0($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section91b0bf98a2d449ca2d3dcb0cd2ff21a0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
