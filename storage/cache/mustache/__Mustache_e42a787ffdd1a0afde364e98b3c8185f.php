...
class __Mustache_e42a787ffdd1a0afde364e98b3c8185f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAedd4f531c6cc7bb7970a15c49a69775($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionAedd4f531c6cc7bb7970a15c49a69775(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
