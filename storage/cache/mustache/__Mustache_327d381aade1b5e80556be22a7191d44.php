...
class __Mustache_327d381aade1b5e80556be22a7191d44 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        />
';
        $buffer .= $indent . '        <button class="mx-8 w-auto rounded-md bg-blue-500 p-2">Register</button>
';
        $buffer .= $indent . '      </form>
';
        $buffer .= $indent . '    </div>
