...
class __Mustache_2c3fe14806ded7edf86c27168396664e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section32e34a265c02c43982f38a9b2cc0db7a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section819c4bbe5ae8130e099b5556881b8f2b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section32e34a265c02c43982f38a9b2cc0db7a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-2 break-words px-14 text-gray-200">
    {{ post_text }}
  </p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
  ...
  <div class="flex justify-center">
    ...
    >
      ...
      <button
        ...
        class="mr-2 rounded-lg px-4 py-2 text-white hover:text-red-600 {{#liked}}text-red-500{{/liked}}"
        type="button"
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-2 break-words px-14 text-gray-200">
';
                $buffer .= $indent . '    ';
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="mr-2 rounded-lg px-4 py-2 text-white hover:text-red-600 ';
                $value = $context->find('liked');
                $buffer .= $this->section819c4bbe5ae8130e099b5556881b8f2b($context, $indent, $value);
                $buffer .= '"
';
