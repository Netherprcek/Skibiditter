...
class __Mustache_cddffce99f51b6915831b6ddc635ce38 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/3 flex-col pl-12 md:pl-16 lg:pl-20 text-left ">
';
