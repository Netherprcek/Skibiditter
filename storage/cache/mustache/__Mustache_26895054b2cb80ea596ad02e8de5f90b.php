...
class __Mustache_26895054b2cb80ea596ad02e8de5f90b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section85822f0a50dfb06fb92dabae04f41bf8($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section4c78c6a7dec1b300af439d2a48104abc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-11/12 aspect-square object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-11/12 aspect-square object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section85822f0a50dfb06fb92dabae04f41bf8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="bg-white shadow-md rounded-lg p-6 mb-6">
            <h2 class="text-xl font-semibold mb-2 bg-red-500">{{title}}</h2>
...
';
                $buffer .= $indent . '            <h2 class="text-xl font-semibold mb-2 bg-red-500">';
                $value = $this->resolveValue($context->find('title'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</h2>
';
...
';
                ...
                $buffer .= $this->section4c78c6a7dec1b300af439d2a48104abc($context, $indent, $value);
