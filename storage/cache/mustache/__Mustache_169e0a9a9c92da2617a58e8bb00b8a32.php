...
class __Mustache_169e0a9a9c92da2617a58e8bb00b8a32 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section02c99cf36718b90b0f275ffd4efc02db($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section02c99cf36718b90b0f275ffd4efc02db(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700 p-2">
          <div class="flex w-full items-center">
            ...
            <span class="ml-auto pr-10 pt-0 text-sm text-gray-300">{{created_at }}</span>
          </div>
...
';
                ...
                $buffer .= '</span>
';
                $buffer .= $indent . '          <div class="flex justify-end mt-2">
';
                $buffer .= $indent . '            <form
';
