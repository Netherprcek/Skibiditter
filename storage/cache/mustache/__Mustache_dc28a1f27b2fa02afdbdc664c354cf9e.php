...
class __Mustache_dc28a1f27b2fa02afdbdc664c354cf9e extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-16 flex h-[calc(100vh-4rem)] flex-[1_1_0] flex-col overflow-y-auto border-l-2 border-gray-800 pl-4"
';
        $buffer .= $indent . '>
';
