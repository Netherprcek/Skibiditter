...
class __Mustache_0b87b52294284a8f45a5de931ce284ee extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <label class="bg-blue-500 text-white p-2 rounded-lg cursor-pointer hover:bg-blue-600">
';
