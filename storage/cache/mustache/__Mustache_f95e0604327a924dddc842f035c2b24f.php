...
class __Mustache_f95e0604327a924dddc842f035c2b24f extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 justify-end" id="dashboard_loggedout">
';
        $buffer .= $indent . '    <a href="/login" class="flex justify-end">
';
        $buffer .= $indent . '      <button class="rounded-md bg-blue-500 px-4 py-2 text-white h-10">Login</button>
';
        $buffer .= $indent . '    </a>
';
        $buffer .= $indent . '    <a href="/register" class="ml-4 flex justify-end">
';
        $buffer .= $indent . '      <button class="rounded-md bg-blue-500 px-4 py-2 text-white h-10">
';
...
';
        $buffer .= $indent . '      <button type="submit" class="rounded-md bg-blue-500 px-4 py-2 text-white h-10">
';
