...
class __Mustache_6ca63913e178723739572d65f2df4e01 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7b50ca7a7bbfc5f6b9ef6ecb150a4e6d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section7b50ca7a7bbfc5f6b9ef6ecb150a4e6d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<article class="relative    py-4 pb-0 border-2 border-gray-800">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<article class="relative    py-4 pb-0 border-2 border-gray-800">
';
