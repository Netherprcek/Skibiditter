...
class __Mustache_f20c2dbbe6f7521bed972a68a500bc02 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD60f1aafa4d654256090abed840980ad($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionD60f1aafa4d654256090abed840980ad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      >
        <div class="relative mb-4 flex items-center justify-between space-x-2">
...
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <div class="relative mb-4 flex items-center justify-between space-x-2">
';
