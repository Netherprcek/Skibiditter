...
class __Mustache_c49423ef71372fe9f523bbc81fe8728f extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <button class="mr-4 rounded-md bg-blue-500 px-4 py-2 text-white">
';
