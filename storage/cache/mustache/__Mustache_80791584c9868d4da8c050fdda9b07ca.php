...
class __Mustache_80791584c9868d4da8c050fdda9b07ca extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <div class="flex w-2/2 flex-col pl-0 2xl:pl-12 justify-self-end text-left">
';
