...
class __Mustache_0e6a8b5a3637cdf6f4dcc6851fc60f79 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF06127a97400be7fb26583588bd4c563($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionF06127a97400be7fb26583588bd4c563(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
  ...
  <p class="mb-2 text-gray-200">{{ post_text }}asd</p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
    <img
      src="{{ img }}"
