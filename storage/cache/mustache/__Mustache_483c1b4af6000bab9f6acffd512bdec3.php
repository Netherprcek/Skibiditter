...
class __Mustache_483c1b4af6000bab9f6acffd512bdec3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section67d0ee28b7f7fdaee48e118b918626ef($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section67d0ee28b7f7fdaee48e118b918626ef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
