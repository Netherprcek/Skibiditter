...
class __Mustache_5076f866528b3044a546ac71de2c23e7 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE18fc31d163d3f3dec18a42287a6f165($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionE18fc31d163d3f3dec18a42287a6f165(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex justify-center">
    ...
    >
      ...
      <button
        ...
        class="mr-2 rounded-lg px-4 py-2 hover:text-red-300 {{#liked}}text-red-600{{/liked}}{{^liked}}text-white{{/liked}}"
        type="button"
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="mr-2 rounded-lg px-4 py-2 hover:text-red-300 ';
