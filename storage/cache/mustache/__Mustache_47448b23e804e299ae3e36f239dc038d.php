...
class __Mustache_47448b23e804e299ae3e36f239dc038d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section66fc9d497485fdb4e6bab43b5c05a0bb($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section66fc9d497485fdb4e6bab43b5c05a0bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '>
';
                $buffer .= $indent . '  <span style="font-size: 1.2em;">🚽</span>
';
