...
class __Mustache_f3f85e32084cfa6bd3e70f362b0afb17 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section447be0754793a219b99f0aef0e59ce12($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section447be0754793a219b99f0aef0e59ce12(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem border-x-2">
...
';
                $buffer .= $indent . '    <div style="width: 100%; max-width: 42rem border-x-2">
';
