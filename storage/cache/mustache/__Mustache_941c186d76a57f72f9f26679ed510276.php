...
class __Mustache_941c186d76a57f72f9f26679ed510276 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBad4cf4c996bd2d975721a36fd5acb5e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9b5b9431fc6e3f021a80a1de667db686(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        src="';
                $value = $this->resolveValue($context->find('img1'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '"
';
                $buffer .= $indent . '        alt="';
...
';
    ...
    private function sectionBad4cf4c996bd2d975721a36fd5acb5e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $value = $context->find('img1');
                $buffer .= $this->section9b5b9431fc6e3f021a80a1de667db686($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
