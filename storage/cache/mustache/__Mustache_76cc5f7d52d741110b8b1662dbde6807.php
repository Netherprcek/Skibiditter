...
class __Mustache_76cc5f7d52d741110b8b1662dbde6807 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <form class="w-80 rounded-lg bg-gray-800 p-4">
';
...
';
        $buffer .= $indent . '        <p class="mt-2 text-sm">Error: ';
