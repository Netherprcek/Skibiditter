...
class __Mustache_3a559589b16b4c21dd2c4b0613a3f570 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFbffd9540a475ee00f08ded9370d6cd5($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function sectionFbffd9540a475ee00f08ded9370d6cd5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
