...
class __Mustache_4a8078ec12235c4f02cc97616b227c3f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA6eede04d91609c2890b439957857e99($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('is_following');
        if (empty($value)) {
...
';
    ...
    private function sectionA6eede04d91609c2890b439957857e99(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <form action="/{{user_id}}/unfollow" method="POST" class="h-min">
      <button
        type="submit"
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('user_id'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/unfollow" method="POST" class="h-min">
';
                $buffer .= $indent . '      <button
';
                $buffer .= $indent . '        type="submit"
