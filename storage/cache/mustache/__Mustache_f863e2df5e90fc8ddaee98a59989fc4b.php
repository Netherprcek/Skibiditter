...
class __Mustache_f863e2df5e90fc8ddaee98a59989fc4b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8a6f65557ff323ba71e0d0249a76af09($context, $indent, $value);
        $buffer .= $indent . '  </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section8a6f65557ff323ba71e0d0249a76af09(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    <h2>';
                $value = $this->resolveValue($context->findDot('.img'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= 'a</h2>
';
                $context->pop();
