...
class __Mustache_bba58baccc4c105584e56e786fccd181 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA137591a1e4c8f944653a051cdad1458($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->sectionC75072e682c818b00bb98f4df7a4ec70($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionA137591a1e4c8f944653a051cdad1458(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC75072e682c818b00bb98f4df7a4ec70(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 rounded-lg border-b border-gray-600 bg-gray-700 p-2">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
          ...
          <span class="overflow-wrap z-10 break-words pl-14"
            >{{comment_text}}</span
          >
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 rounded-lg border-b border-gray-600 bg-gray-700 p-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <span class="overflow-wrap z-10 break-words pl-14"
';
                $buffer .= $indent . '            >';
