...
class __Mustache_61d7551ef301827b54fcf57c5a5e5c83 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex items-center">
';
        $buffer .= $indent . '    <div class="button-wrapper text-sm mx-2 p-2 flex items-center"> <!-- Add Tailwind classes here -->
';
