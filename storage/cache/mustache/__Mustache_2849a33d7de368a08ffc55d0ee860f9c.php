...
class __Mustache_2849a33d7de368a08ffc55d0ee860f9c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8820d355df9f560aeec356a72e4bb85c($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section8820d355df9f560aeec356a72e4bb85c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <h2 class="text-lg text-gray-300">{{ username }}:</h2>
...
';
                $buffer .= $indent . '            <h2 class="text-lg text-gray-300">';
