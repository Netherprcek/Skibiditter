...
class __Mustache_f1f57dd8753bdf5f1e2564a780e25dc7 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-0 xl:pl-12 align-content-end">
';
        $buffer .= $indent . '    <div class="flex flex-col text-left w-1/2">
';
