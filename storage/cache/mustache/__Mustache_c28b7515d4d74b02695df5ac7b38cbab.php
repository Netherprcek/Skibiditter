...
class __Mustache_c28b7515d4d74b02695df5ac7b38cbab extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDb42285a2aa05a6245f5355715c01a44($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionDb42285a2aa05a6245f5355715c01a44(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
