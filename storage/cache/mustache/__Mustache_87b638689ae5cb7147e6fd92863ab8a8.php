...
class __Mustache_87b638689ae5cb7147e6fd92863ab8a8 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9b12c7d7f79681a4dcb140ea5979637e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section9b12c7d7f79681a4dcb140ea5979637e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
