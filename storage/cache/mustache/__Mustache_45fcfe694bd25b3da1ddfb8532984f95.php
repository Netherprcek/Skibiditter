...
class __Mustache_45fcfe694bd25b3da1ddfb8532984f95 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBe55e81a997e7222727c2e5135024c21($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->section999d54d05a029c1b113df02245a37d9d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function sectionBe55e81a997e7222727c2e5135024c21(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section999d54d05a029c1b113df02245a37d9d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 rounded-lg border-b border-gray-600  p-2">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 rounded-lg border-b border-gray-600  p-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
