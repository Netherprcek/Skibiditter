...
class __Mustache_aff02c3fad729f1cf6e23abfc96eb6f6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE2918603180db53936dfed25e3ecc813($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionE2918603180db53936dfed25e3ecc813(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
