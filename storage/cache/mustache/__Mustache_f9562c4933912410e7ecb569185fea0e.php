...
class __Mustache_f9562c4933912410e7ecb569185fea0e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5f9313da5cba08ee651ff1e7cdbe7701($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section5f9313da5cba08ee651ff1e7cdbe7701(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex w-1/3 justify-end" id="dashboard_loggedin">
    <form action="/logout" method="POST" class="h-max-2 ml-4 flex justify-end">
      <button
        type="submit"
...
';
                $buffer .= $indent . '    <form action="/logout" method="POST" class="h-max-2 ml-4 flex justify-end">
';
                $buffer .= $indent . '      <button
';
