...
class __Mustache_cb34eae78d74e9929ea86f9353f70aeb extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <button class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-600 justify-center">SKIBIDITTER</button>
';
