...
class __Mustache_8480e8c7dfe1b6fb5fd5c8a525ffbfa3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <button class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-600 justify-self-center">SKIBIDITTER</button>
';
