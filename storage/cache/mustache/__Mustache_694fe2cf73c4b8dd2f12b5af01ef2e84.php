...
class __Mustache_694fe2cf73c4b8dd2f12b5af01ef2e84 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $indent . '          <h2 class="mb-6 mt-16 text-center text-xl font-bold bg text-white">
';
            $buffer .= $indent . '            Login to interact with the community.
';
            $buffer .= $indent . '            Feel free to visit the explore page to see what\'s happening in meantime.
';
            $buffer .= $indent . '          </h2>
';
        }
