...
class __Mustache_457bd88c8c6812045c2a912a2c67205f extends Mustache_Template
{
...
';
            $buffer .= $indent . '          <h2 class="mb-6 mt-16 rounded-lg bg-gray-800 p-4 text-center text-xl font-bold text-white">
';
            $buffer .= $indent . '            In the meantime, feel free to visit the <a href="/explore" class="text-blue-500"></a>explore page</a> to see what\'s happening 😊
';
            $buffer .= $indent . '          </h2>
';
        }
