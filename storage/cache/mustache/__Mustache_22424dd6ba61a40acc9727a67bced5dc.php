...
class __Mustache_22424dd6ba61a40acc9727a67bced5dc extends Mustache_Template
{
...
';
            $buffer .= $indent . '        <p class="text-white"><a href="/login" class="bg-blue-500 p-2 rounded-md">Login</a> to comment</p>
';
            $buffer .= $indent . '      </div>
';
        }
