...
class __Mustache_5c2369c99a30c065c01590230c4f928c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE3303cb12488e64b0b6ceb5ebee0dfae($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionE3303cb12488e64b0b6ceb5ebee0dfae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
