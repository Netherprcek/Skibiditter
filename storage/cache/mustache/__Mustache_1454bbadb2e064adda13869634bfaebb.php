...
class __Mustache_1454bbadb2e064adda13869634bfaebb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8160bdd7a34cadb1675f0c01c6cf5b1d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section8160bdd7a34cadb1675f0c01c6cf5b1d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '      style="position: relative; overflow: hidden"
';
                $buffer .= $indent . '    >
';
