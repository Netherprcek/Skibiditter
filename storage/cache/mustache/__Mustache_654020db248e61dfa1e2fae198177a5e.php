...
class __Mustache_654020db248e61dfa1e2fae198177a5e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF0595c5eb9fd82aab4508cff62bf2bc4($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionF0595c5eb9fd82aab4508cff62bf2bc4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
