...
class __Mustache_be9366a498a48963e47493e0b30afd5a extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= ' ';
            $value = $context->findDot('profile.is_owner');
            $buffer .= $this->section6fbfae55f18d0361c4b5fc9265f8262e($context, $indent, $value);
            $buffer .= ' ';
        }
        $buffer .= ' ';
        $value = $context->findDot('profile.is_owner');
...
';
    ...
    private function section6fbfae55f18d0361c4b5fc9265f8262e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
