...
class __Mustache_4152da5f5d715c0d5bf0b6eb1eb60c83 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA675b9cad6868eef77111e36a5242ee9($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function sectionA675b9cad6868eef77111e36a5242ee9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <li class="flex items-center mb-2">
          ...
          <span class="ml-2"> <a href="/profile/{{username}}" class="text-blue-500">{{username}}</a> has created a new <a href="{{id_post}}/comments" class="text-blue-500">post</a> - {{created_at}}</span>
        </li>
      ';
