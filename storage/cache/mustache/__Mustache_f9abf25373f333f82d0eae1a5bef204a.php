...
class __Mustache_f9abf25373f333f82d0eae1a5bef204a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section18020879ad1b46a7636016115882da93($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section18020879ad1b46a7636016115882da93(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  {{!-- Logout Button --}}
    ...
    <a href="/profile" class="ml-10 rounded-full bg-blue-500 p-0.5">
      ...
      >
        <span class="truncate pl-1">{{user}}</span>
      </div>
    </a>
  </div>
  ';
...
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <span class="truncate pl-1">';
