...
class __Mustache_7d1aa620ed53e0c6a4e116691b1c4dcb extends Mustache_Template
{
...
';
        $buffer .= $indent . '  </head>
';
        $buffer .= $indent . '  <body class="bg-gray-100 flex justify-center items-center min-h-screen">
';
...
';
        ...
        $buffer .= $this->sectionCeda5d529df92ffbfc16c03f8d16295e($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionCeda5d529df92ffbfc16c03f8d16295e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <article class="bg-white shadow-md rounded-lg p-6 mb-6 mx-auto" style="max-width: 100%;">
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <article class="bg-white shadow-md rounded-lg p-6 mb-6 mx-auto" style="max-width: 100%;">
';
