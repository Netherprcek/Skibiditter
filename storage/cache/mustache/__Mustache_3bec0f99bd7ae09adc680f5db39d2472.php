...
class __Mustache_3bec0f99bd7ae09adc680f5db39d2472 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEd644c0a8bb8ab923bd4f1ff2934fd16($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionEd644c0a8bb8ab923bd4f1ff2934fd16(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
