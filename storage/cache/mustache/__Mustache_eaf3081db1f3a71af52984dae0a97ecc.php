...
class __Mustache_eaf3081db1f3a71af52984dae0a97ecc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section11e9a629d1084e8da6181604b487a2b1($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section11e9a629d1084e8da6181604b487a2b1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
