...
class __Mustache_871e3039d6c0bf63c22d0d232c201b71 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section81a34101631fdd21acc741a565da54b9($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section81a34101631fdd21acc741a565da54b9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class="overflow-wrap break-word mb-4 break-words rounded-lg px-8 py-3 text-gray-100 shadow-inner"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class="overflow-wrap break-word mb-4 break-words rounded-lg px-8 py-3 text-gray-100 shadow-inner"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
