...
class __Mustache_0233d816db15875c50c594e17f6b0778 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDcdb32bef6979a21d0f60aa9e65c35f6($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionDcdb32bef6979a21d0f60aa9e65c35f6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
