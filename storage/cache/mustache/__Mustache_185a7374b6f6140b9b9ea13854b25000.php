...
class __Mustache_185a7374b6f6140b9b9ea13854b25000 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section42b13e5164a0ec285e32e8692a063ccf($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section42b13e5164a0ec285e32e8692a063ccf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
