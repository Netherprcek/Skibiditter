...
class __Mustache_2cd4feafaac25117e8e7f7bd448d792c extends Mustache_Template
{
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '          <button type="submit" class="font-bold text-white">
';
        $buffer .= $indent . '            ';
