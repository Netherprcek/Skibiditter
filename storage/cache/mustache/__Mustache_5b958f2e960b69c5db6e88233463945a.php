...
class __Mustache_5b958f2e960b69c5db6e88233463945a extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section41fc3deb6b27c75bb6b2aacc1d9f95e6($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section41fc3deb6b27c75bb6b2aacc1d9f95e6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-shadow-default"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-shadow-default"
';
                $buffer .= $indent . '        >
';
