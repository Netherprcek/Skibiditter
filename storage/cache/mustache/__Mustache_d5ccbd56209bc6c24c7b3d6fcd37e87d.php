...
class __Mustache_d5ccbd56209bc6c24c7b3d6fcd37e87d extends Mustache_Template
{
...
';
        $buffer .= $indent . '    ></textarea>
';
        $buffer .= $indent . '    <button type="submit" class="absolute right-2 top-16 rounded-lg bg-blue-500 p-2 text-white">
';
