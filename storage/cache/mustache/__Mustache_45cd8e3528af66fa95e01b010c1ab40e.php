...
class __Mustache_45cd8e3528af66fa95e01b010c1ab40e extends Mustache_Template
{
...
';
        $value = $context->findDot('profile.is_owner');
        $buffer .= $this->section7e356f9c1d0a54bb933a418f8c97ac44($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section7e356f9c1d0a54bb933a418f8c97ac44(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
