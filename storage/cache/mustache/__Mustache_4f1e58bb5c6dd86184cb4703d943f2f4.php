...
class __Mustache_4f1e58bb5c6dd86184cb4703d943f2f4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE47ebf5042575c5760d621749fc22ebc($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '      
';
...
';
    ...
    private function sectionE47ebf5042575c5760d621749fc22ebc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $indent . '        <span class="text-white">';
                $value = $this->resolveValue($context->find('username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</span>
';
