...
class __Mustache_be204858e993d6ba4f0b0b3428cb4b9f extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-textarea" class="hidden w-full rounded-lg bg-gray-600 p-2 text-white"></textarea>
';
