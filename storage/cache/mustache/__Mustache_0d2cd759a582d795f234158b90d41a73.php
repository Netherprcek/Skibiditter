...
class __Mustache_0d2cd759a582d795f234158b90d41a73 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section005af0a76d3c59e858f9552642f96def($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section22d08c011e3d28c9ea92ca0832ba94e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-4/5 aspect-square object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-4/5 aspect-square object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section005af0a76d3c59e858f9552642f96def(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section22d08c011e3d28c9ea92ca0832ba94e0($context, $indent, $value);
