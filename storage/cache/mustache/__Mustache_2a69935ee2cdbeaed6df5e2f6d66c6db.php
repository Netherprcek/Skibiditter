...
class __Mustache_2a69935ee2cdbeaed6df5e2f6d66c6db extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section372d253b63d647bf04746599c97d8765($context, $indent, $value);
        $buffer .= ' ';
...
';
    ...
    private function section372d253b63d647bf04746599c97d8765(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
      <div class="mb-6 rounded-lg bg-gray-600 p-6 shadow-md">
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '      <div class="mb-6 rounded-lg bg-gray-600 p-6 shadow-md">
';
