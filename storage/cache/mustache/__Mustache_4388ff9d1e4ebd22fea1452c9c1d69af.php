...
class __Mustache_4388ff9d1e4ebd22fea1452c9c1d69af extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2c531e75d0e33cbf2ef2f6c38413978d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section2c531e75d0e33cbf2ef2f6c38413978d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="w-full max-w-2xl border-x-2 border-gray-800">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="w-full max-w-2xl border-x-2 border-gray-800">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
