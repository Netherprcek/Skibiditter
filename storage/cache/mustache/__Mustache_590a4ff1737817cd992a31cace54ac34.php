...
class __Mustache_590a4ff1737817cd992a31cace54ac34 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section707090f2f7cddf35a10f1271b4d7cdf0($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section707090f2f7cddf35a10f1271b4d7cdf0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  {{!-- Logout Button --}}
    ...
    <a href="/profile" class="ml-10 rounded-full bg-blue-500 p-0.5">
      ...
      >
        <span class="pl-1" style="white-space: nowrap; overflow: hidden; text-overflow: clip; width: 30px;">{{user}}</span>
      </div>
    </a>
  </div>
  ';
...
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <span class="pl-1" style="white-space: nowrap; overflow: hidden; text-overflow: clip; width: 30px;">';
