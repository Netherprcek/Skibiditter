...
class __Mustache_d8b65e8708401f892bbd33937a2999a5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAda0c38088da1ae11fea744bcf31e407($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionAda0c38088da1ae11fea744bcf31e407(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-600 rounded-lg bg-gray-700 p-2">
          ...
          <span class="pl-14">{{comment_text}}</span>
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <span class="pl-14">';
