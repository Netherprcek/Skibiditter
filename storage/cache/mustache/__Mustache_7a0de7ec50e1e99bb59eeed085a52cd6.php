...
class __Mustache_7a0de7ec50e1e99bb59eeed085a52cd6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section78070be53862f5345713e7733a82acdc($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section7a19c0d3943ba4a9e33386534f9e304f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        src="';
                $value = $this->resolveValue($context->findDot('post.img1'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '"
';
                $buffer .= $indent . '        alt="';
...
';
    ...
    private function section78070be53862f5345713e7733a82acdc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section7a19c0d3943ba4a9e33386534f9e304f($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
