...
class __Mustache_3ac6dfb6ef3048cb5c3c155dd1af7254 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3365f0400ec6c589f0f8e35d8b71aca8($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section3365f0400ec6c589f0f8e35d8b71aca8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div class="rounded-lg border-2 border-gray-700 bg-gray-900 pb-4">
    <p
      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100"
    >
      {{ post_text }}
    </p>
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="rounded-lg border-2 border-gray-700 bg-gray-900 pb-4">
';
                $buffer .= $indent . '    <p
';
                $buffer .= $indent . '      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100"
';
                $buffer .= $indent . '    >
';
                $buffer .= $indent . '      ';
