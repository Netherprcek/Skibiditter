...
class __Mustache_4e1c8ab200e356ce9d6f43d938e81715 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section19d919885223fa475a8385da0d78210c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section19d919885223fa475a8385da0d78210c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex justify-center">
    ...
    >
      ...
      <button
        ...
        class="mr-2 rounded-lg px-4 py-2 hover:text-red-200 {{#liked}}text-red-600{{/liked}}{{^liked}}text-white{{/liked}}"
        type="button"
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="mr-2 rounded-lg px-4 py-2 hover:text-red-200 ';
