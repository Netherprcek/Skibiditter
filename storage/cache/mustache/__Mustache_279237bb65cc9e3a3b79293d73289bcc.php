...
class __Mustache_279237bb65cc9e3a3b79293d73289bcc extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div
';
        $buffer .= $indent . '      class="ml-10 flex h-10 w-10 items-center justify-center rounded-full border-4 border-blue-500  font-bold text-gray-600"
';
        $buffer .= $indent . '    >
';
        $buffer .= $indent . '      ';
