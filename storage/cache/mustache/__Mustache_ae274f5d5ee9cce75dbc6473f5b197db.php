...
class __Mustache_ae274f5d5ee9cce75dbc6473f5b197db extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <h2 class="mb-6 text-xl font-bold text-center">Recent activity</h2>
';
