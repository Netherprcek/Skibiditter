...
class __Mustache_803f9ab12d9bcd62af69d3a5222a75bc extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="container mx- px-4">
';
        $buffer .= $indent . '      <div class="grid grid-cols-1 gap-6 max-w-2xl mx-auto">
';
        $value = $context->find('posts');
        $buffer .= $this->section42099f412d3afd2b9b0c5bfefcca3701($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section42099f412d3afd2b9b0c5bfefcca3701(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <article class="bg-white shadow-md rounded-lg p-6 w-96">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <article class="bg-white shadow-md rounded-lg p-6 w-96">
';
