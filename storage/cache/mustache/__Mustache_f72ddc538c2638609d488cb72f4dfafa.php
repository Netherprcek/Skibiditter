...
class __Mustache_f72ddc538c2638609d488cb72f4dfafa extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->findDot('session_user.background'), $context);
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section763ea255829c95f61d6b924fc95bef78($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section763ea255829c95f61d6b924fc95bef78(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="text-shadow-default hover:text-shadow-lg text-md mt-16 rounded-lg border-2 border-red-700 bg-red-600 px-4 py-2 text-white transition duration-300 ease-in-out hover:bg-red-700"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="text-shadow-default hover:text-shadow-lg text-md mt-16 rounded-lg border-2 border-red-700 bg-red-600 px-4 py-2 text-white transition duration-300 ease-in-out hover:bg-red-700"
';
                $buffer .= $indent . '        >
';
