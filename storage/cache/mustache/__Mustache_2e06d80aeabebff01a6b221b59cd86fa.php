...
class __Mustache_2e06d80aeabebff01a6b221b59cd86fa extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="fixed left-0 top-16 z-10 flex h-[calc(100vh-4rem)] w-1/3 content-end overflow-y-auto border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
