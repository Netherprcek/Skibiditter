...
class __Mustache_5ee6da75ea9e8e3e7173ca26b8f10872 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <button type="submit" class="rounded-lg bg-blue-500 p-2 my-2 text-white">
';
