...
class __Mustache_287094453f997a351d20f6f4a2d42688 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section539326e1c8b43b15f11db430b4caa54f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionD6fa8efc34b49790e74a3ae3c2b714c1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section539326e1c8b43b15f11db430b4caa54f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionD6fa8efc34b49790e74a3ae3c2b714c1($context, $indent, $value);
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '    </div>
';
