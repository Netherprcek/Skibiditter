...
class __Mustache_ae72158f737c4b6df6eaeb04f5646cbf extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4f4c47bde29bf9da742f9167c21999e0($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section4f4c47bde29bf9da742f9167c21999e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    <div class="flex items-center">
      ...
      <span class="mb-4 text-sm text-gray-300">Created at: {{ created_at }}</span>
    </div>
    {{#is_owner}}
    <div class="relative">
      <button class="text-white" onclick="toggleOptions(\'{{id_post}}\', event)">
...
';
                $buffer .= $indent . '      </span>
';
                $buffer .= $indent . '      <span class="mb-4 text-sm text-gray-300">Created at: ';
