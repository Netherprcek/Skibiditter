...
class __Mustache_c6648399b59c58a708b6d4dead96c18b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section83b2b3cdfad8ec7140ba6c4ec9bba223($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '      </div>
';
...
';
    ...
    private function section83b2b3cdfad8ec7140ba6c4ec9bba223(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <a href="?page=2" class="btn btn-primary bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Next</a>
          ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '          <a href="?page=2" class="btn btn-primary bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Next</a>
';
                $context->pop();
            }
        }
