...
class __Mustache_55cfacfb22965532ed20cab9e998860d extends Mustache_Template
{
...
';
        $buffer .= $indent . '        class="absolute  right-2 mb-2 text-gray-400 hover:text-gray-300"
';
        $buffer .= $indent . '      >
';
        $buffer .= $indent . '        <svg
