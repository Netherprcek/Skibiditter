...
class __Mustache_6d3a284929924343664b0537ec7cd78d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEd7855cfd954994d4a5ddf7ad8210eae($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->sectionC4357a0c1b8a811b3f8f3b79ff7d6a0b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionEd7855cfd954994d4a5ddf7ad8210eae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC4357a0c1b8a811b3f8f3b79ff7d6a0b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 rounded-lg border border-gray-600 bg-gray-800 p-2">
          ...
          <div class="mt-2 flex justify-center">
            <form
              id="like-form-{{like_id}}"
              action="/{{id_comment}}/handleCommentlike"
              method="POST"
            ...
            >
              ...
              >
                ...
                <span id="like-count-{{like_id}}">{{likes}}</span>
              </button>
            </form>
...
';
                ...
                $value = $this->resolveValue($context->find('like_id'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '"
';
