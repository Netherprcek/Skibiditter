...
class __Mustache_ca6e7b3f785e32fee0abcb8c4e597556 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAc7be0696f87b0ba1e00cd6051927721($context, $indent, $value);
        $buffer .= ' ';
...
';
    ...
    private function sectionAc7be0696f87b0ba1e00cd6051927721(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
          ...
          <div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <form>
              <input
                type="text"
                placeholder="Title"
                class="w-full rounded-lg bg-slate-700 p-2 mb-2"
              />
              <input
                type="text"
...
';
                $buffer .= $indent . '                class="w-full rounded-lg bg-slate-700 p-2 mb-2"
';
                $buffer .= $indent . '              />
';
                $buffer .= $indent . '              <input
