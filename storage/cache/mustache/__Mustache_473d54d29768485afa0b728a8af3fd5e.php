...
class __Mustache_473d54d29768485afa0b728a8af3fd5e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4c6fbd047d788c2df6fa689888d8ac6f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('is_following');
        if (empty($value)) {
...
';
    ...
    private function section4c6fbd047d788c2df6fa689888d8ac6f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <form action="/{{user_id}}/unfollow" method="POST" class="h-2">
      <button
        type="submit"
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('user_id'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/unfollow" method="POST" class="h-2">
';
                $buffer .= $indent . '      <button
';
                $buffer .= $indent . '        type="submit"
