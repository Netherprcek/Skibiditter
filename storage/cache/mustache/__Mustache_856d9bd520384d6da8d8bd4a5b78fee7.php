...
class __Mustache_856d9bd520384d6da8d8bd4a5b78fee7 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        class="absolute top-6 right-2 mb-2 text-gray-400 hover:text-gray-300"
';
        $buffer .= $indent . '      >
';
        $buffer .= $indent . '        <svg
