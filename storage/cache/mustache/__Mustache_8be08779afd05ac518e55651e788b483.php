...
class __Mustache_8be08779afd05ac518e55651e788b483 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-4 xl:pl-20 min-[2000px]:pl-40 text-left justify-items-end">
';
