...
class __Mustache_89cd3d4e791f8849f243c4fd85dc3c57 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD073f542d85a4245279cfe987ddc3aef($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionD073f542d85a4245279cfe987ddc3aef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
