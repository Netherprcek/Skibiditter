...
class __Mustache_4aca236bd010713543cb09e9dc5df89e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section41d8727f7f09d3a3ff7fee4dc5233c31($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section41d8727f7f09d3a3ff7fee4dc5233c31(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <div class="mb-4 flex items-center">
              <span class="mr-2">
                {{> partials/profileAvatar post_user=.}}
              </span>
...
';
                if ($partial = $this->mustache->loadPartial('partials/profileAvatar post_user=.')) {
