...
class __Mustache_8b389c902196031c46919fe5ca797151 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAf8de7701e4d678af75dc446cb3eca23($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionAf8de7701e4d678af75dc446cb3eca23(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-4 border-b pb-4">
';
