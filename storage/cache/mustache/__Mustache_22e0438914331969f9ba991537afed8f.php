...
class __Mustache_22e0438914331969f9ba991537afed8f extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->section824c2bb2243b80d73515a81a4d023c27($context, $indent, $value);
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
                ...
                $buffer .= '/unfollow"
';
                $buffer .= $indent . '        class="mt-16 rounded-lg bg-blue-6000 px-4 py-2 text-white hover:bg-blue-700"
';
                $buffer .= $indent . '      >
';
...
';
    ...
    private function section824c2bb2243b80d73515a81a4d023c27(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
