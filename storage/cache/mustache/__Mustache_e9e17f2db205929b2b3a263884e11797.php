...
class __Mustache_e9e17f2db205929b2b3a263884e11797 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-16 flex h-[calc(100vh-4rem)] flex-grow content-end overflow-y-auto border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '  <div class="flex w-1/2 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-4 xl:pl-20 min-[2000px]:pl-40 min-[2500px]:pl-80 text-left justify-items-end">
';
