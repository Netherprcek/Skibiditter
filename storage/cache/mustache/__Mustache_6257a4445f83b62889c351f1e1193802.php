...
class __Mustache_6257a4445f83b62889c351f1e1193802 extends Mustache_Template
{
...
';
        ...
        $buffer .= ' ';
        $value = $context->findDot('profile.is_owner');
        $buffer .= $this->sectionF065a03da9ce15a5d2e6b5e5b0154e02($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionF065a03da9ce15a5d2e6b5e5b0154e02(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      >
        <textarea
          ...
          style="padding: 0; margin: 0; line-height: 1.5; font-size: 1rem;"
        ></textarea>
        <button
          type="submit"
...
';
                $buffer .= $indent . '          style="padding: 0; margin: 0; line-height: 1.5; font-size: 1rem;"
';
                $buffer .= $indent . '        ></textarea>
';
