...
class __Mustache_4f459fdd82012198164e2af05c74e1f0 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<a href="/profile" class="ml-10 h-8 rounded-full bg-blue-500 p-0.5">
';
        $buffer .= $indent . '  <div
';
