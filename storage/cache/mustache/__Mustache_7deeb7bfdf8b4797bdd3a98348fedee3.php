...
class __Mustache_7deeb7bfdf8b4797bdd3a98348fedee3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section618f10332106c483f8db212168fbd137($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9f6a8e1223f5bbda869c7afdb373081d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section618f10332106c483f8db212168fbd137(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section9f6a8e1223f5bbda869c7afdb373081d($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
