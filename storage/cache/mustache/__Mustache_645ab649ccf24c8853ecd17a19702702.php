...
class __Mustache_645ab649ccf24c8853ecd17a19702702 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section57f1ffdbf9cce723a29211730996be02($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section57f1ffdbf9cce723a29211730996be02(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
