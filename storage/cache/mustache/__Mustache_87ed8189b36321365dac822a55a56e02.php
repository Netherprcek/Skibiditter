...
class __Mustache_87ed8189b36321365dac822a55a56e02 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section47ed3d4464c0879f10442ccbd345f096($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section6cad0aeb555a7ad0c4f65c0537868d5b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-full h-96 object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-full h-96 object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section47ed3d4464c0879f10442ccbd345f096(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section6cad0aeb555a7ad0c4f65c0537868d5b($context, $indent, $value);
