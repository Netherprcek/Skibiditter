...
class __Mustache_e6ffb611ffaf5c6b2388b56a25e582e6 extends Mustache_Template
{
...
';
        ...
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= ' <span class="text-gray-300 font-semibold">Following</span>
';
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '        
...
';
        ...
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= ' <span class="text-gray-300 font-semibold">Followers</span>
';
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '        
