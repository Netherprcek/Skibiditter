...
class __Mustache_5209f8007c1b9ebff77fda1c0318b62f extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= '
';
            $buffer .= $indent . '        <span class="text-white">No comments yet, be the first one!</span>
';
            $value = $context->find('session_user');
            if (empty($value)) {
                
                $buffer .= $indent . '        <a href="/login" class="flex w-auto rounded-md bg-blue-500 p-2 text-center">Login to comment</a>
';
            }
        }
        $buffer .= $indent . '      </div>
