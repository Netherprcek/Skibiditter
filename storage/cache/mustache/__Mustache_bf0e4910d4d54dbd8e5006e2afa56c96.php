...
class __Mustache_bf0e4910d4d54dbd8e5006e2afa56c96 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionE9ae127c303796304fc9bea9b3b03aaa($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionE9ae127c303796304fc9bea9b3b03aaa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="post_form" action="/{{username}}/edit-profile" method="post">
        <input
          type="text"
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '/edit-profile" method="post">
';
                $buffer .= $indent . '        <input
';
