...
class __Mustache_99b6817523d1c52c6683d2c595212ecd extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-40 text-left justify-items-end">
';
