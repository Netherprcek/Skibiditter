...
class __Mustache_4ad0ee512267dbdfb62efac81ae12fe4 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<a href="/profile" class="ml-10 h-11 rounded-full bg-blue-500 p-0.5">
';
        $buffer .= $indent . '  <div
';
