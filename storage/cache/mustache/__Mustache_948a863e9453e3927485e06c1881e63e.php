...
class __Mustache_948a863e9453e3927485e06c1881e63e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEe551cb92e9514ca5d0a49d3b4afb9f0($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionEe551cb92e9514ca5d0a49d3b4afb9f0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
