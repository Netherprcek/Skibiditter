...
class __Mustache_67e15014c6bf73b289772f9dca8b9dba extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF0d3f131c75dd1bb308108b04653e60a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionF0d3f131c75dd1bb308108b04653e60a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex justify-center">
    <form action="/{{id_post}}/like" method="POST" class="flex items-center">
      ...
      <a
        ...
        onclick="document.getElementById(\'like-form-{{id_post}}\').submit(); return false;"
      >
        <button
          type="button"
...
';
                $buffer .= $indent . '        onclick="document.getElementById(\'like-form-';
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '\').submit(); return false;"
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <button
