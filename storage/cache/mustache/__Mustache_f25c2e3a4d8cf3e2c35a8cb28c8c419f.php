...
class __Mustache_f25c2e3a4d8cf3e2c35a8cb28c8c419f extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-0 xl:pl-12">
';
        $buffer .= $indent . '    <div class="flex w-full">
';
        $buffer .= $indent . '      <div class="flex w-1/3 flex-col"></div>
';
        $buffer .= $indent . '      <div class="flex w-2/2 flex-col pl-0 xl:pl-4 2xl:pl-12 justify-self-end text-left">
';
