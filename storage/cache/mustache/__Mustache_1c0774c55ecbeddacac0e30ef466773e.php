...
class __Mustache_1c0774c55ecbeddacac0e30ef466773e extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="sticky top-20 h-[calc(100vh-4rem)] flex w-1/3 content-end border-r-2 border-gray-800 pl-4 pr-4 text-right overflow-y-auto"
';
        $buffer .= $indent . '>
';
