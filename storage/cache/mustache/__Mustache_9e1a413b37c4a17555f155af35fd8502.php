...
class __Mustache_9e1a413b37c4a17555f155af35fd8502 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF4e9964064177a9eb2defe5e2d3e91a1($context, $indent, $value);
        $buffer .= ' ';
...
';
        ...
        $buffer .= $this->section5f858e6268324d577362408865ee203f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionF4e9964064177a9eb2defe5e2d3e91a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section5f858e6268324d577362408865ee203f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-4 border-b border-gray-700 pb-4">
          <div class="flex items-center">
            ...
            <span class="text-gray-3000 pr-10 pt-0 text-sm"
              >Created at: {{created_at }}</span
            >
          </div>
          <p>{{comment_text}}</p>
...
';
                ...
                $buffer .= '</span>
';
                $buffer .= $indent . '            <span class="text-gray-3000 pr-10 pt-0 text-sm"
';
                $buffer .= $indent . '              >Created at: ';
                $value = $this->resolveValue($context->find('created_at'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
