...
class __Mustache_0d26fc83cb965b8cde729547d7732a4d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCbbbb3c49c9b1f2268249cb0e8e5f524($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        $buffer .= $this->sectionDe80e4cf90c3dc96e73a50b9d80d08fe($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
        ...
        $buffer .= $this->section9a3c24e7ac12f9a2f9025c85a99910d6($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function sectionCbbbb3c49c9b1f2268249cb0e8e5f524(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionDe80e4cf90c3dc96e73a50b9d80d08fe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9a3c24e7ac12f9a2f9025c85a99910d6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
