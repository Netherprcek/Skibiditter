...
class __Mustache_e10fb8c628b63f631c1e160efad3be76 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section915826b8e9f7d27e79fc0b249d738a10($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section915826b8e9f7d27e79fc0b249d738a10(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="mb-2 px-10 text-gray-200">{{ post_text }}</p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
    <img
      src="{{ img }}"
...
';
                ...
                $buffer .= '</h2>
';
                $buffer .= $indent . '  <p class="mb-2 px-10 text-gray-200">';
