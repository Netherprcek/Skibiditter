...
class __Mustache_a73c9e48d64753b35ca0da74490942ff extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section78cb038670fb5aef98edd1620ef36e03($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section78cb038670fb5aef98edd1620ef36e03(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
