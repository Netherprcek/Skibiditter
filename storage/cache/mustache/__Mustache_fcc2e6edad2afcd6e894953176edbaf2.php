...
class __Mustache_fcc2e6edad2afcd6e894953176edbaf2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9c96c878ee9650a5be74aa2468ded3e2($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9c96c878ee9650a5be74aa2468ded3e2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
>
  ...
  <button
    ...
    class="mr-2 rounded-lg px-4 py-2 text-white hover:text-red-500 {{#liked}}text-red-600{{/liked}}"
    type="button"
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '    class="mr-2 rounded-lg px-4 py-2 text-white hover:text-red-500 ';
