...
class __Mustache_e6d1a1371dcb43893eb8634903a25438 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section67ccc43fec8ef9c7ed8f6ef8aa4239d7($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section67ccc43fec8ef9c7ed8f6ef8aa4239d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
