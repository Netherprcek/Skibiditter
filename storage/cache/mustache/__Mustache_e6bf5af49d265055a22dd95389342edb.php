...
class __Mustache_e6bf5af49d265055a22dd95389342edb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionFbf8e268e1fcec2293fefb7d60c785bc($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionFbf8e268e1fcec2293fefb7d60c785bc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div class="rounded-lg border-2 border-gray-700 bg-gray-900">
    <p
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="rounded-lg border-2 border-gray-700 bg-gray-900">
';
                $buffer .= $indent . '    <p
';
