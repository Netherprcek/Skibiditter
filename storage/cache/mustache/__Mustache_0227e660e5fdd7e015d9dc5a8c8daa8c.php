...
class __Mustache_0227e660e5fdd7e015d9dc5a8c8daa8c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC028976a987465eaceab1d7a916cd69c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionC028976a987465eaceab1d7a916cd69c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
