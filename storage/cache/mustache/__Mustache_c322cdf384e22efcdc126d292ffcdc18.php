...
class __Mustache_c322cdf384e22efcdc126d292ffcdc18 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7465ef90b443473ba4b0779b0275f035($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section7465ef90b443473ba4b0779b0275f035(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
