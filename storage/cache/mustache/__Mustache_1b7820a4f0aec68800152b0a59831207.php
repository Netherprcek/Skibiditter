...
class __Mustache_1b7820a4f0aec68800152b0a59831207 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section742778f54d388f52b10b345074e4317d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('is_following');
        if (empty($value)) {
...
';
    ...
    private function section742778f54d388f52b10b345074e4317d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
