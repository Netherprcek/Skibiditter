...
class __Mustache_301d1a877df1cda2d8756896e1ca1807 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>
';
        $buffer .= $indent . '      <textarea id="bio-input" class="hidden">';
        $value = $this->resolveValue($context->findDot('profile.bio'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
        $buffer .= '</textarea>
';
        $buffer .= $indent . '      <button id="bio-update" class="hidden bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Update</button>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '
