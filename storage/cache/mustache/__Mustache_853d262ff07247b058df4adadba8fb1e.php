...
class __Mustache_853d262ff07247b058df4adadba8fb1e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5525eabed3d48408211971b37c5e3c00($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section5525eabed3d48408211971b37c5e3c00(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
