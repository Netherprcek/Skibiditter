...
class __Mustache_67c4e4948ab46a516ffed697ffddc104 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9e156a35bd52e96c635b049dfa1cc1fb($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9e156a35bd52e96c635b049dfa1cc1fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
