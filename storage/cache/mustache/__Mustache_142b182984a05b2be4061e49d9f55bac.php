...
class __Mustache_142b182984a05b2be4061e49d9f55bac extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section401dfd3c71167d6ec127965cde13669c($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionF822b20b48b247c7f85f76b03f5166ae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center">
                <img src="{{img}}" alt="{{title}}" class="w-4/5 h-auto object-contain" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-4/5 h-auto object-contain" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section401dfd3c71167d6ec127965cde13669c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionF822b20b48b247c7f85f76b03f5166ae($context, $indent, $value);
