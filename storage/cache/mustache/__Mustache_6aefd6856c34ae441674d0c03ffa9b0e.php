...
class __Mustache_6aefd6856c34ae441674d0c03ffa9b0e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section949bb471b2b9b1a27326b1e3b280d809($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section949bb471b2b9b1a27326b1e3b280d809(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
