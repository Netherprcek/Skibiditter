...
class __Mustache_608c03dd710561207c3f347852153822 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section78b4b0af2b31372ef904d3919098d9a0($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section78b4b0af2b31372ef904d3919098d9a0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 border-b border-gray-600 bg-gray-700">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 border-b border-gray-600 bg-gray-700">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
