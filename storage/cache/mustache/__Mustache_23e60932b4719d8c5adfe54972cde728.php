...
class __Mustache_23e60932b4719d8c5adfe54972cde728 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        profileCard.classList.add("fixed", "top-0", "w-full", "z-50");
';
        $buffer .= $indent . '      } else {
';
        $buffer .= $indent . '        profileCard.classList.remove("fixed", "top-0", "w-full", "z-50");
';
        $buffer .= $indent . '      }
';
        $buffer .= $indent . '    });
