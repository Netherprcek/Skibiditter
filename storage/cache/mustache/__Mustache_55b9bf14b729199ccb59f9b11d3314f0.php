...
class __Mustache_55b9bf14b729199ccb59f9b11d3314f0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section318c28309c486c75bbba4a65df8df5db($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section318c28309c486c75bbba4a65df8df5db(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div>
    <p
      class="overflow-wrap break-word z-10 mb-4 break-words rounded-lg border-2 border-gray-700 bg-gray-900 px-6 py-3 text-gray-100"
    >
      {{ post_text }}
    </p>
...
';
                $buffer .= $indent . '    <p
';
                $buffer .= $indent . '      class="overflow-wrap break-word z-10 mb-4 break-words rounded-lg border-2 border-gray-700 bg-gray-900 px-6 py-3 text-gray-100"
';
                $buffer .= $indent . '    >
';
                $buffer .= $indent . '      ';
