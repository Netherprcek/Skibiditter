...
class __Mustache_9f448da72db06f17eb675fb9088bcbdb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEef0a0f211215a2142c2c81b922ab1f7($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionEef0a0f211215a2142c2c81b922ab1f7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <div class="mb-4">{{> partials/profileAvatar}}<span class="mb-2 text-center text-xl font-semibold text-white">
              {{ username }}
            </span></div>
...
';
                ...
                $buffer .= '<span class="mb-2 text-center text-xl font-semibold text-white">
';
                $buffer .= $indent . '              ';
