...
class __Mustache_49e17d7fb4e2aa2f5985d72accdc8fad extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section03d754c61508ac9bc031dd989ee5153d($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section03d754c61508ac9bc031dd989ee5153d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
  ...
  <a href="/{{id_post}}/delete" method="post">
    <input type="hidden" name="post_id" value="{{id_post}}" />
    <input type="hidden" name="username" value="{{username}}" />
