...
class __Mustache_d0bfd6d5494994b34dd0edad34e563f9 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section76230969d09bac79867863a443e57898($context, $indent, $value);
            $buffer .= ' ';
        }
        $buffer .= '
';
...
';
    ...
    private function section76230969d09bac79867863a443e57898(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
