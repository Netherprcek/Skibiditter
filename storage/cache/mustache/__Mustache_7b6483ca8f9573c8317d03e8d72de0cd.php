...
class __Mustache_7b6483ca8f9573c8317d03e8d72de0cd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2c50bfca391136ac57b9eb39de7d583f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section2c50bfca391136ac57b9eb39de7d583f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 px-4 py-4 pb-0 shadow-md">
  ...
  <div class="px-6 md:px-12 mb-0 mx-4">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-6 md:px-12 mb-0 mx-4">
';
