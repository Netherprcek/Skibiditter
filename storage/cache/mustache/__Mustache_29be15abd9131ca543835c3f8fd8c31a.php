...
class __Mustache_29be15abd9131ca543835c3f8fd8c31a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1b47f8f9ecb60db839ae9944548e913a($context, $indent, $value);
    ...
    private function section1b47f8f9ecb60db839ae9944548e913a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="flex w-full">
      ...
      <div id="right_column" class="flex w-1/4 justify-content: left;"></div>
...
';
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '      <div id="right_column" class="flex w-1/4 justify-content: left;"></div>
';
                $buffer .= $indent . '      <h2>';
                $value = $this->resolveValue($context->findDot('session_user.username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
