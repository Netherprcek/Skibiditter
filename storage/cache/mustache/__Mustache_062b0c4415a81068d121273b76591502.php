...
class __Mustache_062b0c4415a81068d121273b76591502 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAfca10cb1eca28387f2d83f08b273d23($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionAfca10cb1eca28387f2d83f08b273d23(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
