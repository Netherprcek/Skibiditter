...
class __Mustache_2540e6ddfa38946613a0dea72f8f932b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFb354b4a14a9fdd7d0571a2ab3a70c48($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function sectionFb354b4a14a9fdd7d0571a2ab3a70c48(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="mb-2 rounded-lg border border-gray-600  p-2">
          <div class="flex w-full items-center">
            <span class="mr-2">{{> partials/postsAvatar }}</span>
            <a
              href="/profile/{{ username }}"
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="mb-2 rounded-lg border border-gray-600  p-2">
';
                $buffer .= $indent . '          <div class="flex w-full items-center">
';
                $buffer .= $indent . '            <span class="mr-2">';
