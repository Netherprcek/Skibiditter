...
class __Mustache_05f7d1cf7eb832420d6b763957cff64f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section54c5fbf87bcf839620a59b716dce2769($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section54c5fbf87bcf839620a59b716dce2769(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
