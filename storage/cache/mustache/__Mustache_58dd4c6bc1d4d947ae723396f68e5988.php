...
class __Mustache_58dd4c6bc1d4d947ae723396f68e5988 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD21b5595a20045ea86f202ebbecbe8fb($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionD21b5595a20045ea86f202ebbecbe8fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="mb-2 border-b border-gray-700">
          ...
          <span class="pl-12">{{comment_text}}</span>
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <span class="pl-12">';
