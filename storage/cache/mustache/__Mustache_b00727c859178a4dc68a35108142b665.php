...
class __Mustache_b00727c859178a4dc68a35108142b665 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAd62a9b8df33b7e2366d6e485e4a3696($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionDcd2d2e7fa09839a191d3cbfcfbd3b76(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAd62a9b8df33b7e2366d6e485e4a3696(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionDcd2d2e7fa09839a191d3cbfcfbd3b76($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
