...
class __Mustache_2373c87226feea4e375fc0e38ed3acb1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section66ebd80a6fa0ac271a2ac84bf97aa47e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section66ebd80a6fa0ac271a2ac84bf97aa47e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '  <div class="mb-2 flex items-center justify-between px-2">
';
