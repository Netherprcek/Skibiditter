...
class __Mustache_d6ad026406b73166ac2f1be311b331fd extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '        <button class="w-auto justify-center rounded-md bg-blue-500 p-2">
';
        $buffer .= $indent . '          Login
';
