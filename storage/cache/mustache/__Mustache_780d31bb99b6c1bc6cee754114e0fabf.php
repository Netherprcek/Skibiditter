...
class __Mustache_780d31bb99b6c1bc6cee754114e0fabf extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7b297f3ce7323a0c45fa2858ecff9fcb($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section7b297f3ce7323a0c45fa2858ecff9fcb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="mb-2 w-4/5 text-gray-200">{{ post_text }}</p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
    <img
      src="{{ img }}"
...
';
                ...
                $buffer .= '</h2>
';
                $buffer .= $indent . '  <p class="mb-2 w-4/5 text-gray-200">';
