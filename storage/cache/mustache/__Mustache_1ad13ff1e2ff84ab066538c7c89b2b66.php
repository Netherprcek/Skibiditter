...
class __Mustache_1ad13ff1e2ff84ab066538c7c89b2b66 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section427c8f58652e84142a83e9888cb2fc7a($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section427c8f58652e84142a83e9888cb2fc7a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '  <div class="mb-2 flex items-center justify-between px-4">
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-12 md:px-12 mb-0">
';
