...
class __Mustache_ad92542072e13d34d3d0fc5e2a02770e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section632edf563f2130e71d945d74c38b0856($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section632edf563f2130e71d945d74c38b0856(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '    </form>
';
                if ($partial = $this->mustache->loadPartial('profileAvatar')) {
