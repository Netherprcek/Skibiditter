...
class __Mustache_d5223b65ae65d0fe0e781b0c8df48c3d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA1fe29abb1a14863f9685a9d4b01551e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionA1fe29abb1a14863f9685a9d4b01551e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-2 md:px-12 mb-0 ">
';
