...
class __Mustache_277e1a2a0fd322910e58ed42fccadf24 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-4 xl:pl-20 text-left justify-items-end">
';
