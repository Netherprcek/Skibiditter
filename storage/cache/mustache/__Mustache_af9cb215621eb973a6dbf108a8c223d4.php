...
class __Mustache_af9cb215621eb973a6dbf108a8c223d4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC2d3ea0bd5a71e75cb23ee892613768b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section9599e176899deb411b42c9626e2fc7db(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC2d3ea0bd5a71e75cb23ee892613768b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' {{!-- Form for your own post --}} {{#session_user}} {{>
partials/postForm}} {{/session_user}} {{!-- List of posts --}}
<div id="center_column" class="flex w-1/2 justify-center">
  <div style="width: 100%; max-width: 42rem; padding: 2rem">
    <h1 class="mb-6 text-center text-3xl font-bold text-white">Home Page</h1>
    {{> partials/postForm}}
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section9599e176899deb411b42c9626e2fc7db($context, $indent, $value);
                $buffer .= ' ';
                $buffer .= '
';
