...
class __Mustache_1da5acd504a6bd341331352aca86340b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4f8db2996762a44bac0083ef9b121a8f($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section4f8db2996762a44bac0083ef9b121a8f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
