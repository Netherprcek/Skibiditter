...
class __Mustache_57153cca6da5f1cf441aecc7579b707c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionCc647cc7974eef8c30ca8a40d51f0978($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionCc647cc7974eef8c30ca8a40d51f0978(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <form id="avatar_form" action="/{{profile.username}}/edit-profile" method="post" class="relative mb-4 mx-4">
        <input
          type="text"
