...
class __Mustache_610d155f8b042b08478e44b93fd74e9d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA8ce14c87ba1bab9cb99ca36b4516ceb($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
            $buffer .= $indent . '          <h2 class="mb-6 mt-16 rounded-lg bg-gray-800 p-4 text-center text-xl font-bold text-white">
';
            $buffer .= $indent . '            In the meantime, feel free to visit the <a href="/explore" class="text-blue-500">explore page</a> to see what\'s happening 😊
';
            $buffer .= $indent . '          </h2>
';
        }
...
';
    ...
    private function sectionA8ce14c87ba1bab9cb99ca36b4516ceb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="border-x-2 border-gray-800">
          {{> partials/postForm}}
          {{> partials/postList}}
        </div>
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="border-x-2 border-gray-800">
';
