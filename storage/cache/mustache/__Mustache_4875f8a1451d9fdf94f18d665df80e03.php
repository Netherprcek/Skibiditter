...
class __Mustache_4875f8a1451d9fdf94f18d665df80e03 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section4e6bc1e0d2283ac7fa588b2e4d3031c9($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section4e6bc1e0d2283ac7fa588b2e4d3031c9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem">
      ...
      <div class="mx-8 grid grid-cols-2 gap-4">
        ...
        {{> partials/userCard}}
        {{/followers}}
        <span>{{followers.created_at}} aa</span>
      </div>
    </div>
    ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                ...
                $buffer .= $indent . '        <span>';
                $value = $this->resolveValue($context->findDot('followers.created_at'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= ' aa</span>
';
                $buffer .= $indent . '      </div>
