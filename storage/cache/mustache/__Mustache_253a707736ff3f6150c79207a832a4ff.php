...
class __Mustache_253a707736ff3f6150c79207a832a4ff extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '  <div id="notification" class="fixed left-1/2 top-25 z-50 hidden -translate-x-1/2 transform rounded border-l-4 border-yellow-500 bg-yellow-100 p-4 text-yellow-700 opacity-0 shadow-md transition-opacity duration-300" role="alert">
';
