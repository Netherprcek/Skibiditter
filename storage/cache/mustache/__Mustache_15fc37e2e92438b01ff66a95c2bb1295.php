...
class __Mustache_15fc37e2e92438b01ff66a95c2bb1295 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    
';
        $buffer .= $indent . '    <button id="post_button" class="mt-2 w-1/5 rounded-lg bg-blue-500 p-2 text-white hover:bg-blue-600">
';
        $buffer .= $indent . '      Post
';
