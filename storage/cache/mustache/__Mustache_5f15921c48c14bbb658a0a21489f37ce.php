...
class __Mustache_5f15921c48c14bbb658a0a21489f37ce extends Mustache_Template
{
...
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '<div class="flex flex-col w-1/2 text-left"></div>
';
        $buffer .= $indent . '<div class="flex flex-col w-1/2 text-left">
';
