...
class __Mustache_01d675d8754e29fb74293316a154b15e extends Mustache_Template
{
...
';
        $buffer .= $indent . '    
';
        $buffer .= $indent . '    <button id="post_button" class="mt-2  rounded-lg bg-blue-500 p-2 text-white hover:bg-blue-600">
';
        $buffer .= $indent . '      Post
';
