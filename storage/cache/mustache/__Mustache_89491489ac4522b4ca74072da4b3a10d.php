...
class __Mustache_89491489ac4522b4ca74072da4b3a10d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB063d970fd73e230260cdcc0921a5878($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionB063d970fd73e230260cdcc0921a5878(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
