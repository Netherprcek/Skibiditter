...
class __Mustache_b16a93f8af5fcd2fc6101f5e4b746697 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <p class="text-center text-2xl font-bold text-blue-500">SKIBIDITTER</p>
';
...
';
        $buffer .= $indent . '        <h1 class="mb-6 text-center text-3xl font-bold text-white">Posts</h1>
';
        $value = $context->find('posts');
        $buffer .= $this->sectionCb20c8a02481f1caea7624645e9baf5d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section34e7c3ecb76ffbc2dbad9afd152bfe34(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionCb20c8a02481f1caea7624645e9baf5d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section34e7c3ecb76ffbc2dbad9afd152bfe34($context, $indent, $value);
