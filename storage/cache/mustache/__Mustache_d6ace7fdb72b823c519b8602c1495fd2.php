...
class __Mustache_d6ace7fdb72b823c519b8602c1495fd2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section09f71b521d71c608202731a29f47ca39($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section09f71b521d71c608202731a29f47ca39(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
