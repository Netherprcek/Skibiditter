...
class __Mustache_6b25f102334e14c21b0bd74c7f385e97 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section8297bd3fe27d10c7ca5edfc3ea459b2d($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section2188fdf772ac1c08193ecdb3e07deded(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="relative">
      ...
      >
        ...
        <form action="http://localhost:8000/{{id_post}}/delete" method="POST">
        <a
...
';
    ...
    private function section8297bd3fe27d10c7ca5edfc3ea459b2d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section2188fdf772ac1c08193ecdb3e07deded($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
