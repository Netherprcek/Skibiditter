...
class __Mustache_284903ed8c06810b1edbb4c6ab38db1e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0b0f3a1bdabed0cd3187a4402d02504b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section0b0f3a1bdabed0cd3187a4402d02504b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div style="width: 100%; max-width: 42rem; border-x-8">
...
';
                $buffer .= $indent . '    <div style="width: 100%; max-width: 42rem; border-x-8">
';
