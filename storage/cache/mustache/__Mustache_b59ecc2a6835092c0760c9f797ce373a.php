...
class __Mustache_b59ecc2a6835092c0760c9f797ce373a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section51c3e5c1df4f9b9d44478934d016c29e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section51c3e5c1df4f9b9d44478934d016c29e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
