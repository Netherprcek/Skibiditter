...
class __Mustache_6a37a249ba3f89fc8899699a4aac49b7 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFda05b3ef74e417c3d71de19c9a5fb3d($context, $indent, $value);
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function sectionFda05b3ef74e417c3d71de19c9a5fb3d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <li class="flex items-center mb-2">
          ...
          <span class="ml-2"> <a href="/profile/{{username}}" class="text-blue-500">{{username}}</a> has created a new <a href="/post/{{id_post}}" class="text-blue-500">post</a></span>
        </li>
      ';
...
';
                ...
                $value = $this->resolveValue($context->find('username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</a> has created a new <a href="/post/';
                $value = $this->resolveValue($context->find('id_post'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="text-blue-500">post</a></span>
';
                $buffer .= $indent . '        </li>
';
                $context->pop();
