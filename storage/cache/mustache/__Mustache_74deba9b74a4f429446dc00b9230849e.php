...
class __Mustache_74deba9b74a4f429446dc00b9230849e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD1a346c8f45cf728c57d072a9363003b($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionD1a346c8f45cf728c57d072a9363003b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
