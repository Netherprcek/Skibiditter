...
class __Mustache_7fffc74d61f02b7378da4df4341a13b7 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section885c8878a3ff09f1ac8ecf1fb7e25e6a($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section885c8878a3ff09f1ac8ecf1fb7e25e6a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-shadow-lg"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-red-500 hover:text-shadow-lg"
';
                $buffer .= $indent . '        >
';
