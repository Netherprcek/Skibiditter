...
class __Mustache_250b49e51fdb5ea326f8ee95d642624a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section105c939c80b0ae3f479950da4aca28a9($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section81912cbc13255954e5b3daacbdbf8de8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center">
                <img src="{{img}}" alt="{{title}}" class="w-96 h-96 object-cover" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-96 h-96 object-cover" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function section105c939c80b0ae3f479950da4aca28a9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section81912cbc13255954e5b3daacbdbf8de8($context, $indent, $value);
