...
class __Mustache_5c9a6d2209a8599a707e05c187510f85 extends Mustache_Template
{
...
';
        $value = $context->findDot('profile.is_owner');
        $buffer .= $this->sectionAcf6ce3469782e0e4ae44bf489be1f2a($context, $indent, $value);
        $value = $context->findDot('profile.bio');
        $buffer .= $this->section914220546af02cf9765d1f70b7257651($context, $indent, $value);
        $value = $context->findDot('profile.bio');
        if (empty($value)) {
...
';
    ...
    private function section76b83899e6671d4416115378cf3e16ce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
      <p class="bio-text cursor-pointer">{{profile.bio}}</p>
      ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
...
';
    ...
    private function sectionAcf6ce3469782e0e4ae44bf489be1f2a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                $value = $context->findDot('profile.bio');
                $buffer .= $this->section76b83899e6671d4416115378cf3e16ce($context, $indent, $value);
                $value = $context->findDot('profile.bio');
                if (empty($value)) {
...
';
    ...
    private function section914220546af02cf9765d1f70b7257651(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
