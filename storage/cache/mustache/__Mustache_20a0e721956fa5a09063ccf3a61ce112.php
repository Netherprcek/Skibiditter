...
class __Mustache_20a0e721956fa5a09063ccf3a61ce112 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9b2706db38c019f88aa8e9c0e74c662c($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section9b2706db38c019f88aa8e9c0e74c662c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    <div class="flex items-center">
      ...
      <span class=" text-sm pt-0 justify-self-end text-gray-300">Created at: {{ created_at }}</span>
    </div>
    {{#is_owner}}
    <div class="relative">
      <button class="text-white" onclick="toggleOptions(\'{{id_post}}\', event)">
...
';
                $buffer .= $indent . '      </span>
';
                $buffer .= $indent . '      <span class=" text-sm pt-0 justify-self-end text-gray-300">Created at: ';
