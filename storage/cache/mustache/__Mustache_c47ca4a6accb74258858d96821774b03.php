...
class __Mustache_c47ca4a6accb74258858d96821774b03 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section528efdbe3b0de393f20c2571ba8d5aae($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section528efdbe3b0de393f20c2571ba8d5aae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
