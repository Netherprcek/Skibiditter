...
class __Mustache_495cd069b2109be5868cca175eb084d1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        class="absolute top-2 right-2 mb-2 text-gray-400 hover:text-gray-300"
';
        $buffer .= $indent . '      >
';
        $buffer .= $indent . '        <svg
