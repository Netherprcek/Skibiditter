...
class __Mustache_3c65cb359da1739a91c1ac51299cb9c0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1103bffae3e7a395a603477659df89d7($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section1103bffae3e7a395a603477659df89d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class=" mb-4  rounded-lg px-8 py-3 text-gray-100 shadow-inner"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class=" mb-4  rounded-lg px-8 py-3 text-gray-100 shadow-inner"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
