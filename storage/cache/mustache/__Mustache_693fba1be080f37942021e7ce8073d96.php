...
class __Mustache_693fba1be080f37942021e7ce8073d96 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA3b4589408ca64845ea52c551bf6d0cd($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionA3b4589408ca64845ea52c551bf6d0cd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
