...
class __Mustache_6d47829914ea3e2062a0b3681265755d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section6edd5a319bb21adf3bd83b25dbeb6abf($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section6edd5a319bb21adf3bd83b25dbeb6abf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
