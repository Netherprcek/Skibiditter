...
class __Mustache_7ec2f113f67aa8f403270d5e7f10b459 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section18372a06f38e177177cfd167e16f6320($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section18372a06f38e177177cfd167e16f6320(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-2 break-words px-14 bg-gray-800 text-gray-200">
    {{ post_text }}
  </p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-2 break-words px-14 bg-gray-800 text-gray-200">
';
                $buffer .= $indent . '    ';
