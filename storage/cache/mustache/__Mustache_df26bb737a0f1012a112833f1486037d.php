...
class __Mustache_df26bb737a0f1012a112833f1486037d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section37c81585b1d5a086f064d7d82b6a3be2($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section37c81585b1d5a086f064d7d82b6a3be2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
