...
class __Mustache_3dcf85968775ecb1ca023aef27b21bde extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section83a04ab1ffb9091ddf71bb0314830b5e($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section83a04ab1ffb9091ddf71bb0314830b5e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
