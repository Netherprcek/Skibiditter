...
class __Mustache_6d45b423f64005d758ded076d17c09a5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section78eb1d67b03353f149f9296277440277($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section78eb1d67b03353f149f9296277440277(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 px-4 py-4 pb-0 shadow-md">
  ...
  <div class="px-6 md:px-12 mb-0 mx-2">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div class="px-6 md:px-12 mb-0 mx-2">
';
