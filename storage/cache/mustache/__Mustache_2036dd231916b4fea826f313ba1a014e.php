...
class __Mustache_2036dd231916b4fea826f313ba1a014e extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-0 text-left justify-items-end">
';
