...
class __Mustache_77c7449ed7ea67b8b65f5d4487f91a71 extends Mustache_Template
{
...
';
        $buffer .= $indent . '      <button class="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-600 justify-self-auto">SKIBIDITTER</button>
';
