...
class __Mustache_413cf78a7ab7adde348d134d3462308d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7ae9a3c302bb991a05c8cf31353b0b17($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function section7ae9a3c302bb991a05c8cf31353b0b17(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
