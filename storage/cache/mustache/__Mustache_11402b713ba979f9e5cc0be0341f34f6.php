...
class __Mustache_11402b713ba979f9e5cc0be0341f34f6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3df69996f32cb08bf8556165d4a054fa($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section3df69996f32cb08bf8556165d4a054fa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
