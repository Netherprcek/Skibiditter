...
class __Mustache_519b3ba29f781c400aa4ad4734f7e113 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1d3c554fa513aaac8aad1a940d043ec9($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section1d3c554fa513aaac8aad1a940d043ec9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
