...
class __Mustache_a324f30fc1066f995628bca4ccc372ba extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section52920da92b98148484a16e9af2119805($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionBd5b4bd544eaa7ce243f73ef1f5f8eb0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <a href="http://localhost:8000/{{post_id}}/edit">
      <button
...
';
    ...
    private function section52920da92b98148484a16e9af2119805(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionBd5b4bd544eaa7ce243f73ef1f5f8eb0($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
