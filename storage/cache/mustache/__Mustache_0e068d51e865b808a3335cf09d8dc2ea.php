...
class __Mustache_0e068d51e865b808a3335cf09d8dc2ea extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section28ba94bf104dbdb770aa227850231254($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('replies');
        if (empty($value)) {
...
';
    ...
    private function section28ba94bf104dbdb770aa227850231254(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
