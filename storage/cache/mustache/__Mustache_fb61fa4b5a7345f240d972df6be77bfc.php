...
class __Mustache_fb61fa4b5a7345f240d972df6be77bfc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5c75798cb5294f581415a1cf6ddda902($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section5c75798cb5294f581415a1cf6ddda902(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
