...
class __Mustache_0e00096da190a046076b28998f8f2075 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD8882197ab20c7d6491e24c39ce506dd($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionD8882197ab20c7d6491e24c39ce506dd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    ...
    <p
      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-1 border-gray-7000 rounded-lg  "
    >
      {{ post_text }}
    </p>
...
';
                $buffer .= $indent . '    <p
';
                $buffer .= $indent . '      class="overflow-wrap break-word z-10 mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-1 border-gray-7000 rounded-lg  "
';
                $buffer .= $indent . '    >
';
                $buffer .= $indent . '      ';
