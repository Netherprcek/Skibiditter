...
class __Mustache_0e2d4e35c9f59003fa3cfb102c3c2476 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section393a69304f83195fba8b2046db893f86($context, $indent, $value);
        $buffer .= ' ';
...
';
    ...
    private function section393a69304f83195fba8b2046db893f86(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <form>
              ...
              <input type="text" placeholder="Description" class="w-full" />
              <input type="text" placeholder="Image" class="w-full" />
            </form>
          </div>
          ';
...
';
                $buffer .= $indent . '            <form>
';
                $buffer .= $indent . '              <input type="text" placeholder="Title" class="w-full" />
';
                $buffer .= $indent . '              <input type="text" placeholder="Description" class="w-full" />
';
                $buffer .= $indent . '              <input type="text" placeholder="Image" class="w-full" />
';
                $buffer .= $indent . '            </form>
';
                $buffer .= $indent . '          </div>
