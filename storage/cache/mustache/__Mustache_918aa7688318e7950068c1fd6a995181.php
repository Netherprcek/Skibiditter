...
class __Mustache_918aa7688318e7950068c1fd6a995181 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section667fb02826d2517e73bf6c34a3cee646($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section667fb02826d2517e73bf6c34a3cee646(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
