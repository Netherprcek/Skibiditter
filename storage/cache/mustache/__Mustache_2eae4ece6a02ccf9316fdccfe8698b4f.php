...
class __Mustache_2eae4ece6a02ccf9316fdccfe8698b4f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0171c29f6837e65726609f9b14b9da7b($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section0171c29f6837e65726609f9b14b9da7b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
          ...
          <article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            ...
            <p class="mb-2 text-center text-xl font-semibold text-white">
              {{ username }}
            </p>
...
';
                ...
                $buffer .= $indent . '            <p class="mb-2 text-center text-xl font-semibold text-white">
';
                $buffer .= $indent . '              ';
