...
class __Mustache_023af945e45435ec44baf1dc59c71fff extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section534aece1338738e89288623084682cd0($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section534aece1338738e89288623084682cd0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
