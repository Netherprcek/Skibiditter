...
class __Mustache_30da6fc3a6e76ed89708d6f8eb01203c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6cedba21e9f92ad47da6fe35956c978d($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('user');
        if (empty($value)) {
...
';
    ...
    private function section6cedba21e9f92ad47da6fe35956c978d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
