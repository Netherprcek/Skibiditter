...
class __Mustache_290f3a32d480e2826f6cbee9ac106d86 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<a href="/profile" class="h-max-10 ml-10 rounded-full bg-blue-500 p-0.5">
';
        $buffer .= $indent . '  <div
';
