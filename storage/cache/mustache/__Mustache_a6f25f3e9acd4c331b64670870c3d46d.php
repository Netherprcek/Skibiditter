...
class __Mustache_a6f25f3e9acd4c331b64670870c3d46d extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->section9e47dbf61b1c9ddf418fe3681c38c959($context, $indent, $value);
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section9e47dbf61b1c9ddf418fe3681c38c959(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
