...
class __Mustache_292d682f72421e9f4d0832cd2133afd9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-0 xl:pl-12 align-end">
';
        $buffer .= $indent . '    <div class="flex flex-col text-left w-1/2 justify-end">
';
