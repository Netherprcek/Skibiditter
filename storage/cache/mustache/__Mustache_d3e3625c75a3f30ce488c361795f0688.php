...
class __Mustache_d3e3625c75a3f30ce488c361795f0688 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section886b4462b88302136e7de64ee92635ba($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section886b4462b88302136e7de64ee92635ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="mt-16 flex w-full">
  ...
  <div id="center_column" class="flex w-1/3 justify-center">
    <div class="w-max;  42rem; border-x-8 border-gray-800">
...
';
                $buffer .= $indent . '    <div class="w-max;  42rem; border-x-8 border-gray-800">
';
