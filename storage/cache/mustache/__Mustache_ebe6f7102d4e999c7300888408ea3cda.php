...
class __Mustache_ebe6f7102d4e999c7300888408ea3cda extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section77ac7a4f05a7a45e940a26f16616d7a1($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionEa095cef31daf40f911b32cd9bc3984d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section77ac7a4f05a7a45e940a26f16616d7a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('is_owner');
                $buffer .= $this->sectionEa095cef31daf40f911b32cd9bc3984d($context, $indent, $value);
                $buffer .= $indent . '  </div>
';
                $buffer .= $indent . '
';
