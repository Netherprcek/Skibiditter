...
class __Mustache_77251ba9347b4497cd0db6414084db45 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD215e12d071692f0a144537eb7ca599f($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionD215e12d071692f0a144537eb7ca599f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
