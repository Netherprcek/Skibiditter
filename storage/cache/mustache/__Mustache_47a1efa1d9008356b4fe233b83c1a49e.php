...
class __Mustache_47a1efa1d9008356b4fe233b83c1a49e extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section949d957a6c275fa0d0bb2a73b2d156a7($context, $indent, $value);
            $buffer .= ' ';
            $value = $context->find('is_following');
            if (empty($value)) {
...
';
    ...
    private function section949d957a6c275fa0d0bb2a73b2d156a7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <form action="/{{profile.user_id}}/unfollow" method="POST">
        <button
          type="submit"
          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-blue-700"
        >
          Unfollow
        </button>
      </form>
...
';
                $buffer .= $indent . '          type="submit"
';
                $buffer .= $indent . '          class="bg-blue-6000 mt-16 rounded-lg border-2 border-red-600 px-4 py-2 text-white hover:bg-blue-700"
';
                $buffer .= $indent . '        >
';
