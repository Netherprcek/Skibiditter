...
class __Mustache_91c9287fcc41b3c3cda03b8d5b9e5667 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section687b6efc40026b7b2ab513a5ad23c170($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section687b6efc40026b7b2ab513a5ad23c170(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
