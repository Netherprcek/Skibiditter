...
class __Mustache_d5a3f569d2a072931e60463848be125c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC0465e726e772706b593a94fb2b47ea6($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function sectionC0465e726e772706b593a94fb2b47ea6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
