...
class __Mustache_6f2916904e06a073eae2f69e9803fcb3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3c7690894f8d99ee3e1e353ccd455844($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section3c7690894f8d99ee3e1e353ccd455844(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
