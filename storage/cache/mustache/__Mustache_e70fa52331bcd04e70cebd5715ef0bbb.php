...
class __Mustache_e70fa52331bcd04e70cebd5715ef0bbb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD1222ea1ea079375dd210354e0c6be3c($context, $indent, $value);
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section1a89d3291ceac7b14c6232063d5b3546(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <div class="w-full flex justify-center mt-4">
                <img src="{{img}}" alt="{{title}}" class="w-full h-6 object-cover rounded-lg" />
              </div>
            ';
...
';
                ...
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '" class="w-full h-6 object-cover rounded-lg" />
';
                $buffer .= $indent . '              </div>
';
                $context->pop();
    ...
    private function sectionD1222ea1ea079375dd210354e0c6be3c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section1a89d3291ceac7b14c6232063d5b3546($context, $indent, $value);
