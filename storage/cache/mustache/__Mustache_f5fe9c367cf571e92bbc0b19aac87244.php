...
class __Mustache_f5fe9c367cf571e92bbc0b19aac87244 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section250b86014c0b892925f86f3b64e1fa4e($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section250b86014c0b892925f86f3b64e1fa4e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
