...
class __Mustache_0569ab069afd24a4c6b42cb50c5d0f3f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section072587dad473a1f5992b625c98a70774($context, $indent, $value);
        $value = $context->findDot('profile.bio');
        if (empty($value)) {
...
';
    ...
    private function section072587dad473a1f5992b625c98a70774(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      ';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->findDot('cursor-pointer">{{profile.bio'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</p>
';
                $context->pop();
