...
class __Mustache_0822d67ee7fda7d22014c2431eafd9a0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionC9c18a7e3a919c2381f6dfe312dc3ff0($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionC9c18a7e3a919c2381f6dfe312dc3ff0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
