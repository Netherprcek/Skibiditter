...
class __Mustache_abfcd21eb041d254f608147fe5ff7c3e extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="width=100% flex">
';
        $buffer .= $indent . '      <div class="flex w-1/3"></div>
';
        $buffer .= $indent . '      <div style="display: flex; justify-content: center; w-1/3">
';
...
';
        ...
        $buffer .= $this->sectionE846e6f8043edba7af794fadd6e4c1a4($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function sectionE846e6f8043edba7af794fadd6e4c1a4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
