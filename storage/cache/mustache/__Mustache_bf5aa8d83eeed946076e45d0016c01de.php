...
class __Mustache_bf5aa8d83eeed946076e45d0016c01de extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionA20492c47ecfc06b9db1d0329fdef909($context, $indent, $value);
    ...
    private function sectionA20492c47ecfc06b9db1d0329fdef909(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="flex w-full">
      ...
      <div id="right_column" class="flex w-1/4 justify-content: left;"><h2>{{session_user.username}}</h2></div>
...
';
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '      <div id="right_column" class="flex w-1/4 justify-content: left;"><h2>';
                $value = $this->resolveValue($context->findDot('session_user.username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</h2></div>
';
