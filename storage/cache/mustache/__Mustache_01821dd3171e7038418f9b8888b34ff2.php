...
class __Mustache_01821dd3171e7038418f9b8888b34ff2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD3b8a8593ef34f2f9c259156ca00128c($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function sectionD3b8a8593ef34f2f9c259156ca00128c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
