...
class __Mustache_a3d1b960297b44e7fef91b2fdfa75257 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4c398181eb0a6edab80f95e133fadaa3($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('comments');
        if (empty($value)) {
...
';
    ...
    private function section4c398181eb0a6edab80f95e133fadaa3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '</p>
';
                $buffer .= $indent . '          <div class="flex justify-center py-2 mt-2">
';
                $buffer .= $indent . '            <form
';
