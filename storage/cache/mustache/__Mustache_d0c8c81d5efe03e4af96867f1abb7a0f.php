...
class __Mustache_d0c8c81d5efe03e4af96867f1abb7a0f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB09d864b738fa6f977366e7d2c2794c0($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB09d864b738fa6f977366e7d2c2794c0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class="overflow-wrap break-word z-10 mb-4 break-words border-l-2 border-gray-700 px-6 py-3 text-gray-100"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class="overflow-wrap break-word z-10 mb-4 break-words border-l-2 border-gray-700 px-6 py-3 text-gray-100"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
