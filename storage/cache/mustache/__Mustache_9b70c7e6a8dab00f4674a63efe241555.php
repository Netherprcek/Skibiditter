...
class __Mustache_9b70c7e6a8dab00f4674a63efe241555 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section10613b671dfb0409df95d3272fdffee7($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section10613b671dfb0409df95d3272fdffee7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
  ...
  <div class="flex justify-center">
    <button
      class="mr-2 text-white hover:text-gray-400"
    ...
    <a href="http://localhost:8000/{{id_post}}/comments">
      <button
        ...
        style="background: none; border: none; padding: 0"
      >
        <i class="fa fa-poop"></i> {{comment_count}}
      </button>
    </a>
    {{#is_owner}}
    <a href="http://localhost:8000/{{id_post}}/edit">
...
';
                $buffer .= $indent . '    <button
';
                $buffer .= $indent . '      class="mr-2 text-white hover:text-gray-400"
';
                $buffer .= $indent . '      style="background: none; border: none; padding: 0"
';
                $buffer .= $indent . '    >
';
                $buffer .= $indent . '      <i class="fa fa-toilet"></i>
';
                $buffer .= $indent . '    </button>
';
                $buffer .= $indent . '    <a href="http://localhost:8000/';
...
';
                $buffer .= $indent . '      >
';
                $buffer .= $indent . '        <i class="fa fa-poop"></i> ';
