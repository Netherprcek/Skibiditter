...
class __Mustache_1333b29fc0cef87232ccd475d6324a82 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionD004e06003110a2ea1007965d5593a22($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionD004e06003110a2ea1007965d5593a22(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
