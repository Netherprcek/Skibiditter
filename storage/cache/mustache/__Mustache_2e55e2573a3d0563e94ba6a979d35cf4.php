...
class __Mustache_2e55e2573a3d0563e94ba6a979d35cf4 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section27b0057ec3db80183fc423f267c63403($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section27b0057ec3db80183fc423f267c63403(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
