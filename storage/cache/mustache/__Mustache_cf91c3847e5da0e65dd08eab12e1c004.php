...
class __Mustache_cf91c3847e5da0e65dd08eab12e1c004 extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->findDot('session_user.avatar'), $context);
...
';
        ...
        $buffer .= $this->section02a5770ea9b85e5ced949725ca1d81ba($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('posts');
        if (empty($value)) {
...
';
    ...
    private function section02a5770ea9b85e5ced949725ca1d81ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
