...
class __Mustache_5a61ee8b0803a5c4218714180bbf0663 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="mt-12 flex w-1/2 flex-col pl-0 xl:pl-12 text-left ">
';
        $buffer .= $indent . '    <div class="flex flex-col text-left">
';
