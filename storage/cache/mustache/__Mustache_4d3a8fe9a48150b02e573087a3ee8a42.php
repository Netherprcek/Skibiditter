...
class __Mustache_4d3a8fe9a48150b02e573087a3ee8a42 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section304a814b7c05a1deca6759b622b24687($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section304a814b7c05a1deca6759b622b24687(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p
    class="overflow-wrap break-word z-10 mb-4 break-words border-t-2 border-gray-600 px-6 py-3 text-gray-100"
  >
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '  <p
';
                $buffer .= $indent . '    class="overflow-wrap break-word z-10 mb-4 break-words border-t-2 border-gray-600 px-6 py-3 text-gray-100"
';
                $buffer .= $indent . '  >
';
                $buffer .= $indent . '    ';
