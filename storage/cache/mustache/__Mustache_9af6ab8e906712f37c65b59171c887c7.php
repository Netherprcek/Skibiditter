...
class __Mustache_9af6ab8e906712f37c65b59171c887c7 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  class="fixed left-0 top-0 flex h-screen w-1/3 content-end overflow-y-auto border-r-2 border-gray-800 pl-4 pr-4 text-right"
';
        $buffer .= $indent . '>
';
