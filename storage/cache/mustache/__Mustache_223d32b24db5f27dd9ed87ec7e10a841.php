...
class __Mustache_223d32b24db5f27dd9ed87ec7e10a841 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section0073fc39eae44fc036d5dd5991b5d482($context, $indent, $value);
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section0073fc39eae44fc036d5dd5991b5d482(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        <div class="relative mb-4 flex items-center justify-center">
';
