...
class __Mustache_1f10fe27f3a05259246eef4f6287b251 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section5f5519b0316e6dd9f38988acb33f5ba2($context, $indent, $value);
        $buffer .= ' ';
        $value = $context->find('session_user');
        if (empty($value)) {
...
';
    ...
    private function section5f5519b0316e6dd9f38988acb33f5ba2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
