...
class __Mustache_6c9aafed0661fd4d0e8f6e0a25f58b4a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB1b126a904bd0b6ca951fee1c9119c84($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionB1b126a904bd0b6ca951fee1c9119c84(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-gray-700 text-gray-100 rounded-lg shadow-inner">
    {{ post_text }}
  </p>
  {{#img}}
  <div class="mt-4 flex w-full justify-center">
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-8 py-3 border-gray-700 text-gray-100 rounded-lg shadow-inner">
';
                $buffer .= $indent . '    ';
