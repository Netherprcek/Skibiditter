...
class __Mustache_e9299f4f90f133b3b8f711dd44f3410f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section83da1760e9906181ba62baf4122f600a($context, $indent, $value);
    ...
    private function section83da1760e9906181ba62baf4122f600a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="flex w-full">
      ...
      <div id="right_column" class="flex w-1/4 justify-start border-l-2 border-gray-800"><h2>{{session_user.username}}</h2></div>
...
';
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '      <div id="right_column" class="flex w-1/4 justify-start border-l-2 border-gray-800"><h2>';
                $value = $this->resolveValue($context->findDot('session_user.username'), $context);
                $buffer .= ($value === null ? '' : htmlspecialchars($value, 3, 'UTF-8'));
                $buffer .= '</h2></div>
';
