...
class __Mustache_be18be08844bdcb5cd612bb3f091cd4b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEbf6b290623fb458ded248bb5371efe3($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function sectionEbf6b290623fb458ded248bb5371efe3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
