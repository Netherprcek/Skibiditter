...
class __Mustache_3835b22f5daa57008602080703e9dddd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3fe5f1cbc3eda1cf2e81e34d1ccbc35f($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section3fe5f1cbc3eda1cf2e81e34d1ccbc35f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div><p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-2 border-gray-700 rounded-lg z-10">
    {{ post_text }}
  </p>
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '  <div><p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 bg-gray-900 border-2 border-gray-700 rounded-lg z-10">
';
                $buffer .= $indent . '    ';
