...
class __Mustache_7d0d8ec755b1676c08c9b3f5f8f2a452 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <div class="flex w-1/3 flex-col text-left"></div>
';
        $buffer .= $indent . '  <div class="mt-12 flex w-full flex-col items-end text-left pr-12">
';
