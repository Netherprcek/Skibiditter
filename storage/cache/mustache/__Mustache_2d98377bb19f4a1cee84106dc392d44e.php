...
class __Mustache_2d98377bb19f4a1cee84106dc392d44e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section463aeb3642020bf7ba8c06330f4dd686($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section463aeb3642020bf7ba8c06330f4dd686(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
  ...
  <div class="flex justify-center">
    ...
    >
      ...
      <button
        ...
        class="mr-2 rounded-lg px-4 py-2 text-white hover:text-red-600"
        type="button"
