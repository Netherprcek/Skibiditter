...
class __Mustache_53f62555eaa2540b9d492c0f775c10e5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1bd467940351e28a58874ccc34620a57($context, $indent, $value);
        $buffer .= $indent . ' ';
        $value = $context->find('post');
        if (empty($value)) {
...
';
    ...
    private function section1bd467940351e28a58874ccc34620a57(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<article class="relative mb-6 rounded-lg bg-gray-800 p-6 pb-0 shadow-md">
  ...
  <div class="relative">
  <div class="absolute left-4 -top-2 h-4 w-4 rotate-45 transform bg-gray-700"></div>
  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 rounded-lg bg-gray-700 shadow-inner relative z-10">
    {{ post_text }}
  </p>
</div>
...
';
                $buffer .= $indent . '  <div class="relative">
';
                $buffer .= $indent . '  <div class="absolute left-4 -top-2 h-4 w-4 rotate-45 transform bg-gray-700"></div>
';
                $buffer .= $indent . '  <p class="overflow-wrap break-word mb-4 break-words px-6 py-3 text-gray-100 rounded-lg bg-gray-700 shadow-inner relative z-10">
';
                $buffer .= $indent . '    ';
