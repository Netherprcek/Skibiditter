...
class __Mustache_c8f7008c0d7cbbf792e245ec55713521 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1876ffa9aedc9bbdfe4cec8d1fe319d7($context, $indent, $value);
        $buffer .= ' ';
...
';
    ...
    private function section1876ffa9aedc9bbdfe4cec8d1fe319d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
          ...
          <div id="post_form" class="mb-6 rounded-lg bg-gray-800 p-6 shadow-md">
            <form>
              <input
                type="text"
                placeholder="Title"
                class="w-full rounded-lg bg-slate-500 p-2"
              />
              <input
                type="text"
...
';
                $buffer .= $indent . '                class="w-full rounded-lg bg-slate-500 p-2"
';
                $buffer .= $indent . '              />
';
                $buffer .= $indent . '              <input
